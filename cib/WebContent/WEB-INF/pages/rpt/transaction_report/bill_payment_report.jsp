...
function doSubmit(arg) {
	if(validate_payment_history(document.getElementById("form1"))){
		...
		if (arg == 'list') {
			document.form1.ActionMethod.value = 'listBillPaymentReport';
		}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_payment" defaultvalue="MDB Corporate Online Banking > Online Report >  Transaction Report"/><!-- InstanceEndEditable --></td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                <td colspan="2" class="label1">
					<input id="radiobutton" type="radio" name="radiobutton" value="transfer" onClick="changeReport('transfer');">
					...
					-->
                  	<input id="radiobutton" name="radiobutton" type="radio" value="billPayment" checked onClick="changeReport('billPayment');">
              ...
              <tr class="greyline">
                <td width="28%" class="label1"><set:label name="payment_period" defaultvalue="payment_period"/></td>
              ...
              <tr>
                ...
                <input name="dateFrom" type="text" id="dateFrom" size="12" maxlength="10" disabled><img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "if(!document.getElementById('dateFrom').disabled){scwShow(document.getElementById('dateFrom'), this,language)};" >&nbsp;&nbsp;&nbsp;
                <set:label name='Date_To'/>&nbsp;
                <input name="dateTo" type="text" id="dateTo" size="12" maxlength="10" disabled><img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "if(!document.getElementById('dateFrom').disabled){scwShow(document.getElementById('dateTo'), this,language)};" >
              ...
              <tr class="greyline">
                ...
                <td width="72%" class="content1">
					<select id="merchant" name="merchant" onChange="">
              ...
              <tr class="">
                ...
                <td width="72%" class="content1"><input name="fromAccount" type="text" id="fromAccount" value="<set:data name='fromAccount'/>" maxlength="16">
				</td>
              </tr>
            </table>
