...
function doSubmit(arg) {
	if(validate_payment_history(document.getElementById("form1"))){
		if (arg == 'list') {
			document.form1.ActionMethod.value = 'listTransferReport';
		}
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                <td colspan="2" class="label1">
					<input id="radiobutton" name="radiobutton" type="radio" value="transfer" checked onClick="changeReport('transfer');">
              ...
              <tr>
                ...
                <td width="72%" class="content1"><span class="content">
                	...
                	<input name="dateTo" type="text" id="dateTo" size="12" maxlength="10" disabled><img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "if(!document.getElementById('dateTo').disabled){scwShow(document.getElementById('dateTo'), this,language)};" >
              ...
              <tr class="greyline">
                ...
                <td width="72%" class="content1">
				  <select id="businessType" name="businessType" nullable="0">
