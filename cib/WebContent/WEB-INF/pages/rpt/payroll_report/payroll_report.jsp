...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_payroll" defaultvalue="MDB Corporate Online Banking > Online Report >  Transaction Report"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_payroll" defaultvalue="TRANSACTION REPORT"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/payrollReport.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  ...
                  <td class="content1"><span class="content">
                    ...
                    <set:label name="all" rb="app.cib.resource.bat.payroll"/>
                  </span></td>
                </tr>
                <tr class="greyline">
                  ...
                  <td class="content1"><span class="content">
                    ...
                    </span> <set:label name='Date_From' rb="app.cib.resource.bat.payroll"/>&nbsp;
					...
					<set:label name='Date_To' rb="app.cib.resource.bat.payroll"/>&nbsp;
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="40" colspan="2" class="sectionbutton"><input id="search" name="search" type="button" value="&nbsp;&nbsp;<set:label name='search' defaultvalue=' search ' rb='app.cib.resource.bat.payroll'/>&nbsp;&nbsp;" onClick="doSubmit('list')">
