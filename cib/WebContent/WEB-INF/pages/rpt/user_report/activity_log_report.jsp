...
function doSubmit(arg){
	if(validate_payment_history(document.getElementById("form1"))){
		...
		if (arg == 'list') {
			document.form1.ActionMethod.value = 'listActivityLogReport';
		}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_act" defaultvalue="MDB Corporate Online Banking > Online Report >  Transaction Report"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_act" defaultvalue="TRANSACTION REPORT"/><!-- InstanceEndEditable --></td>
