...
function doReturn(){
	var returnPage = '<set:data name="returnPage"/>';
	if(returnPage=='outstanding'){
  		document.form1.ActionMethod.value = 'statusEnquiry';
	} else {
  		document.form1.ActionMethod.value = 'historyEnquiryLoad';
	}
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
               <tr>
                <td width="28%" class="listheader1"><set:label name="Work_Dealer"/></td>
				<td width="12%" class="listheader1"><set:label name="Work_Deal_Time"/></td>
				<td width="12%" class="listheader1"><set:label name="Work_Action"/></td>
				<set:if name= "FinanceFlag" condition="equals" value = "Y">
				<td width="7%" align="center" valign="middle" class="listheader1"><set:label name="Work_Level"/></td>
				</set:if>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" class="sectionbutton">
                  ...
                  <input id="ActionMethod" name="ActionMethod" type="hidden" value="<set:data name='actionMethodReturn' />"></td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
		  </form>
