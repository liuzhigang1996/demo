...
function doSubmit(arg){
	if(true){//(validate_payment_history(document.getElementById("form1"))){
		...
		if (arg == 'list') {
			document.form1.ActionMethod.value = 'statusEnquiryBank';
		}
...
function showUserList(originSelect, targetSelect, callback){
	...
	//var url = '/cib/jsax?serviceName=UserListService&corpId=<set:data name="corpId"/>&' + params;
	var tempId = escape('<set:data name="corpId"/>');
	var url = '/cib/jsax?serviceName=UserListService&corpId=' + tempId + '&' + params;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
          <set:label name="navigationTitle_status" defaultvalue="MDB Corporate Online Banking > Authorization > Authorization State List"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle_status" defaultvalue="AUTHORIZATION STATE LIST"/>
        <!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td class="content1"><set:data name='corpName'/>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_c"><a href="#" onClick="changeDoc('sum');">
                            <set:label name="functionTitle_sum_CR" rb="app.cib.resource.enq.account_enquiry"/>
                            </a></td>
                    ...
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_c"><a href="#" onClick="changeDoc('ca');">
                            <set:label name="functionTitle_ca_CR" rb="app.cib.resource.enq.account_enquiry"/>
                            </a></td>
                          <td class="rtab1_c"><img src="/cib/images/shim.gif" width="7" height="26"></td>
                        </tr>
                      </table></td>
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_c"><a href="#" onClick="changeDoc('sa');">
                            <set:label name="functionTitle_sa_CR" rb="app.cib.resource.enq.account_enquiry"/>
                            </a></td>
                          <td class="rtab1_c"><img src="/cib/images/shim.gif" width="7" height="26"></td>
                        </tr>
                      </table></td>
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_c"><a href="#" onClick="changeDoc('td');">
                            <set:label name="functionTitle_td_CR" rb="app.cib.resource.enq.account_enquiry"/>
                            </a></td>
                          <td class="rtab1_c"><img src="/cib/images/shim.gif" width="7" height="26"></td>
                        </tr>
                      </table></td>
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_c"><a href="#" onClick="changeDoc('oa');">
                            <set:label name="functionTitle_oa_CR" rb="app.cib.resource.enq.account_enquiry"/>
                            </a></td>
                          <td class="rtab1_c"><img src="/cib/images/shim.gif" width="7" height="26"></td>
                        </tr>
                      </table></td>
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_c"><a href="#" onClick="changeDoc('la');">
                            <set:label name="functionTitle_la_CR" rb="app.cib.resource.enq.account_enquiry"/>
                            </a></td>
                          <td class="rtab1_c"><img src="/cib/images/shim.gif" width="7" height="26"></td>
                        </tr>
                      </table></td>
                      ...
                      <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_c"><a href="#" onClick="changeDoc('cc');">
                            <set:label name="functionTitle_cc_CR" rb="app.cib.resource.enq.account_enquiry"/>
                            </a></td>
                          <td class="rtab1_c"><img src="/cib/images/shim.gif" width="7" height="26"></td>
                        </tr>
                      </table></td>
                    ...
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="ltab1_o"><img src="/cib/images/shim.gif" width="7" height="23"></td>
                          <td class="tab1_o"><a href="#" onClick="changeDoc('out');">
                            <set:label name="functionTitle_out_CR" rb="app.cib.resource.enq.account_enquiry"/>
                            </a></td>
                    ...
                    <tr>
                      <td bgcolor=#FFFFFF class=content><table border=0 cellpadding=5 cellspacing=0 width=100% bgcolor=#FFFFFF>
                          ...
                          <tr class="greyline">
                            ...
                            <td class=content colspan="3"><select name="roleId" id="roleId" onChange="showUserList(this, $('userId'));">
                                <option value="0" selected>
                                <set:label name="all"/>
                                </option>
                                <set:if name="corpType" value="1" condition="equals">
                                  <set:rblist file="app.cib.resource.common.corp_role">
                                    <set:rboption name="roleId"/>
                                  </set:rblist>
                                </set:if>
                                <set:if name="corpType" value="2" condition="equals">
                                  <set:rblist file="app.cib.resource.common.corp_role_opt2">
                                    <set:rboption name="roleId"/>
                                  </set:rblist>
                                </set:if>
                                <set:if name="corpType" value="3" condition="equals">
                                  <set:rblist file="app.cib.resource.common.corp_role_opt3">
                                    <set:rboption name="roleId"/>
                                  </set:rblist>
                                </set:if>
                                <set:if name="corpType" value="4" condition="equals">
                                  <set:rblist file="app.cib.resource.common.corp_role_opt4">
                                    <set:rboption name="roleId"/>
                                  </set:rblist>
                                </set:if>
                              </select>
                          ...
                          <tr class="">
                            ...
                            <td class=content colspan="2"><select name="userId" id="userId" nullable="0" >
                                <option value="0" selected>
                                <set:label name="all"/>
                                </option>
                              </select>
                          ...
                          <tr class="greyline">
                            ...
                            <td class=content colspan="3"><select name="procStatus" id="procStatus">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    ...
                    <set:if name= "FinanceFlag" condition="equals" value = "Y">
                      <td  class="listheader1"><set:label name="Currency" defaultvalue="CCY"/></td>
                      <td  class="listheader1"><set:label name="Amount" defaultvalue="Amount"/></td>
                    </set:if>
                    <td class="listheader1"><set:label name="Approve_Status" defaultvalue="Status"/></td>
                    <!-- td class="listheader1"><set:label name="Action" defaultvalue="Action"/></td -->
                    <td class="listheader1"><set:label name="Deal_Memo" defaultvalue="Observations"/></td>
                  </tr>
                  <set:list name="statusWorkList" showPageRows="10" showNoRecord="YES">
                    <tr class="<set:listclass class1='' class2='greyline' />">
                      ...
                      <!--
                  <td class="listcontent1"><a onClick="toTargetFormgoToTarget('/cib/approve.do?ActionMethod=statusEnquiryView&workId=<set:listdata name='workId'/>&returnPage=outstanding')" href="#"><set:listdata name="txnType" rb="app.cib.resource.common.subtype"/></a></td>
-->
                      <td class="listcontent1"><set:listdata name="workDealer"/></td>
                      <td class="listcontent1"><set:list name="progressList">
                          <set:listif name="FinishFlag" condition="equals" value="1"> <span class="textnormal">
                            <set:listdata name="Dealer"/>
                            </span><br>
                          </set:listif>
                          <set:listif name="FinishFlag" condition="equals" value="0"> <span class="textgray">&gt;
                            <set:listdata name="Dealer" rb="app.cib.resource.flow.dealer_type"/>
                            </span><br>
                          </set:listif>
                        </set:list>
                      </td>
                      <set:if name= "FinanceFlag" condition="equals" value = "Y">
                        <td class="listcontent1"><set:listif name="ruleFlag" condition="equals" value="0">
                      ...
                      <td class="listcontent1"><set:listdata name="dealMemo" maxlen="40"/>
                        &nbsp;</td>
                    </tr>
                  </set:list>
                </table>
