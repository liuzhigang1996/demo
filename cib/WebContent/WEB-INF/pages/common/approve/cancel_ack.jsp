...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_cancelack" defaultvalue="MDB Corporate Online Banking > Authorization > Cancel an Operation - Acknowledgement"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_cancelack" defaultvalue="CANCEL AN OPERATION"/><!-- InstanceEndEditable --></td>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		String url = (String) resultData.get("detailPageUrl");
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" colspan="2" class="sectionbutton"><input id="buttonOk" name="buttonOk" type="button" value="<set:label name='buttonOK' defaultvalue='OK'/>" onClick="doCancelReturn()">
                  <input id="ActionMethod" name="ActionMethod" type="hidden" value="statusEnquiry">				  </td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
		  </form>
