...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_changeapprover" defaultvalue="MDB Corporate Online Banking > Change Approver(s)"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_changeapprover" defaultvalue="CHANGE APPROVER(S)"/><!-- InstanceEndEditable --></td>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		String url = (String) resultData.get("detailPageUrl");
			...
			<set:reassignuser selectFlag="Y"/>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" class="sectionbutton"><input id="buttonChange" name="buttonChange" type="button" value="<set:label name='buttonChange' defaultvalue='Change'/>" onClick="doChange()">
				<!--
				...
				-->
                  <input id="ActionMethod" name="ActionMethod" type="hidden" value="changeApprover">
				  <input id="procId" name="procId" type="hidden" value="<set:data name='procId'/>">
				  <input id="transNoToChange" name="transNoToChange" type="hidden" value="<set:data name='transNoToChange'/>">
				  <input id="txnTypeToChange" name="txnTypeToChange" type="hidden" value="<set:data name='txnTypeToChange'/>">
				  </td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
