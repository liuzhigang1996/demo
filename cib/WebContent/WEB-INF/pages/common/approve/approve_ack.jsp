...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_approveack" defaultvalue="MDB Corporate Online Banking > Authorization > Single Authorization - Acknowledgement"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_approveack" defaultvalue="SINGLE AUTHORIZATION"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/approve.do" method="post" name="form1" id="form1">
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr>
                    <td width="28%" class="label1"><b><set:label name="Txn_Ref_Cap" defaultvalue="REFERENCE NO"/></b></td>
                    <td width="72%" class="content1"><b><set:data name="transNo"/></b></td>
                  </tr>
                </table>
				<table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
