		  ...
		  <form action="/cib/messageManage.do" method="post" name="form1" id="form1">
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="3">
             ...
             <tr class="greyline">
               ...
               <td class="content1"><set:data name='messageId'/></td>
             </tr>
           </table>
           <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
              ...
              <tr class="greyline">
                ...
                <td class="content1"><textarea name="msgContent" cols="40" rows="6" style="overflow:hidden" readonly="readonly"><set:data name='msgContent'/></textarea></td>
              </tr>
            </table>
