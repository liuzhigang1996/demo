                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <set:list name="messageList" showPageRows="10" showNoRecord="YES">
                    <tr class="<set:listclass class1='' class2='greyline'/>">
                      ...
                      <td align="center" class="listcontent1"><a onClick="postToMainFrame('/cib/messageManage.do?ActionMethod=viewBySupervisor',{messageId:'<set:listdata name='messageId'/>'})" href="#"><set:label name="View_Detail" defaultvalue="View Detail"/></a></td>
                    </tr>
                  </set:list>
                </table>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="40" colspan="2" class="sectionbutton">
                   	<input id="ActionMethod" name="ActionMethod" type="hidden" value="viewBySupervisor"></td>
                  </tr>
                </table>
                <!-- InstanceEndEditable -->
		  </form>
