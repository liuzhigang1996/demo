...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
        <set:label name="navigationTitle_add" defaultvalue="MDB Corporate Online Banking > Service Maintenance > New Message"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle_add" defaultvalue="NEW MESSAGE"/>
        <!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/messageManage.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr class="greyline">
                    <td class="label1" valign="top"><set:label name="Message_Content" defaultvalue="Message Content"/></td>
                    <td class="content1"><textarea name="msgContent" cols="40" rows="6" style="overflow:hidden" readonly="readonly"><set:data name='msgContent'/>
</textarea></td>
                  </tr>
                </table>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="40" colspan="2" class="sectionbutton"><input id="buttonConfirm" name="buttonConfirm" type="button" value="<set:label name='buttonConfirm' defaultvalue='Confirm'/>" onClick="doConfirm()">
