...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
        <set:label name="navigationTitle_view" defaultvalue="MDB Corporate Online Banking > Service Maintenance > View Message"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle_view" defaultvalue="VIEW MESSAGE"/>
        <!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/messageManage.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    <td colspan="2" class="groupconfirm">&nbsp;</td>
                  </tr>
                  <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="40" class="sectionbutton"><input id="buttonOK" name="buttonOK" type="button" value="<set:label name='buttonOK' defaultvalue='OK'/>" onClick="doReturn()">
                      <input id="ActionMethod" name="ActionMethod" type="hidden" value="listByBankSupervisor">                    </td>
                  </tr>
                </table>
                <!-- InstanceEndEditable -->
		  </form>
