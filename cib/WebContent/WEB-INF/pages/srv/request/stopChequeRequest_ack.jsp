        ...
        <tr>
		  ...
		  <form action="/cib/stopChequeRequest.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr class="greyline">
                <td width="29%" class="label1"><set:label name="Referenc_No" defaultvalue="Reference No"/></td>
                <td width="71%" class="content1"><set:data name='transId'/></td>
              </tr>
			  <tr >
            ...
            <tr class="greyline">
              ...
              <td class="label1" colspan="2"><set:if name='reasonFlag' condition='equals' value='Y'><set:data name='stopReason' rb="app.cib.resource.srv.stop_reason"/></set:if><set:if name='reasonFlag' condition='equals' value='N'><set:data name='stopReason'/></set:if></td>
            </tr>
            </table>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <td colspan="2" class="sectionbutton">
				...
				<input id="ActionMethod" name="ActionMethod" type="hidden" value="stopLoad">
