        ...
        <tr>
		  ...
		  <form action="/cib/protectionChequeRequest.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="history" form="form1" file="check_request" /> </td>
                </tr>
              </table>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="72%" class="content1"><span class="content">
                    ...
                    </span> <set:label name="date_from" defaultvalue="date from"/>
                    <input id="dateFrom" name="dateFrom" type="text" value="<set:data name='dateFrom' format="date"/>
" size="12" maxlength="10" disabled="disabled"> <img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "if(!document.getElementById('dateFrom').disabled){scwShow(document.getElementById('dateFrom'), this,language)};" >&nbsp;&nbsp;&nbsp;&nbsp; <set:label name="date_to" defaultvalue="date to"/>&nbsp;&nbsp;&nbsp;&nbsp;
...
" size="12" maxlength="10" disabled="disabled"> <img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "if(!document.getElementById('dateTo').disabled){scwShow(document.getElementById('dateTo'), this,language)};" >
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr align="center">
                  ...
                  <td align="right" class="content1"><table width="100" border="0" cellspacing="0" cellpadding="0">
                      <%--<tr>
                         <td class="buttonexcel"><a href="/cib/DownloadCVS?listName=toList&fileName=protectionCheque_history&columnTitles=<set:label name='REQUES_DATE'/>,<set:label name='FROM_ACCOUNT'/>,<set:label name='Beneficiary_Name'/>,<set:label name='Issue_Date'/>,<set:label name='Cheque_Number'/>,<set:label name='Amount'/>,<set:label name='STATUS'/>,<set:label name='upload_status'/>&columnNames=requestTime||format@datetime1,account,beneficiaryName,issueDate||format@date,chequeNumber,amount||format@amount,status||rb@app.cib.resource.common.status,detailResult||rb@app.cib.resource.bat.batch_result"><set:label name="download" rb="app.cib.resource.common.operation"/></a> </td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr class="greyline">
                  ...
                  <td class="listheader1"><div align="left"><set:label name="Cheque_Number"  defaultvalue="Cheque Number"/></div></td>
                  <td class="listheader1"><div align="left"><set:label name="Amount"  defaultvalue="Amount"/></div></td>
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  ...
                  <td class="listcontent1"><div align="left"><set:listdata name="account" /></div></td>
                  ...
                  <td class="listcontent1"><div align="left"><set:listdata name="chequeNumber" /></div></td>
                  <td class="listcontent1"><div align="right"><set:listdata name="amount" format="amount"/></div></td>
