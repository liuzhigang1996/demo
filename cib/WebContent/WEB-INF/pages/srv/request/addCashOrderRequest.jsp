...
function doSubmit()
{
	if(validate_cash_order_requst(document.getElementById("form1"))){
    ...
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
		  ...
		  <form action="/cib/cashOrderRequest.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="cash_order_requst" form="form1" file="cash_order" />
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="ltab1_o"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                        <td class="tab1_o"><set:label name="Cash_order_single" defaultvalue="Cash Order Request"/></td>
                  ...
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="tab1_c"><a onClick="toTargetFormgoToTarget('/cib/cashOrderBatchRequest.do?ActionMethod=uploadFileLoad')" href="#"><set:label name="Cash_order_batch" defaultvalue="Bank Draft Batch Request"/></a></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr >
                  ...
                  <td class="content1" colspan="3" ><select id="fromAccount" name="fromAccount" nullable="0" onChange="chargeAccount()">
                ...
                <tr class="greyline">
                  ...
                  <td class="content1" colspan="3" ><select id="toCurrency" name="toCurrency" nullable="0" >
                      ...
                      <set:rblist file="app.cib.resource.srv.cash_order_request_currency"> 
                ...
                <tr >
                  <td class="label1"><set:label name="Cash_Number" defaultvalue="Number of Bank Draft"/></td>
