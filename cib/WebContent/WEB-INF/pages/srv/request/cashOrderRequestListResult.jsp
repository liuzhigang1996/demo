			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr align="center">
                ...
                <td align="right" class="content1"><table width="100" border="0" cellspacing="0" cellpadding="0">
                  <%--<tr>
                    <td class="buttonexcel"><a href="/cib/DownloadCVS?listName=toList&fileName=cashOrder_history&columnTitles=<set:label name='Request_Type'/>,<set:label name='REQUES_DATE'/>,<set:label name='FROM_ACCOUNT'/>,<set:label name='CURRENCY'/>,<set:label name='DRAFT_NUMBER'/>,<set:label name='TOTAL_AMOUNT'/>,<set:label name='STATUS'/>,<set:label name='upload_status'/>&columnNames=requestType,requestTime||format@datetime1,fromAccount,toCurrency||db@currency,totalNumber,toAmount||format@amount,status||rb@app.cib.resource.common.status,batchResult||rb@app.cib.resource.bat.batch_result"><set:label name="download" rb="app.cib.resource.common.operation"/></a> </td>
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
				...
				<td class="listcontent1"><div align="center"><a onClick="toTargetFormgoToTarget('/cib/cashOrderRequest.do?ActionMethod=viewDetail',{batchId:'<set:listdata name="batchId"/>'})" href="#"><set:label name="VIEW_DETAIL" defaultvalue="View Detail"/></div></td>
				</tr>
			  </set:list>
			</table> 
<!-- InstanceEndEditable -->
