...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/cashOrderRequest.do" --><!-- InstanceParam name="help_href" type="text" value="#" passthrough="true" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.srv.cash_order_request" -->
</head>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="3">
			   <tr >
                ...
                <td  class="listheader1"><div align="center"><set:label name="CASHIER_AMOUNT" defaultvalue="CASHIER AMOUNT"/></div></td>
				<td  class="listheader1"><div align="center"><set:label name="BENEFICIARY_NAME1" defaultvalue="BENEFICIARY NAME"/></div></td>
				<td  class="listheader1"><div align="center"><set:label name="upload_status" defaultvalue="upload_status"/></div></td>		<!-- add by lw 20100902 -->
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
                ...
                <td class="listcontent1"><div align="center"><set:listdata name="cashierAmount" format="amount"/></div></td>
