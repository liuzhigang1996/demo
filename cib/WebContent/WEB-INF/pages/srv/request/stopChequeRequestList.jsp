  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		--%></td>
			   ...
			   <td class="ltab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
        <td class="tab1_c">
		<a onClick="toTargetFormgoToTarget('/cib/cashOrderRequest.do?ActionMethod=listLoad')" href="#"><set:label name="Cashier_Order" defaultvalue="Cashier Order Request History"/></a></td>
			   <td class="rtab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
		</tr></table>
			   --%></td>
			   <td>
        ...
        <td class="tab1_o">
		<set:label name="Stop_Cheque" defaultvalue="Stop Cheque Request History"/></a></td>
