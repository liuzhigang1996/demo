...
function pageLoad(){
 <set:list name="inputList">
	...
	putFieldValues("beneficiaryName3_<set:listdata name='index'/>", "<set:listdata name='beneficiaryName3'/>");
	putFieldValues("cashierAmount_<set:listdata name='index'/>", "<set:listdata name='cashierAmount' format='amount'/>");
	// add by lw 20101029
...
function fieldCheck() {
	...
	for (i=0; i<form.elements.length; i++){
		if (form.elements[i].type == 'text') {
			if (form.elements[i].name.substring(0,14) == 'cashierAmount_') {
...
function checkIfShowPurpose(value,index){
	var cashierAmount = document.getElementById("cashierAmount_" + index).value;
	var toCurrency = document.getElementById("toCurrency").value;
	var fromAccount = document.getElementById("fromAccount").value;
	var url = '/cib/jsax?serviceName=CheckNeedPurposeService&transferAmount=' +cashierAmount+ '&debitAmount=' +""+ '&fromAccount='+fromAccount+ '&toCurrency=' +toCurrency+ '&toCountryCode=MO';
	//registerElement('purposeVisible');
	// add by lw 20101026
	//registerElement('proofVisible'); 
	// add by lw end  
	getMsgToElement(url, cashierAmount, '', null,false,language);
		  ...
		  <form action="/cib/cashOrderRequest.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->  <set:messages width="100%" cols="1" align="center"/>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <td align="center" class="content1" colspan="3"><set:data name='currency'/> <set:data name='toAmount' format="amount"/></td>
              </tr>
			  -->
                <tr >
                ...
                <tr class="<set:listclass  class2='greyline'/>">
                  <td align="center" class="listcontent1"><div align="left">
                    ...
                    <input id="beneficiaryName2_<set:listdata name='index'/>" name="beneficiaryName2_<set:listdata name='index'/>" type="text" value="" size="45" maxlength="35"><br>
                    <input id="beneficiaryName3_<set:listdata name='index'/>" name="beneficiaryName3_<set:listdata name='index'/>" type="text" value="" size="45" maxlength="35">
                  </div></td>
                  <td align="center" class="listcontent1"><div align="left">
                      <input name="cashierAmount_<set:listdata name='index'/>" id="cashierAmount_<set:listdata name='index'/>" onBlur="checkIfShowPurpose(this.value,<set:listdata name='index'/>)" type="text" value="" size="20" maxlength="20">
