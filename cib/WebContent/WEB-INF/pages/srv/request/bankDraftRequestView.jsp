...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/bankRequest.do" --><!-- InstanceParam name="help_href" type="text" value="#" passthrough="true" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.srv.bank_draft_request" -->
</head>
		  ...
		  <form action="/cib/bankRequest.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
             <tr class="greyline">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="3">
			   <tr >
                <td class="listheader1"><div align="center"><set:label name="SEQUENCE_NO" defaultvalue="SEQUENCE NO"/></div></td>
                <td class="listheader1"><div align="right"><set:label name="DRAFT_AMOUNT" defaultvalue="DRAFT AMOUNT"/></div></td>
				<td class="listheader1"><div align="left"><set:label name="BENEFICIARY_NAME1" defaultvalue="BENEFICIARY NAME"/></div></td>
				<td class="listheader1"><div align="left"><set:label name="upload_status" defaultvalue="upload_status"/></div></td>	    <!-- add by lw 20100902 -->
				<td  class="listheader1"><div align="center"><set:label name="Purpose" defaultvalue="Purpose"/></div></td>
				<!-- add by lw end -->
			   </tr>
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
                ...
                <td class="listcontent1"><div align="right"><set:listdata name="draftAmount" format="amount"/></div></td>
				...
				<!-- add by lw 20100902 -->				
				<td class="listcontent1"><div align="center"><set:listdata name='purpose' /></div></td>				
				<!-- add by lw end -->
              </tr>
			  </set:list> 
			   <tr class="greyline">
                <td  width="28%" class="label1"><set:label name="Total_Number" defaultvalue="Total Transfer Number "/></td>
                <td  width="72%" class="content1" colspan="4" ><set:data name='totalNumber'/>
				</td>
              </tr>
			   <tr>
                <td class="label1"><set:label name="Total_Amount" defaultvalue="Total Transfer Amount"/></td>
                <td class="content1" colspan="4" ><set:data name='toCurrency' db="rcCurrencyCBS"/><set:data name='totalAmount' format="amount"/>
				</td>
              </tr>
			</table>
			  <table width="100%" border="0" cellpadding="0" cellspacing="0">
