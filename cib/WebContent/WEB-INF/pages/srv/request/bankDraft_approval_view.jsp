...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr >
               ...
               <td class="content1"><set:data name='fromAccount' /><input id="fromAccount" type="hidden" name="fromAccount" value="<set:data name='fromAccount'/>"></td>
			 </tr>
			  <tr class="greyline" >
                <td class="label1"><set:label name="Charge_Account" defaultvalue="Account to be debited for Charges"/></td>
				 <td class="content1"><set:data name='chargeAccount' /><input id="chargeAccount" type="hidden" name="chargeAccount" value="<set:data name='chargeAccount'/>"></td>
              </tr>
</table>
 <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  <tr >
                 <td width="12%" align="left" class="listheader1"><set:label name="Beneficiary_Name" defaultvalue="Beneficiary Name"/></td>
                 <td width="12%" align="right" class="listheader1"><set:label name="Amount_confirm" defaultvalue="Amount"/>(in <set:data name='toCurrency' db="rcCurrencyCBS"/>)</td>
			  ...
			  <tr >
                 ...
                 <td width="12%" align="right" class="content1"><set:data name='toAmount' format="amount" /><input id="toAmount" type="hidden" name="toAmount" value="<set:data name='toAmount'/>"></td>
				 <td width="12%" align="right" class="content1"><set:data name='totalChargesamount' format="amount"/><input id="totalChargesamount" type="hidden" name="totalChargesamount" value="<set:data name='totalChargesamount'/>"></td>
			   </tr>
            </table>
</set:loadrb>
