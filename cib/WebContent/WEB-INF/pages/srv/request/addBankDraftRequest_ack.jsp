        ...
        <tr>
		  ...
		  <form action="/cib/bankRequest.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr>
                <td width="29%" class="label1"><set:label name="Status" defaultvalue="Status"/></td>
				<td width="71%" class="content1"><set:label name='ackStatusAccepted' /></td>
              </tr>
			  <tr class="greyline">
                <td class="label1"><set:label name="Referenc_No" defaultvalue="Reference No"/></td>
                <td class="content1"><set:data name='batchId'/></td>
              </tr>
			  <tr >
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr >
                 <td width="12%" align="center" class="listheader1"><set:label name="Total_Amount" defaultvalue="Total Amount"/></td>
                 <td width="12%" align="right" class="listheader1"><set:data name='toAmount' format="amount" /></td>
				 <td width="12%" align="right" class="listheader1"><set:data name='totalChargesamount' format="amount"/></td>				 <!-- add by lw 20100902 -->				 
				 <td width="12%" align="right" class="listheader1"></td>					
				 <!-- add by lw end -->		
			   </tr>
            </table>
