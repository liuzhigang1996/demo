...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitleList" defaultvalue="BANK Corporation Banking >Cheque > Cheque Book Request"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/stopChequeRequest.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td class="content1" colspan="3"><input id="chequeNumber" name="chequeNumber" type="text" value="<set:data name='chequeNumber'/>" size="15" maxlength="6"></td>
               </tr>
              <tr class="greyline">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr align="center">
                ...
                <td align="right" class="content1"><table width="100" border="0" cellspacing="0" cellpadding="0">
                  <%--<tr>
                    <td class="buttonexcel"><a href="/cib/DownloadCVS?listName=toList&fileName=stopCheque_history&columnTitles=<set:label name='REQUES_DATE'/>,<set:label name='FROM_ACCOUNT'/>,<set:label name='DRAFT_NUMBER'/>,<set:label name='Beneficiary_Name'/>,<set:label name='Issue_Date'/>,<set:label name='Expiry_Date'/>,<set:label name='Stop_Reason'/>,<set:label name='STATUS'/>,<set:label name='upload_status'/>&columnNames=requestTime||format@datetime1,fromAccount,beneficiaryName,issueDate||format@datetime,expiryDate||format@datetime,status||rb@app.cib.resource.common.status,detailResult||rb@app.cib.resource.bat.batch_result"><set:label name="download" rb="app.cib.resource.common.operation"/></a> </td>
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="3">
			   <tr class="greyline">
				...
				<td class="listheader1"><div align="left"><set:label name="Beneficiary_Name" defaultvalue="Beneficiary Name"/></div></td>
				<td class="listheader1"><div align="left"><set:label name="Issue_Date"  defaultvalue="Issue Date"/></div></td>
				<td class="listheader1"><div align="left"><set:label name="Expiry_Date" defaultvalue="Expiry Date"/></div></td>
				<td class="listheader1"><div align="left"><set:label name="STOP_REASON" defaultvalue="STOP REASON"/></div></td>
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
                ...
                <td class="listcontent1"><div align="left"><set:listdata name="currentAccount" /></div></td>
				<td class="listcontent1"><div align="left"><set:listdata name="beneficiaryName" /></div></td>
				<td class="listcontent1"><div align="left"><set:listdata name="issueDate" format="date"/></div></td>
				<td class="listcontent1"><div align="left"><set:listdata name="expiryDate" format="date"/></div></td>
				<td class="listcontent1"><div align="left"><set:listif name="reasonFlag" condition="EQUALS" value="Y"><set:listdata name="stopReason" rb="app.cib.resource.srv.stop_reason"/></set:listif><set:listif name="reasonFlag" condition="EQUALS" value="N"><set:listdata name="stopReason"/></set:listif></div></td>
