...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/protectionChequeRequest.do" --><!-- InstanceParam name="help_href" type="text" value="#" passthrough="true" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.srv.protection_check_request" -->
</head>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="3">
			   <tr >
				...
				<td class="listheader1"><div align="center"><set:label name="CHEQUE_NUMBER" defaultvalue="CHEQUE NUMBER"/></td>
				<td class="listheader1"><div align="center"><set:label name="ISSUE_DATE" defaultvalue="ISSUE DATE"/></td>
				<td class="listheader1"><div align="center"><set:label name="CHEQUE_STYLE" defaultvalue="CHEQUE STYLE"/></td>
				<td class="listheader1"><div align="center"><set:label name="BENEFICIARY_NAME1" defaultvalue="BENEFICIARY NAME"/></td>
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
				...
				<td class="listcontent1"><div align="center"><set:listdata name="chequeStyle" /></div></td>
			   ...
			   <tr class="greyline">
                ...
                <td class="content1" colspan="7" ><set:data name='totalNumber'/>
				</td>
              </tr>
			   <tr>
                <td class="label1"><set:label name="Total_Amount" defaultvalue="Total Transfer Amount"/></td>
                <td class="content1" colspan="4" ><set:data name='currency' db="rcCurrencyCBS"/><set:data name='totalAmount' format="amount"/>
				</td>
              </tr>
			</table>
			  <table width="100%" border="0" cellpadding="0" cellspacing="0">
