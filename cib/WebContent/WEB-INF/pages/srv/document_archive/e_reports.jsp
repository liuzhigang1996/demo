...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/ereports.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.srv.doc_archive" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/ereports.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <tr>
                  ...
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="tab1_o"><a href="#" onClick="changeDoc('reports');"><set:label name="functionTitle_reports"/></a></td>
                ...
                <tr>
                  <td bgcolor="#FFFFFF" class="content"><table border="0" cellpadding="5" cellspacing="0" width="100%" bgcolor="#FFFFFF">
                      ...
                      <tr class="">
                        ...
                        <td width="81" valign="top"><set:label name="operation"/></td>
                        <td width="777"><select name="operation" id="operation" nullable="0">
                            <option value="0" selected><set:label name="all"/></option>
                            <set:rblist db="reportsOperation"> <set:rboption name="operation"/> </set:rblist>
                          </select>
                        </td>
                      </tr>
                      <tr class="greyline">
                        <td valign="top">&nbsp;</td>
                        <td valign="top"><set:label name="reports"/></td>
                        <td width="777"><select name="reports" id="reports" nullable="0">
                            <option value="0" selected><set:label name="all"/></option>
                            <set:rblist db="reportsName"> <set:rboption name="reports"/> </set:rblist>
                          </select>
                        </td>
                      </tr>
                    </table></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  ...
                  <td align="left" class="listheader1"><set:label name="reports"/></td>
                  <td align="left" class="listheader1"><set:label name="type_of_operation"/></td>
                  <td width="11%" align="center" class="listheader1"><set:label name="report"/></td>
                </tr>
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  ...
                  <td class="listcontent1" align="left"><set:listdata name="REPORT_NAME"/></td>
