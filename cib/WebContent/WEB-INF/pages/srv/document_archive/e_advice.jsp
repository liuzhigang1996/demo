...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/eadvice.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.srv.doc_archive" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/eadvice.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <tr>
                  ...
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="tab1_o"><a href="#" onClick="changeDoc('advice');"><set:label name="functionTitle_advice"/></a></td>
                ...
                <tr>
                  <td bgcolor="#FFFFFF" class="content"><table border="0" cellpadding="5" cellspacing="0" width="100%" bgcolor="#FFFFFF">
                      <tr>
                        ...
                        <td colspan="3" valign="top" class="content"><set:label name='range' defaultvalue='range'/>&nbsp;
                      ...
                      <tr class="greyline">
                        ...
                        <td colspan="3" valign="top" class="content"><set:label name='from' defaultvalue='from'/>&nbsp;&nbsp;&nbsp;
                      ...
                      <tr>
                        ...
                        <td colspan="2"><select name="accountType" id="accountType" onChange="showAccList(this, $(accountNo));">
                      ...
                      <tr class="greyline">
                        ...
                        <td colspan="2"><select name="accountNo" id="accountNo" nullable="0">
                            <option value="0" selected><set:label name="all"/></option>
                          </select>
                        </td>
                      </tr>
                      <tr class="">
                        <td valign="top">&nbsp;</td>
                        <td valign="top"><set:label name="operation"/></td>
                        <td colspan="2"><select name="operation" id="operation" nullable="0">
                            <option value="0" selected><set:label name="all"/></option>
                            <set:rblist db="adviceOperation"> <set:rboption name="operation"/> </set:rblist>
                          </select>
                        </td>
                      </tr>
                      <tr class="greyline">
                        <td valign="top">&nbsp;</td>
                        <td valign="top"><set:label name="reference"/></td>
                        <td width="106">
						  <select name="refType" id="refType" onChange="">
                            <option value="0" selected><set:label name="all"/></option>
                            <set:rblist file="app.cib.resource.srv.e_advice_ref_type"> <set:rboption name="refType"/> </set:rblist>
                          </select>
						</td>
                      <td width="661"><input id="reference" type="text" name="reference" maxlength="40" size="60" value="<set:data name='reference'/>"></td>
                      </tr>
                    </table></td>
                </tr>
              </table>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  ...
                  <td align="left" class="listheader1"><set:label name="your_ref"/></td>
                  <td align="left" class="listheader1"><set:label name="bank_ref"/></td>
                  <td align="left" class="listheader1"><set:label name="type_of_operation"/></td>
                  <td width="11%" align="center" class="listheader1"><set:label name="advice"/></td>
                </tr>
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  ...
                  <td class="listcontent1" align="left"><set:listdata name="CLIENT_REFERENCE"/></td>
                  <td class="listcontent1" align="left"><set:listdata name="BANK_REFERENCE"/></td>
                  <td class="listcontent1" align="left"><set:listdata name="TYPE_OF_OPERATION"/></td>
