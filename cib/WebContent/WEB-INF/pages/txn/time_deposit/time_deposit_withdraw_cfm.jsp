...
function doSubmit(arg) {
	...
	if(document.getElementById("corpType").value != "3"){
		if(checkAssignedUser()){
			document.form1.ActionMethod.value = 'withdrawTimeDepositCfm';
			document.form1.submit();
			setFormDisabled("form1");
			setFieldEnabled("cancel");
		} else {
...
function doCancel(){
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="withdrawTimeDepositCancel";
              ...
              <tr>
                <td height="40" colspan="2" class="sectionbutton">
					<input id="ok" name="ok" type="button" value="&nbsp;&nbsp;<set:label name='confirm' defaultvalue=' confirm '/>&nbsp;&nbsp;" onClick="doSubmit('ok')">
				  	...
				  	<input id="currentAccount" name="currentAccount" type="hidden" value="">
				  	<input id="tdAccount" name="tdAccount" type="hidden" value="<set:data name="tdAccount"/>">
				  	<!-- add by lzg 20190820 -->
