            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td height="40" colspan="4" class="sectionbutton" style = "text-align: center;">
	                <input type = "button" class = "sectionbutton" value = "<set:label name='return' defaultvalue='return'/>" onClick="postToMainFrame('/cib/timeDeposit.do?ActionMethod=listTimeDepositWithdrawal','')"/>
