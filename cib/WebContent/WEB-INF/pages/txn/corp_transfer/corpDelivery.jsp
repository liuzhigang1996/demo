...
<set:loadrb file="app.cib.resource.txn.corp_delivery">
<head>
...
function pageLoad(){
	...
	setTimeout(
		function(){
  			showList($('toCorporation'), $('toAccount'),
				function(){
					if('<set:data name="toAccount"/>'!=''){
						$('toAccount').value = '<set:data name="toAccount"/>';
						$('toAccount').onchange();
					}
				}
			);
...
function showTree() {
	var selectCorpId = document.getElementById("toCorporation").value;
...
function changeCorp(arg) {
	putFieldValues("toCorporation", arg);
	showList($('toCorporation'),$('toAccount'));
}
function doSubmit()
{
	if(validate_corpDelivery(document.getElementById("form1"))){
...
function changeToAcc(toAcc){
	if (toAcc != '0' && toAcc != '') {//modify by hjs
		...
		//var url = '/cib/jsax?serviceName=AccInTxnService&showToAcc=' + toAcc + '&language=' + language + 'corpId=<set:data name="corpId" />';
		var url = '/cib/jsax?serviceName=AccInTxnService&showToAcc=' + toAcc + '&language=' + language + '&corpId=<set:data name="corpId" />';
...
function showList(originSelect, targetSelect, callback){
	...
	//add by long_zg 2014-09-04 for BOB_security
	//clearSelect("toAccount");
}
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/corpDelivery.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.corp_delivery" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/corpDelivery.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><set:messages width="100%" cols="1" align="center"/>
                            <set:fieldcheck name="corpDelivery" form="form1" file="corp_transfer" />
                        </td>
                      </tr>
                </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td class="groupinput" colspan="6" ><set:label name="Fill_Info" defaultvalue="Fill the following Information"/></td>
              </tr>
			  <tr>
			   ...
			   <tr class="greyline">
                ...
                <td class="content1" colspan="5" ><set:data name="fromCorporation" /></td>
                </tr>
              <tr >
                <td class="label1"><set:label name="Account_Number" defaultvalue="Account Number"/></td>
                <td class="content1" colspan="5" ><select id="fromAccount" name="fromAccount" nullable="0" onChange="changeFromAcc(this.value)">
				<option value=""><set:label name="select_account" defaultvalue="----- Select an Account ------"/></option>
                  ...
                  </select><div name="showAmountArea" id="showAmountArea" style="display: none"><table border="0" cellpadding="0" cellspacing="0">
                    <tr><td><set:label name="available_balance" defaultvalue="Available Balance :"/>&nbsp;</td><td> <div name="showAmount" format="amount" id="showAmount"></div></td></tr></table></div></td>
                </tr>
				 <tr >
                <td class="label1" colspan="4"></td>
              </tr>
			  <tr class="greyline">
                <td class="label1" colspan="6"><b><set:label name="Transfer_To" defaultvalue="Transfer To"/></b></td>
              </tr>
			  <tr >
                <td class="label1"><set:label name="Corporation" defaultvalue="Corporation"/></td>
                <td class="content1" colspan="5" ><select name="toCorporation" id="toCorporation" nullable="0" onChange="showList(this,$('toAccount'));">
                  <option value=""><set:label name="select_corporation" defaultvalue="----- Select a Corporation ------"/></option>
                  <set:rblist db="corpInTree">
                    <set:rboption name="toCorporation"/>
                  </set:rblist>
                </select>
			  ...
			  <tr class="greyline">
                <td class="label1"><set:label name="Account_Number" defaultvalue="Account Number"/></td>
				 <td class="content1" colspan="5" ><select name="toAccount" id="toAccount" nullable="0" onChange="changeToAcc(this.value)">
				 <option value=""><set:label name="select_account" defaultvalue="----- Select an Account ------"/></option>
                  </select>				</td>
			</tr>
              <tr>
              ...
              <tr class="greyline">
                ...
                <td class="label1" colspan="5" ><set:label name="Transfer_Amount_Info1" defaultvalue="You either input the actual amount of funds to be transferred OR the amount to be debited from the selected account above"/></td>
              </tr>
              <tr>
                <td >&nbsp;</td>
                ...
                <td width="38%" class="content1"><input id="transferAmount" name="transferAmount" type="text" value="<set:data name='transferAmount' format='amount'/>" size="20" maxlength="20" onFocus ="document.form1.debitAmount.value='';"></td>
              </tr>
              <tr class="greyline">
                <td>&nbsp;</td>
              ...
              <tr class="">
                ...
                <td class="content1" colspan="5"> <input id="remark" name="remark" type="text" value="<set:data name='remark'/>" size="40" maxlength="40"></td>
              </tr>
            </table>
