...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/corpSubsidiaryTransfer.do" --><!-- InstanceParam name="help_href" type="text" value="/cib/corpSubsidiaryTransfer.do" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.corp_subsidiary" -->
</head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<!--
    <td class="buttonhelp"><a href="/cib/corpSubsidiaryTransfer.do"><img src="/cib/images/shim.gif" width="36" height="18" border="0"></a></td>
	-->
  </tr>
  <tr>
