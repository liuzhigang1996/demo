...
function doSubmit()
{
	if(validate_corpSubsidiary(document.getElementById("form1"))){
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/corpSubsidiaryTransfer.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.corp_subsidiary" -->
</head>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><set:messages width="100%" cols="1" align="center"/>
                            <set:fieldcheck name="corpSubsidiary" form="form1" file="corp_transfer" /> 
                        </td>
                      </tr>
              </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td class="groupinput" colspan="5"><set:label name="Fill_Info" defaultvalue="Fill the following Information"/></td>
              </tr>
			  <tr>
               ...
               <option value=""><set:label name="select_corporation" defaultvalue="----- Select a Corporation ------"/></option>
			     <set:rblist db="corpInTree">
                   <set:rboption name="fromCorporation"/>
                 </set:rblist>
               </select><a href="#" onClick="showTree('fromCorporation');"> <img src="/cib/images/tree.gif" border="0" align="absmiddle"></a></td> 
                </tr>
              <tr >
			  ...
			  <tr class="greyline">
               ...
               <td class="content1" colspan="4" ><select name="toCorporation" id="toCorporation" nullable="0" onChange="showList(this,$('toAccount'));">
                 <option value=""><set:label name="select_corporation" defaultvalue="----- Select a Corporation ------"/></option>
				 <set:rblist db="corpInTree">
                   <set:rboption name="toCorporation"/>
                 </set:rblist>
               </select><a href="#" onClick="showTree('toCorporation');"> <img src="/cib/images/tree.gif" border="0" align="absmiddle"></a></td> 
                </tr>
			  <tr class="greyline">
                <td class="label1"><set:label name="Account_Number" defaultvalue="Account Number"/></td>
              ...
              <tr class="greyline">
                ...
                <td class="content1" colspan="4" ><set:label name="Transfer_Amount_Info1" /></td>
              </tr>
              <tr>
                <td >&nbsp;</td>
