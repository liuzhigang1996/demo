		  ...
		  <form action="/cib/transferTemplate3rd.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
             <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr class="greyline">
                <td width="20%" class="groupinput"  colspan="4" > <set:label name="Acknowledgement" defaultvalue="Acknowledgement"/> </td>
              </tr>
			   <tr>
                <td class="label1" ><set:label name="Operation" defaultvalue="Operation"/></td>
				<td class="label1" colspan="3"><set:label name="functionTitleAdd" defaultvalue="TRANSFERS TEMPLATE NEW"/></td>
              </tr>
              <tr class="greyline">
                <td class="label1"><set:label name="Status" defaultvalue="Status"/></td>
				<td class="label1" colspan="3"><set:label name='ackStatusAccepted1' /></td>
              </tr>
			 <tr>
			  ...
			  <tr class="greyline">
                ...
                <td class="content1" colspan="3" ><set:data name='fromAccount'/>
				</td>
              </tr>
			  <tr>
                <td class="label1"><set:label name="Amount_to_be_debited" defaultvalue="Amount to be debited"/></td>
                <td class="content1" colspan="3"><set:data name='fromCurrency' db="rcCurrencyCBS"/><set:data name='debitAmount' format="amount"/>
				</td>
              </tr>
			  <tr class="greyline">
			  ...
			  <tr class="greyline">
                ...
                <td class="content1" colspan="3" ><set:data name='toCurrency' db="rcCurrencyCBS"/><set:data name='transferAmount' format="amount"/>
				</td>
              </tr>
              <!-- add by lzg 20190618 -->
              ...
              <tr class="greyline">
                ...
                <td class="content1" colspan="3"> <set:data name='remark'/></td>
              </tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 <tr>
				...
				<input id="ActionMethod" name="ActionMethod" type="hidden" value="addTemplateLoad">				  </td>
