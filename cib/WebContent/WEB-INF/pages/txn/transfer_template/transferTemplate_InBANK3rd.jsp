...
function pageLoad(){
	...
	if(!"<set:data name='toAccount' />" == ""){
		...
		//toCurrency.value = "<set:data name='toCurrency' />" ;
		var toAccount = document.getElementById("toAccount");
		var toCurrency = document.getElementById("toCurrency");
...
function changeFromAcc(fromAcc){
	...
	if (fromAcc != '0' && fromAcc != '') { //modify by hjs
		...
		document.getElementById("toCurrency").value= '<set:data name="toCurrency"/>';
...
function changeToAcc(toAcc){
	...
	if (toAcc != '0' && toAcc != '') {
		...
		document.getElementById("showToCurrency").innerHTML = "";
		var url = '/cib/jsax?serviceName=AccInTxnService&showToAcc=' + toAcc + '&language=' + language + '&to_ccy=' + to_ccy;
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><set:messages width="100%" cols="1" align="center"/>
                            <set:fieldcheck name="transferInBANK" form="form1" file="transfer_BANK" />                        </td>
                      </tr>
                </table>
              ...
              <tr class="greyline">
				...
				<option selected value="" selected><set:label name="select_account" defaultvalue="----- Select  an Account ------"/></option>
                  ...
                  <div name="showAmountArea" id="showAmountArea" style="display: none"><table border="0" cellpadding="0" cellspacing="0">
                    <tr><td><set:label name="availd_balance" defaultvalue="Available Balance :"/>&nbsp;</td><td> <div name="showAmount" id="showAmount"></div></td></tr></table></div>
                    -->
