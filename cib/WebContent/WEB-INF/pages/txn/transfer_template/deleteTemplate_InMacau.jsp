		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  <tr class="greyline">
				...
				<td  class="label1"><set:label name="Accounts_in_Banks_Macau" defaultvalue="Accounts in Banks Macau "/></td>
              </tr>
             <tr>
			  ...
			  <tr>
			   ...
			   <tr class="greyline">
			    ...
			    <td class="content1"><set:data name='toCurrency' db="rcCurrencyCBS"/><set:data name='transferAmount'/>
			    </td>
              </tr>
			  <tr >
