...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
        <set:label name="navigationTitle" defaultvalue="BANK Online Banking >Transfer > Accounts in Other Banks in Macau"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle" defaultvalue="TRANSFER TO ACCOUNTS IN OTHER BANKS IN MACAU"/>
        <!-- InstanceEndEditable --></td>
  ...
  <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><set:messages width="100%" cols="1" align="center"/>
                      <set:fieldcheck name="transferInMacau" form="form1" file="transfer_macau" />                    </td>
                  </tr>
                </table>
              ...
              <tr>
                ...
                <!-- add by lzg 20190522 -->
                  ...
                  <tr class="greyline">
                    ...
                    <td class="content1" colspan="3" >
					<select id="beneficiaryBank" name="beneficiaryBank" nullable="0" >
 				...
 				<tr>
				    ...
				    <td><!-- <div name="showTransferDate" id="showTransferDate" style="display: block"><input name="transferDateString" type="text" id="transferDateString" size="20" maxlength="20"value="<set:data name='transferDateString'/>">
	<img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "scwShow(document.getElementById('transferDateString'), this,language);" ></div> --></td>
                  ...
                  <tr>
                    ...
                    <td  class="content1" colspan="3"><input placeholder="<set:label  name = 'common_input_tips'/>" id="messsage" name="messsage" type="text" value="<set:data name='messsage'/>" size="20" maxlength="20">
				...
				<tr>
     			...
     			<table width="100%">
     			<tr>
                  	<td class="label1" width="23%"><set:label name="Purpose" defaultvalue="Purpose"/></td>
                  	<td class="content1" colspan="3" width="77%">
      				<input id="otherPurpose" name="otherPurpose" value="" type="text" size="35" maxlength="35">
      				</td>
     			</tr>
     			</table>
     			</div>
