            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  <tr class="greyline">
			   ...
			   <tr>
				...
				<td class="label1" ><set:label name="functionTitle" defaultvalue="TRANSFERS TO ACCOUNTS IN BANK"/></td>
              </tr>
			   <tr>
			  ...
			  <tr  >
                ...
                <td class="content1" colspan="5"><set:data name='showExchangeRate' format="rate"/>&nbsp;&nbsp;<span style = "color:red;"><set:label name="Exchange_Rate_Tip" defaultvalue="The Rate is for reference only, the dealing rate will be quoted upon trading."/></span>
                </td>
              </tr>
			   </set:if>
              <tr class="greyline">
