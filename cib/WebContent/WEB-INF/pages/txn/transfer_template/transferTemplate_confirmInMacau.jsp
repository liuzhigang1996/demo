...
{
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="payCancel";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle" defaultvalue="TRANSFER TEMPLATES ADD"/><!-- InstanceEndEditable --></td>
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  <tr>
			   ...
			   <tr>
				...
				<td class="label1" ><set:label name="functionTitle" defaultvalue="TRANSFERS TO ACCOUNTS IN OTHER BANKS IN MACAU"/></td>
              </tr>
			   <tr>
           ...
           <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<input id="ActionMethod" name="ActionMethod" type="hidden" value="transferTemplateConfirm">
				<!-- add by lzg 20190820 -->
