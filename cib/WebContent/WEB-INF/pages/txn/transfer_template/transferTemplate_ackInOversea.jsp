		  ...
		  <form action="/cib/transferTemplateInOversea.do" method="post" name="form1" id="form1">
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  <tr class="greyline">
				...
				<td class="label1" ><set:label name="functionTitle" defaultvalue="Transfers To Accounts In Banks Overseas"/></td>
              </tr>
            ...
            <tr  class="greyline">
			  ...
			  <tr class="greyline">
			    <td class="label1"><set:label name="Beneficiary_Bank" defaultvalue="Name of Beneficiary Bank"/></td>
               <td class="content1"><set:data name='beneficiaryBank1' db="overseaBank"/>
			    </td>
              </tr>
