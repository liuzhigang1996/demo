...
<set:loadrb file="app.cib.resource.txn.template_listOversea">
<head>
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferTemplateInOversea.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.template_listOversea" -->
</head>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="ltab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                        <td class="tab1_c"><a onClick="toTarget('/cib/transferTemplateInMacau.do?ActionMethod=listTemplate')" href="#"><set:label name="Accounts_in_Macau" defaultvalue="Accounts in Other Banks in Macau"/></a></td>
                        <td class="rtab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                      </tr>
                    </table></td>
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="tab1_o"><set:label name="Accounts_in_Overseas" defaultvalue="Accounts in Banks Overseas"/></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  ...
                  <td class="listheader1"><div align="left"><set:label name="Beneficiary_Bank" defaultvalue="Beneficiary  Bank Name"/></div></td>
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  ...
                  <td class="listcontent1"><div align="left"> <set:listif name='bankFlag' condition='equals' value='N'><set:listdata name='beneficiaryBank1' db="overseaBank"/></set:listif> <set:listif name='bankFlag' condition='equals' value='Y'><set:listdata name='beneficiaryBank1'/></set:listif> </div></td>
