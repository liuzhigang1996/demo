...
function doSubmit()
{
	...
	if(validate_templateInBANK(document.getElementById("form1"))){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleAdd" defaultvalue="TRANSFER Templates Add"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/transferTemplate.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><set:messages width="100%" cols="1" align="center"/>
                            <set:fieldcheck name="templateInBANK" form="form1" file="transfer_template_BANK" />                        </td>
                      </tr>
                </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="greyline">
                <td width="17%" valign="top" class="label1"><span class = "xing">*</span><set:label name="From_Account" defaultvalue="Account Number"/></td>
              ...
              <tr>
                ...
                <td width="39%" class="label1"><set:label name="Amount_to_be_Transferred" defaultvalue="Amount to be Transferred"/></td>
                <td width="6%" align="right" class="content1"><div name="showToCurrency" id="showToCurrency"><set:data name="toCurrency" db="rcCurrencyCBS"/></div></td>
              ...
              <tr class="greyline">
                <td></td>
                <td width="39%" class="label1"><set:label name="Transfer_Info1" defaultvalue="Amount to be debited from the selected account above"/></td>
              ...
              <tr class="greyline">
                ...
                <td class="content1" colspan="3"><input id="remarkHost" name="remarkHost" type="text" value="<set:data name='remarkHost'/>" size="60" maxlength="120" ></td>
              </tr>
              <!-- end -->
            </table>
