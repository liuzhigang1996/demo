           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><set:messages width="100%" cols="1" align="center"/>
                      <set:fieldcheck name="templateInOversea" form="form1" file="transfer_template_oversea" />
                    </td>
                  </tr>
                </table>
              ...
              <tr>
                ...
                <tr >
                  ...
                  <tr class="greyline">
                    ...
                    <td class="content1" colspan="3" >
					<select name="beneficiaryBank1" id="beneficiaryBank1" nullable="0"  onChange="changeCgd(this.value);otherBankControl(this.value);">
