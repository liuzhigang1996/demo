...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleDelete" defaultvalue="TRANSFER TEMPLATES DELETE"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/transferTemplateInOversea.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				 <td class="groupinput" colspan="4"><set:label name="Delete" defaultvalue="Delete"/></td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr class="greyline">
                <td class="label1" width="40%" ><set:label name="Type_of_Transfer" defaultvalue="Type of Transfer"/> </td>
				<td  class="label1"><set:label name="Accounts_in_Banks_Overseas" defaultvalue="Accounts in Banks Overseas "/></td>
              </tr>
			   <tr>
			...
			<tr class="greyline">
              ...
              <tr >
			    <td class="label1"><set:label name="To_Amount" defaultvalue="To Amount"/></td>
               <td class="content1"><set:data name='toCurrency' db="rcCurrencyCBS"/><set:data name='debitAmount' format="amount"/>
			    </td>
              </tr>
              <tr class="greyline">
	              <td  colspan="4">&nbsp;</td>
			  ...
			  <!-- /* Modify by long_zg 2019-05-21 UAT6-194 COB：海外匯款出現相同的兩個欄位 begin */ -->
			   <!--
			  ...
			  -->
			  <!-- /* Modify by long_zg 2019-05-21 UAT6-194 COB：海外匯款出現相同的兩個欄位 end */ -->
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<input id="submit1" name="submit1" type="button" value="<set:label name='Delete' defaultvalue='Delete' />" tabindex="3"  onClick="doSubmit();">
				  <input id="ActionMethod" name="ActionMethod" type="hidden" value="deleteTemplate">
				  <set:singlesubmit/>
				  </td>
              </tr>
            </table>
