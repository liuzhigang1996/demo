           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  <tr class="greyline">
			   ...
			   <tr>
				...
				<td class="label1" ><set:label name="functionTitleAdd" defaultvalue="Transfers Template New"/></td>
              </tr>
              <tr class="greyline">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 <tr>
				...
				<input id="submit1" name="submit1" type="button" value="<set:label name='do_it_again' defaultvalue=' submit ' />" tabindex="3"  onClick="doSubmit();">
