...
function changeFromAcc(fromAcc){
	...
	if (fromAcc != '0' && fromAcc != '') { //modify by hjs
		...
		var url = '/cib/jsax?serviceName=AccInTxnService&showFromAcc=' + fromAcc + '&from_ccy=' + from_ccy + '&language=' + language;
...
/*function checkIfShowPurpose(){
		...
		if(vi == "visible"){
			...
			if(pi == "needproof"){
				...
				//add by long_zg 2015-07-30 for BOB production bug begin
				document.getElementById('proofCheckBox').checked = false;
				//add by long_zg 2015-07-30 for BOB production bug end
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
        <set:label name="navigationTitle" defaultvalue="BANK Online Banking >Transfer > Accounts in Overseas"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle" defaultvalue="TRANSFER TO ACCOUNTS IN BANKS OVERSEAS"/>
        <!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><set:messages width="100%" cols="1" align="center"/>
                      <set:fieldcheck name="transferInOversea" form="form1" file="transfer_oversea" />
                    </td>
                  </tr>
                </table>
				...
				<option selected value="" selected><set:label name="select_account" defaultvalue="----- Select  an Account ------"/></option>
				  ...
				  <div name="showAmountArea" id="showAmountArea" style="display: none"><table border="0" cellpadding="0" cellspacing="0">
                    <tr><td><set:label name="available_balance" defaultvalue="Available Balance :"/>&nbsp;</td><td> <div name="showAmount" id="showAmount"></div></td></tr></table></div></td>			
                  </tr>
                  -->
              ...
              <tr>
	           ...
	           <tr class="greyline" >
                  ...
                  <tr >
                    ...
                    <td  class="content1"  colspan="3">
					<input placeholder="<set:label  name = 'common_input_tips'/>" id="messsage" name="messsage" type="text" value="<set:data name='messsage'/>" size="45" maxlength="35">
					<br>
				...
				<tr>
     			...
     			--><!-- modified by lzg end -->
                  <tr>
                    ...
                    <td class="content1" colspan="3">
                      <input placeholder="<set:label  name = 'common_input_tips'/>" id="remark" name="remark" type="text" value="<set:data name='remark'/>" size="45" maxlength="120"></td>
                  </tr>
                </table>
...
<!--                  <input id="bottonReset" name="bottonReset" type="reset" onClick="document.getElementById('showAmountArea').style.display='none';" value="<set:label name='buttonReset' defaultvalue='Reset'/>"> -->
				 <input id="ActionMethod" name="ActionMethod" type="hidden" value="transferTemplate">	
