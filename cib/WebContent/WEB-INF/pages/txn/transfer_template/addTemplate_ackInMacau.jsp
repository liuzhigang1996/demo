...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleAdd" defaultvalue="TRANSFER TEMPLATE ADD"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/transferTemplateInMacau.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
			   ...
			   <tr>
				...
				<td width="72%" class="label1" ><set:label name="functionTitleAdd" defaultvalue="TRANSFER TEMPLATE ADD"/></td>
              </tr>
              <tr class="greyline">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 <tr>
				...
				<input id="submit1" name="submit1" type="button" value="<set:label name='submitl' defaultvalue=' submit ' />" tabindex="3"  onClick="doSubmit();">
