		  ...
		  <form action="/cib/transferTemplate3rd.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <tr class="greyline">
				...
				<td  class="label1"><set:label name="Accounts_in_Banks_Bank" defaultvalue="Accounts in Banks Bank "/></td>
              </tr>
              <tr>
			  ...
			  <tr >
               ...
               <td class="content1"><set:data name='fromCurrency' db="rcCurrencyCBS"/><set:data name='debitAmount'/>
			    </td>
              </tr>
			  <tr class="greyline">
              ...
              <!-- end -->
			   ...
			   <tr class="greyline">
                ...
                <td class="content1" colspan="2"><set:data name='toCurrency' db="rcCurrencyCBS"/><set:data name='transferAmount'/>
                </td>
              </tr>
              <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<input id="submit1" name="submit1" type="button" value="<set:label name='Delete' defaultvalue=' OK ' />" tabindex="3"  onClick="doSubmit();">
