...
{
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="listTemplate";
	document.getElementById("form1").submit();
}
</script>
		  ...
		  <form action="/cib/transferTemplateInOversea.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
			 ...
			 <tr >
			   ...
			   <tr>
				...
				<td class="label1" ><set:label name="functionTitleDelete" defaultvalue="Transfers Template Delete"/></td>
              </tr>
			   <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <td height="40" colspan="2" class="sectionbutton">
				...
				<input id="ActionMethod" name="ActionMethod" type="hidden" value="deleteTemplateConfirm">
				<set:singlesubmit/>
				  </td>
              </tr>
            </table>
