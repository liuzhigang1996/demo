...
function changeFromAcc(fromAcc){
	...
	if (fromAcc != '0' && fromAcc != '') { //modify by hjs
		...
		document.getElementById("fromCurrency").value=document.getElementById("showFromCurrency").innerHTML;
	}else{
			 ...
			 <table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<option selected value="" selected><set:label name="select_account" defaultvalue="----- Select  an Account ------"/></option>
                  <set:list name="transferuser"> <option value="<set:listdata  name='ACCOUNT_NO' />" 
                      ...
                      <%--<input type="hidden" name="fromCurrency" id="fromCurrency" value="<set:data name='fromCurrency'/>"> --%><div name="showAmountArea" id="showAmountArea" style="display: none"><table border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <!-- add by lzg end -->
                 ...
                 <tr class="greyline">
                    ...
                    <td class="content1" colspan="3"><input placeholder="<set:label  name = 'common_input_tips'/>" id="remark" name="remark" type="text" value="<set:data name='remark'/>" size="60" maxlength="120" ></td>
                  </tr>
				<tr>
