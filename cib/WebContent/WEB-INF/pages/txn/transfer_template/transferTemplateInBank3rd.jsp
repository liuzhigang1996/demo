...
<set:loadrb file="app.cib.resource.txn.template_listBank3rd">
<head>
...
function doSubmit(arg) {
	if (arg == 'add') {
		document.form1.ActionMethod.value = 'addTemplateLoad3rd';
		document.form1.submit();
		setFormDisabled('form1');
	} else {
		if(validate_templateList(document.getElementById("form1"))){
			if (arg == 'execute') {
				document.form1.ActionMethod.value = 'transferTemplateLoad3rd';
			} else if (arg == 'edit') {
				document.form1.ActionMethod.value = 'editTemplateLoad3rd';
			} else if (arg == 'delete') {
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferTemplate.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.template_listBank" -->
</head>
                ...
                <tr>
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="tab1_c"><a onClick="postToMainFrame('/cib/transferTemplate.do?ActionMethod=listTemplate',{ownerAccFlag:'Y'})" href="#"><set:label name="Accounts_in_BANK" defaultvalue="Accounts in BANK"/></a></td>
                  ...
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="tab1_o"><set:label name="Accounts_in_BANK_3RD" defaultvalue="To MDB Account"/></td>
