...
function doSubmit(arg) {
	if(validate_card_payment(document.getElementById("form1"))){
		...
		if (arg == 'ok') {
			document.form1.ActionMethod.value = 'frequentCardPayment';
		}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_frequent_card" defaultvalue="MDB Corporate Online Banking > Bill Payment > Frequent Credit Card Payment"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_frequent_card" defaultvalue="FREQUENT CREDIT CARD PAYMENT"/><!-- InstanceEndEditable --></td>
