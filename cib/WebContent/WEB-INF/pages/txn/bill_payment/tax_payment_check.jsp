...
function doSubmit(arg) {
	if(validate_tax_payment_check(document.getElementById("form1"))){
		//document.getElementById("submit1").disabled=true;
		if (arg == 'ok') {
			document.form1.ActionMethod.value = 'taxPaymentCheck';
		}
		  ...
		  <form action="/cib/billPayment.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><set:messages width="100%" cols="1" align="center"/>
						<set:fieldcheck name="tax_payment_check" form="form1" file="bill_payment" />
					</td>
				</tr>
			</table>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="greyline">
                ...
                <td width="72%" class="content1">
                  	<select name="billType" id="billType" nullable="0">
						<option value="0" selected><set:label name="sel_tax"/></option>
                      	<set:rblist db="tax">
							<set:rboption name="billType"/>
						</set:rblist>
                	</select>
                  	<input name="category" type="hidden" id="category" value="970">
				</td>
              </tr>
              <tr>
              ...
              <tr class="greyline">
                ...
                <td width="72%" class="content1">
                  <input name="billNo2" type="text" id="billNo2" maxlength="16" value="<set:data name='billNo2'/>">
				</td>
              </tr>
            </table>
