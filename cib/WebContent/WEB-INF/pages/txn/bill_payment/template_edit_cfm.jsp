...
function doSubmit(arg) {
	if (arg == 'ok') {
		document.form1.ActionMethod.value = 'editTemplateCfm';
	} else if (arg == 'cancel') {
...
function doCancel(){
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="editTemplateCancel";
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  ...
                  <td width="72%" class="content1"><set:label name='functionTitle_tmp_edit'/></td>
                </tr>
                <tr>
                    ...
                    <div id="card" style="display:none">
                      <table width="100%" border="0" cellpadding="3" cellspacing="0">
                        ...
                        <tr class="greyline">
                          ...
                          <td class="content1"><span id="card_ccy"></span> <set:data name='transferAmount'/> </td>
                        </tr>
                        <tr>
                          <td class="label1"><set:label name="remark" defaultvalue="remark"/></td>
                          <td class="content1"><set:data name='remark'/> </td>
