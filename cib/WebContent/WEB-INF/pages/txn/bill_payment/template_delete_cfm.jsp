...
function doSubmit(arg) {
	if (arg == 'ok') {
		document.form1.ActionMethod.value = 'deleteTemplateCfm';
	} else if (arg == 'cancel') {
...
function doCancel(){
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="deleteTemplateCancel";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_tmp_delete" defaultvalue="MDB Corporate Online Banking > Pay Bills > DELETE Frequent Payment List"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_tmp_delete" defaultvalue="Delete An Item From Frequent Payment List"/><!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  ...
                  <td width="72%" class="content1"><set:label name='functionTitle_tmp_delete'/></td>
                </tr>
                <tr>
                      ...
                      <table width="100%" border="0" cellpadding="3" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td class="content1"><set:data name='fromAccount' db="accountByUser"/>
                            <input id="fromAccountName" type="hidden" name="fromAccountName" value="<set:data name='fromAccountName' format="amount"/>">
                          </td>
                        </tr>
                        <tr class="greyline">
                    ...
                    <div id="card" style="display:none">
                      <table width="100%" border="0" cellpadding="3" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td class="content1"><set:data name='fromAccount' db="accountByUser"/> </td>
                        </tr>
                        <tr class="greyline">
                          <td class="label1"><set:label name="payment_amount" defaultvalue="payment_amount"/></td>
                          <td class="content1"><span id="card_ccy"></span> <set:data name='transferAmount' format="amount"/> </td>
                        </tr>
                        <tr>
                          <td class="label1"><set:label name="remark" defaultvalue="remark"/></td>
                          <td class="content1"><set:data name='remark'/> </td>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="40" colspan="2" class="sectionbutton"><input id="ok" name="ok" type="button" value="&nbsp;&nbsp;<set:label name='confirm' defaultvalue=' confirm '/>&nbsp;&nbsp;" onClick="doSubmit('ok')">
