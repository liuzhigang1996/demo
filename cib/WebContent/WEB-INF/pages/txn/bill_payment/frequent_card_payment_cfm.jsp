...
function doSubmit(arg) {
	if (arg == 'ok') {
		if(checkAssignedUser()){
			document.form1.ActionMethod.value = 'frequentCardPaymentCfm';
		...
		document.form1.ActionMethod.value = 'cardPaymentLoad';
		document.form1.submit();
		setFormDisabled("form1");
		setFieldEnabled("cancel");
	}
...
function doCancel(){
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="frequentCardPaymentCancel";
		  ...
		  <form action="/cib/billPayment.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                ...
                <td width="72%" class="content1"><set:data name='billNo1'/> - 
                  <set:data name='currency' db="rcCurrencyCBS"/>
				</td>
              </tr>
              <tr class="greyline">
