...
<input id="fieldsToBeSigned" type="hidden" name="fieldsToBeSigned" value="billNo1|currency|transferAmount|fromAccount|debitCurrency|debitAmount|remark">
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td width="28%" class="label1"><set:label name="card_no" defaultvalue="card_no" rb='app.cib.resource.txn.bill_payment'/></td>
    <td width="72%" class="content1"><set:data name='billNo1'/> - <set:data name='currency' db="rcCurrencyCBS"/>
      ...
      <input id="currency" type="hidden" name="currency" value="<set:data name='currency' db="rcCurrencyCBS"/>"></td>
  </tr>
  <tr class="greyline">
    ...
    <td width="72%" class="content1"><set:data name='currency'/> - <set:data name='transferAmount' format='amount'/>
      <input id="transferAmount" type="hidden" name="transferAmount" value="<set:data name='transferAmount'/>">
    </td>
  </tr>
  <tr class="">
    <td width="28%" class="label1"><set:label name="debit_account" defaultvalue="debit_account" rb='app.cib.resource.txn.bill_payment'/></td>
    <td width="72%" class="content1"><set:data name='fromAccount' db='accountByUser'/>
      <input id="fromAccount" type="hidden" name="fromAccount" value="<set:data name='fromAccount'/>">
    </td>
  </tr>
  <tr class="greyline">
