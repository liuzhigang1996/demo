...
function doSubmit(arg) {
	if(validate_card_payment(document.getElementById("form1"))){
		//document.getElementById("submit1").disabled=true;
		if (arg == 'ok') {
			document.form1.ActionMethod.value = 'cardPayment';
		}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_card" defaultvalue="MDB Corporate Online Banking > Pay Bills > Credit Card Payment"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_card" defaultvalue="CREDIT CARD PAYMENT"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/billPayment.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="2" class="groupinput"><set:label name="input_card_no" defaultvalue="input_card_no"/></td>
              </tr>
              <tr>
                <td width="28%" class="label1"><set:label name="card_no" defaultvalue="card_no"/></td>
                <td width="72%" class="content1"><set:data name='billNo1'/> - <set:data name='currency' db="rcCurrencyCBS"/>
				</td>
              </tr>
              <tr class="greyline">
                <td width="28%" class="label1" valign="top"><set:label name="debit_account" defaultvalue="debit_account"/></td>
                <td width="72%" class="content1">
					...
					<input type="hidden" name="balAccount" id="balAccount" value="">
                  	<span id="showFromCurrency"></span>&nbsp;&nbsp;<span format="amount" id="showAmount"></span>
				</td>
              </tr>
              <tr class="">
                <td width="28%" class="label1"><set:label name="payment_amount" defaultvalue="payment_amount"/></td>
                <td width="72%" class="content1"><set:data name='currency' db="rcCurrencyCBS"/> - 
                  <input name="transferAmount" type="text" id="transferAmount" size="20" maxlength="20" value="<set:data name='transferAmount' format='amount'/>">
				</td>
              </tr>
              <tr class="greyline">
                <td width="28%" class="label1"><set:label name="remark" defaultvalue="remark"/></td>
                <td width="72%" class="content1"><input name="remark" type="text" id="remark" value="<set:data name='remark'/>" size="50" maxlength="50">
				</td>
              </tr>
            </table>
