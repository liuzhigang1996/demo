...
&nbsp; <set:label name='date_from' defaultvalue='date_from'/>&nbsp;
                  ...
                  <set:rblist file="app.cib.resource.common.date_selection">
                    <set:rboption/>
                      ...
                      <tr class="greyline">
                        ...
                        <td class=content colspan="3"><select id="merchant" name="merchant" onChange="">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td height="40" valign="middle" class="content1" align="right"><table width="100" border="0" cellspacing="0" cellpadding="0">
                      <%--<tr>
                        <td class="buttonexcel"><a href="/cib/DownloadCVS?listName=historyList&fileName=payment_history&columnTitles=<set:label name='date_paid'/>,<set:label name='merchant'/>,<set:label name='billNoAndCardNo'/>,<set:label name='remark'/>,<set:label name='ccy'/>,<set:label name='payment_amount'/>,<set:label name='debit_account'/>,<set:label name='status'/>&columnNames=requestTime||format@datetime,merchant||db@merchantAll,billNo1,billNo2,currency,transferAmount||format@amount,fromAccount,status||rb@app.cib.resource.common.status"><set:label name="download" rb="app.cib.resource.common.operation"/></a> </td>
                      </tr>
                    --%></table></td>
                </tr>
              </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  ...
                  <td class="listheader1"><div align="left"><set:label name="merchant" defaultvalue="merchant"/></div></td>
                  <td class="listheader1"><div align="left"><set:label name="billNoAndCardNo" defaultvalue="billNoAndCardNo"/><br>
                      <set:label name="remark" defaultvalue="remark"/></div></td>
                  <td class="listheader1"><div align="center"><set:label name="ccy" defaultvalue="ccy"/></div></td>
                  <td class="listheader1"><div align="right"><set:label name="payment_amount" defaultvalue="payment_amount"/></div></td>
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  ...
                  <td class="listcontent1"><div align="left"><set:listdata name="billNo1"/>&nbsp;<br>
                      <set:listif name="payType" condition="equals" value="3"><set:listdata name="billNo2"/><br>
                      </set:listif> <set:listdata name="remark"/>&nbsp;</div></td>
                  <td class="listcontent1" valign="middle"><div align="center"><set:listdata name="currency" db="rcCurrencyCBS"/></div></td>
                  <td class="listcontent1" valign="middle"><div align="right"><set:listdata name="transferAmount" format="amount"/></div></td>
                  <td class="listcontent1" valign="middle"><div align="left"><set:listdata name="fromAccount"/>&nbsp;<set:listif name='billName' condition='notequals' value=''><br><set:listdata name="billName"/>&nbsp;</set:listif></div></td>
