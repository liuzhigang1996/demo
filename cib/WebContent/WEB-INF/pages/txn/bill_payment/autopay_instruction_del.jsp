...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_autopay_delete" defaultvalue="AUTOPAY INSTRUCTION - Delete"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/autopayAuthorization.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="groupseperator"><set:label name="CONFIRM_INFORMATION" defaultvalue="CONFIRM_INFORMATION"/></td>
              </tr>
            </table>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" colspan="2" class="sectionbutton">
                	<input id="ok" name="ok" type="button" value="&nbsp;&nbsp;<set:label name='OK' defaultvalue=' OK '/>&nbsp;&nbsp;" onClick="doSubmit('delete')">
					<input id="cancel" name="cancel" type="button" value="&nbsp;&nbsp;<set:label name='Cancel' defaultvalue=' Cancel '/>&nbsp;&nbsp;" onClick="doSubmit('listAutopay')">
