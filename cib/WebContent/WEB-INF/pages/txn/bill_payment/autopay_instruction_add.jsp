...
function pageLoad(){
	selectAcct() ;
	var payOption = "<set:data name='payOption'/>";
	if (payOption!='P'){
		disablePayLimit();
	}
}
function selectAcct() {
	...
	var paymentType = document.getElementById("apsCode") ;
	var selectValue = paymentType.options[paymentType.selectedIndex].value ;
	if(card_merchant==selectValue){
...
function doSubmit(arg){
	...
	//alert(contractNo.search("^[a-zA-Z0-9+.\\-/\\\\ ]*$")) ;
	if("cancel"==arg){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_autopay_add" defaultvalue="AUTOPAY INSTRUCTION - ADDITION"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/autopayAuthorization.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                ...
                <select id="apsCode" name="apsCode" onChange="selectAcct()">
                  <set:rblist db="autopay">
                    <set:rboption name="apsCode"/>
                  </set:rblist>
                </select>
				</td>
              </tr>
              <tr>
                ...
                <td width="72%" class="content1">
                <input type="text" name="contractNo" id="contractNo" maxlength="16" value="<set:data name='contractNo' />">
				</td>
              </tr>
              <tr class="">
              ...
              <td width="28%" class="label1" valign="top">&nbsp;</td>
                <td width="72%" class="content1"><input type="radio" name="payOption" value="P" onClick="enablePayLimit()" <set:if name='payOption' condition='equals' value='P'>checked</set:if>> <set:label name="Input_Amout" defaultvalue="Input Amout"/>&nbsp;&nbsp;&nbsp;<input type="text" name="paymentLimit" id="paymentLimit" 
                 value="<set:data name='paymentLimit'/>" <set:if name="paymentLimit" condition="equals" value="0.0">disabled</set:if>>
				</td>
              </tr>
              <tr class="">
