...
function doSubmit(){
	...
	if(validate_transferInOversea(document.getElementById("form1"))){
...
function showcorrBankCode(operator,firstRecord,endRecord,isFirstSearch,searchType){
	if(operator == "swiftCode"){
		if(searchType == "correspondentBank"){
			var arg = document.getElementById("correspondentBankCode").value.trim();
		}else{
...
<!-- add by lzg end -->
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInOversea.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.transfer_oversea" -->
</head>
        ...
        <tr>
		  ...
		  <form action="/cib/transferInOversea.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="transferInOversea" form="form1" file="transfer_oversea" /> </td>
                </tr>
              </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr >
                  <td width="20%" class="label1",colspan="3"><span>&nbsp;&nbsp;</span><b> <set:label name="Transfer_From" defaultvalue="Transfer From"/></b>
                ...
                <tr class="greyline">
                  ...
                  <td class="content1" valign="top" colspan="4" ><!--<select id="fromAccount" name="fromAccount" nullable="0" onChange="changeFromAcc(this.value)">
              ...
              <tr>
                ...
                <!-- add by lzg 20190523 -->
                <tr class="greyline">
                  <td class="label1"><span class = "xing">*</span><set:label name="Beneficiary_Account" defaultvalue="Beneficiary Account"/></td>
                ...
                <tr >
                  ...
                  <td  class="content1"  colspan="3"><input placeholder="<set:label  name = 'common_input_tips'/>"  id="beneficiaryName3" name="beneficiaryName3" type="text" value="<set:data name='beneficiaryName3'/>" size="45" maxlength="31"><br>
                ...
                <tr >
                  ...
                  <td class="content1" colspan="3" ><table><tr><td><select name="beneficiaryCountry" id="beneficiaryCountry" nullable="0"  onChange="showList(this, $('beneficiaryCity'),'country');">
                      <option value="" selected><set:label name="select_country" defaultvalue="---Select a Country ---"/></option>
                ...
                <tr class="greyline">
                  ...
                  <td class="content1" colspan="3" ><table><tr><td><select name="beneficiaryCity" id="beneficiaryCity" nullable="0"  onChange="otherCityControl(this.value);"><!--add follows: showList(this, $('beneficiaryBank1'),'city'); -->
                      <option value="" selected><set:label name="select_city" defaultvalue="---Select a City ---"/></option>
                ...
                <tr class="greyline">
                  ...
                  <td class="content1" colspan="3" ><select name="beneficiaryBank1" id="beneficiaryBank1" nullable="0"  onChange="changeCgd(this.value);otherBankControl(this.value);">
                      <option value="0" selected><set:label name="select_bene_bank" defaultvalue="---Select a Beneficiary Bank---"/></option>
                    </select>
                ...
                <tr class="greyline">
                 ...
                 <tr >
                  <td class="label1"><span class = "xing">*</span><set:label name="Transfer_Date" 	defaultvalue="Transfer Date "/></td>
                  <td colspan="3" class="content1" ><table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><set:rblist file="app.cib.resource.txn.transfer_Date"> <!--  Modify by long_zg 2019-05-29 UAT6-466 COB：匯款預約封掉不上（本澳匯款、海外匯款 begin  --><!-- <input id="requestType" type="radio" name="requestType" value="<set:rbkey />" <set:rbselected equals="requestType" output="checked"/> onClick="changeRequestType(this.value)"><set:rbvalue />--> <input id="requestType" type="radio" name="requestType" value="<set:rbkey />" checked ><set:rbvalue /> <!--  Modify by long_zg 2019-05-29 UAT6-466 COB：匯款預約封掉不上（本澳匯款、海外匯款 end  --> </set:rblist> &nbsp;&nbsp;&nbsp;</td>
                        <td><div name="showTransferDate" id="showTransferDate" style="display: none">
                            <input name="transferDateString" type="text" id="transferDateString" size="20" maxlength="20" value="<set:data name='transferDateString'/>">
                            <img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "scwShow(document.getElementById('transferDateString'), this,language);" > </div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr class="greyline">
                  ...
                  <td  class="content1"  colspan="3"><input placeholder="<set:label  name = 'common_input_tips'/>" id="messsage" name="messsage" type="text" value="<set:data name='messsage'/>" size="45" maxlength="35">
                    <br>
                    <input placeholder="<set:label  name = 'common_input_tips'/>" id="messsage2" name="messsage2" type="text" value="<set:data name='messsage2'/>" size="45" maxlength="35"><br>
                    <input placeholder="<set:label  name = 'common_input_tips'/>" id="messsage3" name="messsage3" type="text" value="<set:data name='messsage3'/>" size="45" maxlength="35">
                  </td>
                </tr>
                <tr >
				...
				<!--<div name="purposeVisible" id="purposeVisible" style="display:none"></div>				
				...
				<!--<tr>
     			...
     			<table width="100%">
     			<tr>
                  	<td class="label1" width="20%"><set:label name="Purpose" defaultvalue="Purpose"/></td>
                  	<td class="content1" colspan="3" width="80%">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr >
                  <td colspan="2" class="sectionbutton"><input id="submit1" name="submit1" type="button" value="<set:label name='Transfer' defaultvalue=' OK ' />" tabindex="3"  onClick="doSubmit();">
