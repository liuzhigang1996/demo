...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInbankTest.do" --><!-- InstanceParam name="help_href" type="text" value="#" passthrough="true" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.transfer_bank" -->
</head>
		  ...
		  <form action="/cib/transferInbankTest.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr >
               ...
               <td class="content1"><set:data name='fromCurrency'/><set:data name='debitAmount' format="amount"/>
			    </td>
              </tr>
			  <tr class="greyline">
			  ...
			  <tr >
			   ...
			   <tr class="greyline">
                ...
                <td class="content1" colspan="2"><set:data name='toCurrency'/><set:data name='transferAmount' format="amount"/>
                </td>
              </tr>
