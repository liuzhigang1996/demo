		  ...
		  <form action="/cib/transferInBANK3rd.do" method="post" name="form1" id="form1">
            ...
            <set:if name = "corpType" condition="notequals" value = "3" >
			 ...
			 <tr>
				...
				<input id="ActionMethod" name="ActionMethod" type="hidden" value="addLoad3rd">
				...
				<td width="200" >
				  <table width="200" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="buttonsavetemp"><a  onClick="postToMainFrame('/cib/transferInBANK3rd.do?ActionMethod=saveTemplate',{transId:'<set:data name='transId'/>'})"><set:label name="Save_As_Transfer_Template" defaultvalue="Save As Transfer Template"/></a></td>
                    </tr>
                  </table>
                </td>
              </tr>
