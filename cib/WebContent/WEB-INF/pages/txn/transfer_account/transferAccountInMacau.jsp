...
function doSubmit()
{
	...
	if(validate_transferInMacau(document.getElementById("form1"))){
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInMacau.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.transfer_macau" -->
</head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --> <set:label name="functionTitle" defaultvalue="TRANSFER TO ACCOUNTS IN OTHER BANKS IN MACAU"/> <!-- InstanceEndEditable --></td>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/transferInMacau.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="transferInMacau" form="form1" file="transfer_macau" />
              ...
              <tr>
                ...
                <tr>
                  ...
                  <!--<set:label name="first_select_ccy_info" defaultvalue="First select the currency and then input the amount"/> <br>
                  --><!-- modified by lzg end -->
                    <span class="content1">
                    <select id="toCurrency" name="toCurrency" nullable="0" onChange="changeToCcy(this.value)">
                      <option value="" selected><set:label name="select_ccy" defaultvalue="----- Select a Currency ------"/></option>
                      <set:rblist db="currencyMacau"> <set:rboption name="toCurrency"/> </set:rblist>
                    </select>
                    </span></td>
                </tr>
                <tr>
                ...
                <tr class="greyline">
                  ...
                  <td class="content1" colspan="3"><input placeholder="<set:label  name = 'common_input_tips'/>" id="beneficiaryName1" name="beneficiaryName1" type="text" value="<set:data name='beneficiaryName1'/>" size="45" maxlength="35">
                    <br>
                ...
                <tr>
                  ...
                  <td class="content1" colspan="3" ><select id="beneficiaryBank" name="beneficiaryBank" nullable="0" onChange="">
                      <option value="" selected><set:label name="select_beneficiary_bank" defaultvalue="----- Select a Beneficiary Bank ------"/></option>
                      <set:rblist db="localBank"> <set:rboption name="beneficiaryBank"/> </set:rblist>
                    </select>
                  </td>
                </tr>
                <tr class="greyline">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="sectionbutton"><input id="submit1" name="submit1" type="button" value="<set:label name='Transfer' defaultvalue=' OK ' />" onClick="doSubmit();">
