        ...
        <tr>
		  ...
		  <form action="/cib/transferInMacau.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
				<td class="groupinput",width="30%",  colspan="2"><set:label name="Acknowledgement" defaultvalue="Acknowledgement"/></td>
              </tr>
              ...
              <td class="content1" colspan="2" ><set:data name='transferDate' format="date"/>
				</td>
				</tr>
				<tr >
			 ...
			 <tr>
				...
				<td width="200" >
				  <table width="200" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <%--<td class="buttonsavetemp"><a href="#" onClick="popUpWindow('/cib/transferInMacau.do?ActionMethod=saveTemplate&transId=<set:data name='transId'/>', 249, 300, 500, 200)"><set:label name="Save_As_Transfer_Template" defaultvalue="Save as Transfer Template"/></a></td>
                    --%>
                    <td class="buttonsavetemp"><a  onClick="postToMainFrame('/cib/transferInMacau.do?ActionMethod=saveTemplate',{transId:'<set:data name='transId'/>'})"><set:label name="Save_As_Transfer_Template" defaultvalue="Save As Transfer Template"/></a></td>
                    </tr>
                  </table></td>
              </tr>
            </table>
