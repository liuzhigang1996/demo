...
function pageLoad(){
	...
	if(!"<set:data name='toAccount' />" == ""){
		...
		//toAccount = "<set:data name='toAccount' />" ;
		
		showToCcyList(toAccount, toCurrency,'getToCcy', "<set:data name='toAccount' />");
...
{   
	...
	if(validate_transferInBANK3rd(document.getElementById("form1"))){
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInBANK3Rd.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.transfer_bank" -->
</head>
    ...
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
		  ...
		  <form action="/cib/transferInBANK3rd.do" method="post" name="form1" id="form1">
            ...
            <set:fieldcheck name="transferInBANK3rd" form="form1" file="transfer_BANK_3rd" />
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="greyline">
                <td width="16%" valign="top" class="label1"><span class = "xing">*</span><set:label name="From_Account" defaultvalue="From Account"/></td>
			  ...
			  <tr>
                <td class="label1"><span class = "xing">*</span><set:label name="To_Account" defaultvalue="To Account"/></td>
                <td class="content1" colspan="3" >
