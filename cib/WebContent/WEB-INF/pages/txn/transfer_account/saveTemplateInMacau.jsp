...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInBank.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.transfer_macau" -->
</head>
...
<set:loadrb file="app.cib.resource.txn.transfer_macau">
  ...
  <tr>
    ...
    <td><form action="/cib/transferInMacau.do" method="post" name="form1" id="form1">
      <!-- InstanceBeginEditable name="sectioncontent" -->
      <table width="500" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><table width="95%" align="center" border="0" cellpadding="5" cellspacing="0">
              <TR>
                <TD width="10%" height="60" align="center"><img src="/cib/images/Ok.gif" width="33" height="33"></TD>
                <TD><set:label name="Save_Template_Success" defaultvalue="Save Template Success"/></TD>
              </TR>
              <tr align="center">
