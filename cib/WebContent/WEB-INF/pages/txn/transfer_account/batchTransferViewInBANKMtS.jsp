...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferHistory.do" --><!-- InstanceParam name="help_href" type="text" value="#" passthrough="true" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.bat.batch_transfer_bank" -->
</head>
<body class="body1" onLoad="pageLoad();">
<div name="pageheader" id="pageheader">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitleDetailMtS" defaultvalue="BANK Online Banking >Transfer > Single D to Multi C In Bank"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleDetailMtS" defaultvalue="SINGLE DEBIT TO MULTI CREDIT TRANSFER DETAIL"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/transferHistory.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="3">
			   <tr >
                <td  class="listheader1"><div align="left"><set:label name="SEQUENCE_NO" defaultvalue="SEQUENCE NO"/></div></td>
                <td  class="listheader1"><div align="left"><set:label name="ACCOUNT_NUMBER" defaultvalue="ACCOUNT NUMBER"/></div></td>
				<td  class="listheader1"><div align="right"><set:label name="AMOUNT" defaultvalue="AMOUNT"/></div></td>
				<td  class="listheader1"><div align="left"><set:label name="DESCRIPTION" defaultvalue="DESCRIPTION"/></div></td>
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
			    ...
			    <td class="listcontent1"><div align="right"><set:listdata name="debitAmount" format="amount"/></div></td>
			  ...
			  <tr>
                ...
                <td class="content1" colspan="4" ><set:data name='fromCurrency' db="rcCurrencyCBS"/>
				</td>
              </tr>
			   <tr class="greyline">
