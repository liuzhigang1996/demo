...
<SCRIPT language=JavaScript src="/cib/javascript/commoFixed
n.js?v=20130117"></SCRIPT>
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInBnu.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.transfer_bnu" -->
</head>
<body onLoad="pageLoad();">
<set:loadrb file="app.cib.resource.txn.transfer_bank">
  <table width="500" border="0" cellspacing="0" cellpadding="0" height="40">
    <tr>
      <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle" defaultvalue="TRANSFER TO ACCOUNTS IN BNU"/><!-- InstanceEndEditable --></td>
  ...
  <tr>
    ...
    <td><form action="/cib/transferInBANK3rd.do" method="post" name="form1" id="form1">
