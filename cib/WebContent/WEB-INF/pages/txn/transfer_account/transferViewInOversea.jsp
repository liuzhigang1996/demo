...
function pageLoad(){
 ...
 function doSubmit()
{
	if(validate_transfer(document.getElementById("form1"))){
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferHistory.do" --><!-- InstanceParam name="help_href" type="text" value="#" passthrough="true" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.txn.transfer_oversea" -->
</head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleDetail" defaultvalue="TRANSFER IN OVERSEA DETAIL"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/transferHistory.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <tr >
			   ...
			   <tr class="greyline">
			    <td class="label1" width="28%"><set:label name="Debit_Amount" defaultvalue="Debit Amountt"/></td>
               <td class="content1" width="72%"><set:data name='fromCurrency' db="rcCurrencyCBS"/><set:data name='debitAmount' format="amount"/>
			    </td>
              </tr>
			  <tr >
			  ...
			  <tr >
			   ...
			   <set:if name='cityFlag' condition='equals' value='Y'><set:data name='beneficiaryCity' /></set:if>
			    </td>
              </tr>
			  <tr class="greyline">
			   ...
			   <set:if name='bankFlag' condition='equals' value='Y'><set:data name='beneficiaryBank1'/></set:if>
			    </td>
              </tr>
			   ...
			   <br><set:data name='beneficiaryBank3'/>
				  <br><set:data name='beneficiaryBank4'/>
			    </td>
              </tr>			  
			  <tr>
              ...
              <tr class="greyline">
               ...
               <td class="content1"><set:data name='toCurrency' db="rcCurrencyCBS"/> <set:data name='chargeAmount'/>
			    </td>
              </tr>
			   <tr >
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 <tr>
				...
				<input id="business_type" name="business_type" type="hidden" value="<set:data name='business_type'/>">
                      ...
                      <input id="methodType" name="methodType" type="hidden" value="viewInOversea">
				  ...
				  <table width="200" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="buttonsavetemp">
                       ...
                       <!-- <a href="#" onClick="popUpWindow('/cib/transferInOversea.do?ActionMethod=saveTemplate&transId=<set:data name='transId'/>', 249, 300, 500, 200)"><set:label name="Save_As_Transfer_Template" defaultvalue="Save as Transfer Template"/></a> -->
                       <a  onClick="postToMainFrame('/cib/transferHistory.do?ActionMethod=saveTemplate',{transId:'<set:data name='transId'/>',tmp:'SEA'})"><set:label name="Save_As_Transfer_Template" defaultvalue="Save As Transfer Template"/></a>
