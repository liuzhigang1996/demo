...
function doSubmit()
{
	if(validate_transferHistorys(document.getElementById("form1"))){
        ...
        <tr>
		  ...
		  <form action="/cib/transferHistory.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="transferHistorys" form="form1" file="transfer_history" /> </td>
                </tr>
              </table>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr class="greyline">
                  ...
                  <td width="72%" colspan="2" class="content1" ><select id="business_type" name="business_type" nullable="0" onChange="changRoleId(this);">
                      <option><set:label name="select_transfer_type" defaultvalue="----- Select a Transfer Type ------"/></option>
                      <set:rblist file="app.cib.resource.txn.business_type"> <set:rboption name="business_type"/> </set:rblist>
                    </select>
                  </td>
                </tr>
                <tr class="">
                  <td width="28%" class="label1"><div title="operator"  id="operator" > <set:label name="Account_Number" defaultvalue="Account Number"/> </div>
                    <div title="approver"  id="approver" style="display:none"> <set:label name="To_Account_Number" defaultvalue="Account Number"/> </div></td>
                  <td width="72%"  class="content1" ><select id="fromAccount" name="fromAccount" nullable="0">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="72%" class="content1"><span class="content">
                    ...
                    <img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "if(!document.getElementById('dateFrom').disabled){scwShow(document.getElementById('dateFrom'), this,language)};" >&nbsp;&nbsp;&nbsp;&nbsp; <set:label name="date_to" defaultvalue="date to"/>&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="40" colspan="2" class="sectionbutton"><input id="ok" name="ok" type="button" value="<set:label name='search' defaultvalue='search'/>" onClick="doSubmit()">
