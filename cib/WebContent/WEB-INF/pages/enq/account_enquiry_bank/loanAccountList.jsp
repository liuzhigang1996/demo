...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_la_bank" defaultvalue="BANK Online Banking > Account Enquiry > Loan Account"/><!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1"/>
                  ...
                  <tr>
                    ...
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_o"><a href="#" onClick="changeDoc('la');">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <!--<set:listif name='ACCOUNT_STATUS' condition='notequals' value='4'> -->
                  ...
                  <td align="left" class="listcontent1"><a onClick="postToMainFrame('/cib/accEnquiryBank.do?ActionMethod=viewLoanAccount',{accountNo:'<set:listdata name='ACCOUNT_NO'/>',from_ccy:'<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>'})" href="#"> <set:listif name='SPECIAL_ACC_FLAG' condition='equals' value='Y'>*</set:listif> <set:listdata name="ACCOUNT_NO"/></a></td>
                  <td align="left" class="listcontent1"><set:listdata name="ACCOUNT_NO" db="accountDesc"/></td>
                  <td align="center" class="listcontent1"><set:listdata name="CURRENCY_CODE" db="rcCurrencyCBS"/><span class="content1">
                  ...
                  <td align="right" class="listcontent1"><set:listdata name="OUTSTANDING_AMOUNT"format="amount"/>
                    <input name="fromAmt_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>" type="hidden" id="fromAmt_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>" value="<set:listdata name='OUTSTANDING_AMOUNT'/>"></td>
                  <td align="right" class="listcontent1"><div id="equ_<set:listdata name='ACCOUNT_NO'/>"><set:listdata name="EQUIVALENT" format="amount"/></div></td>
