            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                ...
                <td class="content1"><%--<set:data name="CUR_BAL" format="amount"/>--%>
                                     <set:data name="ISSUE_AMOUNT" format="amount"/></td>
              </tr>
              <tr class="greyline">
              ...
              <tr>
                ...
                <td class="content1"><set:data name='INT_RATE'/>%</td>
              </tr>
              <tr class="greyline">
                ...
                <td class="content1">
					...
					<set:if name="REN_DATE" condition="notequals" value="00000000">
						<%--<set:data name="REN_DATE" format='date'/>--%>
						<set:data name="OPEN_DATE" format='date'/>
					</set:if>
				</td>
              </tr>
              ...
              <tr class="greyline">
                ...
                <td class="content1"><set:data name='netCreditAmt' format="amount"/></td>
              </tr>
              <%--
              <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<td height="40" colspan="4" class="sectionbutton" style = "text-align: center;">
					<input type = "button" class = "sectionbutton" value = "<set:label name='return' defaultvalue='return'/>" onClick="postToMainFrame('/cib/accEnquiryBank.do?ActionMethod=listTimeDeposit','')"/>
