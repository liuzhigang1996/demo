...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
          <set:label name="navigationTitle_td_bank" defaultvalue="BANK Online Banking > Account Enquiry > Time Deposit"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle_td" defaultvalue="TIME DEPOSIT(S) ENQUIRY"/>
        <!-- InstanceEndEditable --></td>
...
-->
                  ...
                  <tr>
                    <td colspan="4"><div align="left"> <b>
                        <set:label name="sort_type" rb="app.cib.resource.txn.time_deposit"/>
                        :</b>
                  ...
                  <tr>
                    ...
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_o"><a href="#" onClick="changeDoc('td');">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="right" class="listheader1"><set:label name="Principal" defaultvalue="Principal"/></td>
                  ...
                  <set:list name="timeDepositList" showNoRecord="YES">
                    ...
                    <!--<set:listif name='ACCOUNT_STATUS' condition='notequals' value='4'>-->
                      <tr class="<set:listclass class1='' class2='greyline'/>">
                        <td align="left" class="listcontent1"><a onClick="postToMainFrame('/cib/accEnquiryBank.do?ActionMethod=viewTimeDeposit',{tdAccountNo:'<set:listdata name='ACCOUNT_NO'/>'})" href="#">
                        ...
                        <td align="right" class="listcontent1"><set:listdata name="PRINCIPAL_AMOUNT" format="amount"/>
