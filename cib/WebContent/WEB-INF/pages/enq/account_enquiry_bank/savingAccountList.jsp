...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
          <set:label name="navigationTitle_sa_bank" defaultvalue="BANK Online Banking > Account Enquiry > Current Account"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle_sa" defaultvalue="CURRENT ACCOUNT(S) ENQUIRY"/>
        <!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="right" valign="top" class="content1"><b>
                      <set:label name="Enq_Amount_In" defaultvalue="Equivalent amount in: "/>
                      </b>
                  ...
                  <tr>
                    ...
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_o"><a href="#" onClick="changeDoc('sa');">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr class="<set:listclass class1='' class2='greyline'/>">
                        <td align="left" class="listcontent1"><a onClick="postToMainFrame('/cib/accEnquiryBank.do?ActionMethod=viewSavingAccount',{range:1,accountNo:'<set:listdata name='ACCOUNT_NO'/>',from_ccy:'<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>'})" href="#">
                        ...
                        <td align="right" class="listcontent1"><div id="equ_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>">
              ...
              <!-- add by linrui end -->
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="40" class="sectionbutton"><input id="ActionMethod" name="ActionMethod" type="hidden" value="listSavingAccount"></td><!-- modify by wcc 20180209 -->
