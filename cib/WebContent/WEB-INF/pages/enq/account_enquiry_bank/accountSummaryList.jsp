...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
          <set:label name="navigationTitle_sum_bank" defaultvalue="BANK Online Banking > Account Enquiry > Current Account"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle_sum" defaultvalue="CURRENT ACCOUNT(S) ENQUIRY"/>
        <!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="40" valign="top" class="content1"><table width="100" border="0" cellspacing="0" cellpadding="0">
                        <%--<tr>
                          <td class="buttonexcel"><a id="downloadHref" href="#" onClick="if(!canDownloadFlag)return false;">Download</a></td>
                        </tr>
                      --%></table></td>
                    <td align="right" valign="top" class="content1"><b>
                      <set:label name="Enq_Amount_In" />
                      </b>
                  ...
                  <tr>
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="tab1_o"><a href="#" onClick="changeDoc('sum');">
                    ...
                    <%-- mod by linrui 20180329 without creadit card and so on
                    <td><table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="ltab1_c"><img src="/cib/images/shim.gif" width="7" height="26"></td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="25%" align="right" class="listheader1"><span id="showEqCcy">
                  ...
                  <set:if name="showCurrentAccount" condition="equals" value="1">
                    <set:list name="currentList">
                      <tr class="<set:listclass class1='' class2='greyline'/>">
                        ...
                        <td class="listcontent1" align="left"><set:listif name="@INDEX"  condition="equals" value="0"><a onClick="toTargetFormgoToTarget('/cib/accEnquiryBank.do?ActionMethod=listCurrentAccount')" href="#">
                            <set:label name="Current_Account" defaultvalue="Current Account"/>
                            </a></set:listif>
                          &nbsp;</td>
                        ...
                        <td align="right" class="listcontent1"><div id="equ_CA_<set:listdata name='@INDEX'/>">
                            <!--set:listdata name="TOTAL_LCY_BALANCE" format="amount"/-->
                          </div></td>
                        <td class="listcontent1">&nbsp;</td>
                      </tr>
                    </set:list>
                    <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                      ...
                      <td align="center"  class="listcontent1" width="10%"><strong>
                        <set:label name="Sub_Total" defaultvalue="Sub-Total"/>
                        </strong></td>
                      <td width="25%" align="right" class="listcontent1"><div id="subTotal_CA">
                          <!--set:data name="CA_SubTotal" format="amount"/-->
                        </div></td>
                      <td class="listcontent1">&nbsp;</td>
                    </tr>
                  </set:if>
                  <set:if name="showNothing" condition="equals" value="1">
                    <set:list name="currentList" showNoRecord="YES"> </set:list>
                  </set:if>
                </table>
                ...
                <set:if name="showSavingAccount" condition="equals" value="1">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <set:list name="savingList">
                      <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                        <td class="listcontent1">&nbsp;</td>
                        <td class="listcontent1" align="left"><set:listif name="@INDEX"  condition="equals" value="0"><a onClick="toTargetFormgoToTarget('/cib/accEnquiryBank.do?ActionMethod=listSavingAccount')" href="#">
                            <set:label name="Saving_Account" defaultvalue="Saving Account"/>
                            </a></set:listif></td>
                        ...
                        <td align="right" class="listcontent1"><div id="equ_SA_<set:listdata name='@INDEX'/>">
                            <!--set:listdata name="TOTAL_LCY_BALANCE" format="amount"/-->
                          </div></td>
                        <td class="listcontent1">&nbsp;</td>
                      </tr>
                    ...
                    <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                      ...
                      <td width="25%" align="right" class="listcontent1"><div id="subTotal_SA">
                          <!--set:data name="SA_SubTotal" format="amount"/-->
                        </div></td>
                      <td class="listcontent1">&nbsp;</td>
                    </tr>
                  </table>
                ...
                <set:if name="showTimeDeposit" condition="equals" value="1">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <set:list name="tdList">
                      <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                        <td class="listcontent1">&nbsp;</td>
                        <td class="listcontent1" align="left"><set:listif name="@INDEX"  condition="equals" value="0"><a onClick="toTargetFormgoToTarget('/cib/accEnquiryBank.do?ActionMethod=listTimeDeposit')" href="#">
                            <set:label name="Time_Deposit" defaultvalue="Time Deposit"/>
                            </a></set:listif>
                          &nbsp;</td>
                        ...
                        <td align="right" class="listcontent1"><input name="fromAmt_TD_<set:listdata name='@INDEX'/>" type="hidden" id="fromAmt_TD_<set:listdata name='@INDEX'/>" value="<set:listdata name='TOTAL_BALANCE'/>">
                          <set:listdata name="TOTAL_BALANCE" format="amount"/></td>
                        <td align="right" class="listcontent1">&nbsp;</td>
                        <td align="right" class="listcontent1"><div id="equ_TD_<set:listdata name='@INDEX'/>">
                            <!--set:listdata name="TOTAL_LCY_BALANCE" format="amount"/-->
                          </div></td>
                        <td class="listcontent1">&nbsp;</td>
                      </tr>
                    ...
                    <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                      ...
                      <td width="25%" align="right" class="listcontent1"><div id="subTotal_TD">
                          <!--set:data name="TD_SubTotal" format="amount"/-->
                        </div></td>
                      <td class="listcontent1">&nbsp;</td>
                    </tr>
                  </table>
                ...
                <set:if name="showOverdraft" condition="equals" value="1">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <set:list name="overdraftList">
                      <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                        <td class="listcontent1">&nbsp;</td>
                        <td class="listcontent1" align="left"><set:listif name="@INDEX"  condition="equals" value="0"><a onClick="toTargetFormgoToTarget('/cib/accEnquiryBank.do?ActionMethod=listOverdraftAccount')" href="#">
                            <set:label name="Overdraft_Account" defaultvalue="Overdraft Account"/>
                            </a></set:listif>
                          &nbsp;</td>
                        ...
                        <td align="right" class="listcontent1"><input name="fromAmt_OV_<set:listdata name='@INDEX'/>" type="hidden" id="fromAmt_OV_<set:listdata name='@INDEX'/>" value="<set:listdata name='TOTAL_BALANCE'/>">
                          <set:listdata name="TOTAL_BALANCE" format="amount"/></td>
                        <td align="right" class="listcontent1">&nbsp;</td>
                        <td align="right" class="listcontent1"><div id="equ_OV_<set:listdata name='@INDEX'/>">
                            <!--set:listdata name="TOTAL_LCY_BALANCE" format="amount"/-->
                          </div></td>
                        <td class="listcontent1">&nbsp;</td>
                      </tr>
                    ...
                    <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                      ...
                      <td width="25%" align="right" class="listcontent1"><div id="subTotal_OV">
                          <!--set:data name="OA_SubTotal" format="amount"/-->
                        </div></td>
                      <td class="listcontent1">&nbsp;</td>
                    </tr>
                  </table>
                ...
                <set:if name="showLoanAccount" condition="equals" value="1">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <set:list name="loanList">
                      <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                        <td class="listcontent1">&nbsp;</td>
                        <td class="listcontent1" align="left"><set:listif name="@INDEX"  condition="equals" value="0"><a onClick="toTargetFormgoToTarget('/cib/accEnquiryBank.do?ActionMethod=listLoanAccount')" href="#">
                            <set:label name="Loan_Account" defaultvalue="Loan Account"/>
                            </a></set:listif>
                          &nbsp;</td>
                        ...
                        <td align="right" class="listcontent1"><input name="fromAmt_LA_<set:listdata name='@INDEX'/>" type="hidden" id="fromAmt_LA_<set:listdata name='@INDEX'/>" value="<set:listdata name='TOTAL_BALANCE'/>">
                          <set:listdata name="TOTAL_BALANCE" format="amount"/></td>
                        <td align="right" class="listcontent1">&nbsp;</td>
                        <td align="right" class="listcontent1"><div id="equ_LA_<set:listdata name='@INDEX'/>">
                            <!--set:listdata name="TOTAL_LCY_BALANCE" format="amount"/-->
                          </div></td>
                        <td class="listcontent1">&nbsp;</td>
                      </tr>
                    ...
                    <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                      ...
                      <td width="25%" align="right" class="listcontent1"><div id="subTotal_LA">
                          <!--set:data name="LA_SubTotal" format="amount"/-->
                        </div></td>
                      <td class="listcontent1">&nbsp;</td>
                    </tr>
                  </table>
                ...
                <set:if name="showCreditCard" condition="equals" value="1">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <set:list name="creditCardList">
                      <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                        <td class="listcontent1">&nbsp;</td>
                        <td class="listcontent1" align="left"><set:listif name="@INDEX"  condition="equals" value="0"><a onClick="toTargetFormgoToTarget('/cib/accEnquiryBank.do?ActionMethod=listCreditAccount')" href="#">
                            <set:label name="Credit_Card" defaultvalue="Credit Card"/>
                            </a></set:listif></td>
                        ...
                        <td align="right" class="listcontent1"><input name="fromAmt_CC_<set:listdata name='@INDEX'/>" type="hidden" id="fromAmt_CC_<set:listdata name='@INDEX'/>" value="<set:listdata name='TOTAL_BALANCE'/>">
                          <set:listdata name="TOTAL_BALANCE" format="amount"/></td>
                        <td align="right" class="listcontent1">&nbsp;</td>
                        <td align="right" class="listcontent1"><div id="equ_CC_<set:listdata name='@INDEX'/>">
                            <!--set:listdata name="TOTAL_LCY_BALANCE" format="amount"/-->
                          </div></td>
                        <td class="listcontent1">&nbsp;</td>
                      </tr>
                    ...
                    <tr class="<set:listclass class1='' class2='greyline' inlevel='@CONTINUE'/>">
                      ...
                      <td width="25%" align="right" class="listcontent1"><div id="subTotal_CC">
                          <!--set:data name="CC_SubTotal" format="amount"/-->
                        </div></td>
                      <td class="listcontent1">&nbsp;</td>
                    </tr>
                  </table>
