  ...
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
	  <%-- <set:if name="fromPage" value="" condition="equals">
	  	<set:label name="navigationTitle_detail_bank" defaultvalue="BANK Online Banking >Account Enquiry > Current Account"/>
	  </set:if>
	  <set:if name="fromPage" value="sub" condition="equals">
	  	<set:label name="navigationTitle_detail_bank" defaultvalue="BANK Online Banking >Account Enquiry > Current Account" rb="app.cib.resource.enq.subsidiary_account_enquiry"/>
	  </set:if> --%>
	  <set:label name="navigationTitle_ca_detail_bank" />
		  ...
		  <form action="/cib/accEnquiryBank.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  <td class="label1" width="16%"><set:label name="Account_Number" defaultvalue="Account Number"/></td>
                ...
                <%--<tr class="greyline">
                  <td class="label1" width="16%"><set:label name="Currency" defaultvalue="Currency"/></td>
                ...
                <!-- add by lzg end -->
                <tr>
                  <td class="label1" width="16%"><set:label name="Ledger_Balance" defaultvalue="Ledger Balance : "/></td>
                  <td class="content1"><set:data name="CURRENT_BALANCE" format="amount"/></td>
                </tr>
                <tr class="greyline">
                  <td class="label1" width="16%"><set:label name="Available_Balance" defaultvalue="Available Balance : "/></td>
                  <td class="content1">
                ...
                <%--
                <tr>
                  <td class="label1" width="16%"><set:label name="Statement" defaultvalue="Statement : "/></td>
                  <td class="content1"><set:data name="ACCOUNT_NO" db="statementForDetail"/></td>
                </tr>
              --%>
              <!-- add by lzg 20190618 -->
              <tr>
              	<td colspan="4" style = "text-align: center;"><input type = "button" class = "sectionbutton" value = "<set:label name='buttonReturn' defaultvalue='return'/>" onClick="postToMainFrame('/cib/accEnquiryBank.do?ActionMethod=listCurrentAccount','')"/></td>
              </tr>
              <!-- add by lzg end -->
              </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  <td colspan="3" class="groupinput"><set:label name="Transaction_History" defaultvalue="Account Transaction History"/></td>
                </tr>
                <tr>
                  <td class="content1">
                  	<!-- modified by lzg 20190621 -->                  
