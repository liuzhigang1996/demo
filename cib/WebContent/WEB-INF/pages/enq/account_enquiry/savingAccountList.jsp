...
function chanPage(flagPage,arg){
	...
	if (arg == 'list') {
		document.form1.ActionMethod.value = 'listSavingAccount';
	}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_sa" defaultvalue="BANK Online Banking > Account Enquiry > Current Account"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_sa" defaultvalue="CURRENT ACCOUNT(S) ENQUIRY"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/accEnquiry.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1"/>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <set:list name="savingAccountList" showNoRecord="YES"> 
                <!-- modify by wcc 20180209 -->
                <!--<set:listif name='ACCOUNT_STATUS' condition='notequals' value='4'>-->
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  <td align="left" class="listcontent1"><a onClick="postToMainFrame('/cib/accEnquiry.do?ActionMethod=viewSavingAccount',{range:1,accountNo:'<set:listdata name='ACCOUNT_NO'/>',from_ccy:'<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>'})" href="#"> <set:listif name='SPECIAL_ACC_FLAG' condition='equals' value='Y'>*</set:listif> <set:listdata name='ACCOUNT_NO'/></a></td>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="40" class="sectionbutton"><input id="ActionMethod" name="ActionMethod" type="hidden" value="listSavingAccount"></td>
