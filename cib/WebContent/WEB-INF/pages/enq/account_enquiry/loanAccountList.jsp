...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_la" defaultvalue="BANK Online Banking > Account Enquiry > Loan Account"/><!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1"/>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  <td align="left" class="listcontent1"><a onClick="postToMainFrame('/cib/accEnquiry.do?ActionMethod=viewLoanAccount',{accountNo:'<set:listdata name='ACCOUNT_NO'/>',from_ccy:'<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>'})" href="#"> <set:listif name='SPECIAL_ACC_FLAG' condition='equals' value='Y'>*</set:listif> <set:listdata name="ACCOUNT_NO"/></a></td>
