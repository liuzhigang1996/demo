...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_sa_detail" defaultvalue="BANK Online Banking >Account Enquiry > Current Account"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/accEnquiry.do" method="post" name="form1" id="form1">
		    ...
		    <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <!-- add by lzg 20190618 -->
              <tr>
              	<td colspan="4" style = "text-align: center;"><input type = "button" class = "sectionbutton" value = "<set:label name='buttonReturn' defaultvalue='return'/>" onClick="postToMainFrame('/cib/accEnquiry.do?ActionMethod=listSavingAccount','')"/></td>
              </tr>
              <!-- add by lzg end -->
              </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  ...
                  <td class="content1"><div align="right">
                  	  <!-- modified by lzg 20190621 -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr class="<set:listclass class1='' class2='greyline' />">
                  ...
                  <td class="listcontent1"><set:listdata name="QHIS_TX_TIME" /></td>
