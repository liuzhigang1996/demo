...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_credit_account" defaultvalue="BANK Online Banking > Account Enquiry > Credit Card"/><!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1"/>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  <td align="left" class="listcontent1"><a onClick="toTargetFormgoToTarget('/cib/accEnquiry.do?ActionMethod=viewCreditAccount&range=1&accountNo=<set:listdata name='CREDIT_CARD_NO'/>')" href="#"> <set:listif name='SPECIAL_ACC_FLAG' condition='equals' value='Y'>*</set:listif> <set:listdata name='CREDIT_CARD_NO'/></a></td>
                  ...
                  <set:listif name="PAYMENT_DUE_DATE" condition="equals" value="00000000">-</set:listif>
                  ...
                  <td align="right" class="listcontent1"><set:listdata name="MIN_PAYMENT" format="amount"/>
                  </div></td>
                </tr>
                </set:listif> </set:list>
              </table>
