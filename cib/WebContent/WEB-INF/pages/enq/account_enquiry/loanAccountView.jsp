...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_detail" defaultvalue="BANK Online Banking > Account Enquiry > Loan Account"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/accEnquiry.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td class="groupinput" colspan="4"><set:label name="Account_Detial" defaultvalue="Account Detial"/></td>
              </tr>
              <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <!-- modified by lzg 20190621 -->
                ...
                <input type = "button" class = "sectionbutton" value = "<set:label name='buttonReturn' defaultvalue='return'/>" onClick="postToMainFrame('/cib/accEnquiry.do?ActionMethod=listLoanAccount','')"/>
                <input id="ActionMethod" name="ActionMethod" type="hidden" value="loanAccountHistory">
                <!-- add by linrui for request premission 20190508 -->
