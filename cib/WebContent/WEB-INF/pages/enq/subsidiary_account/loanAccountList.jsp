...
function chanPage(flagPage,arg){
	...
	if (arg == 'list') {
		document.form1.ActionMethod.value = 'listLoanAccount';
	}
	document.getElementById("form1").submit();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_la" defaultvalue="BANK Online Banking > Account Enquiry > Loan Account" rb="app.cib.resource.enq.subsidiary_account_enquiry"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_la" defaultvalue="LOAN ACCOUNT(S) ENQUIRY"/><!-- InstanceEndEditable --></td>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="40" valign="top" class="content1"><table width="100" border="0" cellspacing="0" cellpadding="0">
                  <%--<tr>
                    <td class="buttonexcel"><a href="/cib/DownloadCVS?listName=loanAccountList&fileName=corp_loan_account&columnTitles=<set:label name='Account_Number'/>,<set:label name='Description_Remark'/>,<set:label name='Original_Currency'/>,<set:label name='Balance'/>&&columnNames=ACCOUNT_NO,ACCOUNT_NO||db@accountDesc||specialChar@yes,CURRENCY_CODE||db@currencyCBS,OUTSTANDING_AMOUNT||format@amount"><set:label name="download" rb="app.cib.resource.common.operation"/></a></td>
                  </tr>
                --%></table></td>
                <td align="right" valign="top" class="content1"><b>
                  <set:label name="Equivalent_In" defaultvalue="Equivalent amount in: "/></b>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                ...
                <td class="listheader1"><set:label name="Description_Remark" defaultvalue="Description"/></td>
			  ...
			  <set:list name="loanAccountList" showNoRecord="YES">
			  <!-- modify by wcc 20180209 -->
			  <!--<set:listif name='ACCOUNT_STATUS' condition='notequals' value='4'>-->
              <tr class="<set:listclass class1='' class2='greyline'/>">
                <td align="left"  class="listcontent1"><a onClick="toTargetFormgoToTarget('/cib/accEnquiry.do?ActionMethod=viewLoanAccount&accountNo=<set:listdata name='ACCOUNT_NO'/>&from_ccy=<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>')" href="#"> <set:listif name='SPECIAL_ACC_FLAG' condition='equals' value='Y'>*</set:listif><set:listdata name="ACCOUNT_NO"/></a></td>
                <td align="left" class="listcontent1"><set:listdata name="ACCOUNT_NO" db="accountDesc"/></td>
				<td align="center" class="listcontent1"><set:listdata name="CURRENCY_CODE" db="rcCurrencyCBS"/><input name="fromCcy_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>" type="hidden" id="fromCcy_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>" value="<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>">
				</td>
                <td align="right" class="listcontent1"><set:listdata name="OUTSTANDING_AMOUNT" format="amount"/><input name="fromAmt_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>" type="hidden" id="fromAmt_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>" value="<set:listdata name='OUTSTANDING_AMOUNT'/>"></td>
                <td align="right" class="listcontent1"><div id="equ_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>"><set:listdata name="EQUIVALENT" format="amount"/></div></td>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" class="sectionbutton"><input id="ActionMethod" name="ActionMethod" type="hidden" value="listLoanAccount"></td>
                <td height="40" class="sectionbutton"><input id="equivalentCCY" name="equivalentCCY" type="hidden" value="<set:data name='equivalentCCY'/>"><input id="corpId" name="corpId" type="hidden" ></td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
		  </form>
