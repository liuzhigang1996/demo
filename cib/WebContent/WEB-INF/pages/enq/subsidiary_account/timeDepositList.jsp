...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_td" defaultvalue="BANK Online Banking > Account Enquiry > Time Deposit" rb="app.cib.resource.enq.subsidiary_account_enquiry"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/subsidiaryAcc.do" method="post" name="form1" id="form1">
			...
			document.write(d);
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td colspan="6"><div align="right"><span class="content1"><b> <set:label name="Enq_Amount_In" defaultvalue="Equivalent amount in: "/></b>
                ...
                <%--
                <tr>
                  <td colspan="4"><div align="left"> <b><set:label name="sort_type" rb="app.cib.resource.txn.time_deposit"/>:</b>
                      <select name="sortType" id="sortType" onChange="selectNode('<set:data name="subCorpId"/>');this.disabled=true;$('eqCcy').disabled=true;">
                        <set:rblist file="app.cib.resource.txn.td_sort_ype"> <set:rboption name="sortType"/> </set:rblist>
                      </select>
                    </div></td>
                  <td colspan="2" align="right"><table width="100" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="buttonexcel" align="right"><a href="/cib/DownloadCVS?listName=timeDepositList&fileName=corp_timeDeposit_account&columnTitles=<set:label name='Account_Number'/>,<set:label name='Term'/>,<set:label name='Maturity'/>,<set:label name='Original_Currency'/>,<set:label name='Principal'/>&columnNames=ACCOUNT_NO,PERIOD||db@period,MATURITY_DATE||format@date,CURRENCY_CODE||db@currencyCBS,PRINCIPAL_AMOUNT||format@amount,"><set:label name="download" rb="app.cib.resource.common.operation"/></a></td>
                      </tr>
                    </table></td>
                </tr>
                --%>
                <tr>
                  <td class="listheader1" align="left"><set:label name="Account_Number" defaultvalue="Account Number"/></td>
                  <td class="listheader1" align="left"><set:label name="Term" defaultvalue="Term"/></td>
                  <td class="listheader1" align="left"><set:label name="Maturity" defaultvalue="Maturity"/></td>
                  <td class="listheader1" align="center"><set:label name="Original_Currency" defaultvalue="Original Currency"/></td>
                  <td class="listheader1" align="right"><set:label name="Principal" defaultvalue="Principal"/></td>
                ...
                <set:listclass class1='' class2='greyline'/>"> <set:list name="timeDepositList" showNoRecord="YES"> 
                <!-- modify by wcc 20180313 -->
                <!--<set:listif name='ACCOUNT_STATUS' condition='notequals' value='4'>-->
                <tr  class="<set:listclass class1='' class2='greyline'/>">
                  <td class="listcontent1" align="left"><a onClick="toTargetFormgoToTarget('/cib/timeDeposit.do?ActionMethod=viewTimeDeposit&tdAccountNo=<set:listdata name='ACCOUNT_NO'/>')" href="#"><set:listdata name='ACCOUNT_NO'/>
                    <input name="fromCcy_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>" type="hidden" id="fromCcy_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>" value="<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>">
                    </a></td>
                  <td class="listcontent1" align="left"><set:listdata name="PERIOD" db="period"/></td>
                  <td class="listcontent1" align="left"><set:listdata name="MATURITY_DATE" format="date"/></td>
                  <td class="listcontent1" align="center"><set:listdata name="currency" db="rcCurrencyCBS"/></td>
                  <td class="listcontent1" align="right"><set:listdata name="PRINCIPAL_AMOUNT" format="amount"/>
                  ...
                  <td class="listcontent1" align="right"><div id="equ_<set:listdata name='ACCOUNT_NO'/>_<set:listdata name="CURRENCY_CODE" db="currencyCBS"/>"><set:listdata name="EQUIVALENT" format="amount"/></div></td>
              ...
              <!-- add by linrui end -->
              </set:if> <set:if name="flag" condition="notequals" value="Y">
