...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_oa" defaultvalue="BANK Online Banking > Account Enquiry > Overdraft Account" rb="app.cib.resource.enq.subsidiary_account_enquiry"/><!-- InstanceEndEditable --></td>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
                <td align="left" class="listcontent1"><a onClick="toTargetFormgoToTarget('/cib/accEnquiry.do?ActionMethod=viewOverdraftAccount&range=1&accountNo=<set:listdata name='ACCOUNT_NO'/>&fromPage=sub&from_ccy=<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>')" href="#">
				<set:listif name='SPECIAL_ACC_FLAG' condition='equals' value='Y'>*</set:listif><set:listdata name='ACCOUNT_NO'/></a></td>
				...
				--%>
				<td  align="center" class="listcontent1"><set:listdata name="CURRENCY_CODE" db="rcCurrencyCBS"/><input name="fromCcy_<set:listdata name='ACCOUNT_NO'/>" type="hidden" id="fromCcy_<set:listdata name='ACCOUNT_NO'/>" value="<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>"></td>
                <td align="right" class="listcontent1"><set:listdata name="CURRENT_BALANCE" format="amount"/><input name="fromAmt_<set:listdata name='ACCOUNT_NO'/>" type="hidden" id="fromAmt_<set:listdata name='ACCOUNT_NO'/>" value="<set:listdata name='CURRENT_BALANCE'/>"></td>
