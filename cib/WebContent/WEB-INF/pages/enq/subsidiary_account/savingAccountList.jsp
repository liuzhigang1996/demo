...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
        <set:label name="navigationTitle_sa" defaultvalue="BANK Online Banking > Account Enquiry > Current Account" rb="app.cib.resource.enq.subsidiary_account_enquiry"/>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <!-- modify by wcc 20180209 -->
                    ...
                    <tr class="<set:listclass class1='' class2='greyline'/>">
                      <td align="left" class="listcontent1"><a onClick="toTargetFormgoToTarget('/cib/accEnquiry.do?ActionMethod=viewSavingAccount&range=1&accountNo=<set:listdata name='ACCOUNT_NO'/>&fromPage=sub&from_ccy=<set:listdata name='CURRENCY_CODE' db='currencyCBS'/>')" href="#">
