...
{
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="editGroupCancel";
		  ...
		  <form action="/cib/group.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                ...
                <td width="80%" class="content1"><set:label name='functionTitle_edit'/></td>
              </tr>
            </table>
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <set:list name="accountList">
                      <tr>
                        <td width="30" class="content1"><input type=checkbox  disabled="disabled" name="item_accountList" value="<set:listdata name='accountNo'/>"  
                          <set:listselected  key="accountNo" equals='item_accountList'  output='checked'/>
                          ></td>
              ...
              <tr class="greyline">
                ...
                <td><set:if name="roleId" condition="EQUALS" value="1" >
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <set:rblist file="app.cib.resource.sys.operator_function">
                        <tr>
                          <td class="content1" width="30"><input type=checkbox disabled="disabled" name="item_functionList" value="<set:rbkey/>" <set:rbselected  equals='item_functionList'  output='checked'/>
                            ></td>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<input id="buttonCancel" name="buttonCancel" type="button" value="<set:label name='buttonCancel' defaultvalue='Cancel'/>" onClick="doCancel()">
                  <input id="ActionMethod" name="ActionMethod" type="hidden" value="editGroupConfirm">
