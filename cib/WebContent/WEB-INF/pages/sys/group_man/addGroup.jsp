...
function doSubmit()
{
	if(validate_group_man(document.getElementById("form1"))){
...
function clearFunctionSelection(roleId) {
	if(roleId=='1'){
		  ...
		  <form action="/cib/group.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                ...
                <td width="80%" class="content1"><input id="groupName" name="groupName" type="text" value="<set:data name='groupName'/>" size="20" maxlength="20"></td>
              </tr>
              <tr class="greyline">
                <td class="label1"><set:label name="Role" defaultvalue="Role"/></td>
                <td class="content1">
				<set:if name="corpType" condition="EQUALS" value="1" >
				  <select name="roleId" id="roleId" nullable="0" onChange="showFunctionList(this.value);clearFunctionSelection(this.value);">
              ...
              <tr>
                <td class="label1" align="top"><set:label name="Account_List" defaultvalue="Account List"/></td>
				<td>
              ...
              <tr class="greyline">
				...
				<div title="operator_function"  id="operator_function">
					...
					<set:rblist file="app.cib.resource.sys.operator_function">
             		 <tr>
                		<td width="30" class="content1"><input id="item_functionList" type=checkbox name="item_functionList" value="<set:rbkey/>"  <set:rbselected  equals='item_functionList'  output='checked'/>></td>
              ...
              <tr>
                ...
                <td class="content1"><input name="groupDesc" type="text" id="groupDesc" value="<set:data name='groupDescription'/>" size="60" maxlength="60"></td>
              </tr>
            </table>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<input id="submit1" name="submit1" type="button" value="<set:label name='buttonOK' defaultvalue=' OK '/>" onClick="doSubmit();">
<!--                  <input id="bottonReset" name="bottonReset" type="reset" value="<set:label name='buttonReset' defaultvalue='Reset'/>"> -->
				  <input id="ActionMethod" name="ActionMethod" type="hidden" value="addGroup">
				  </td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
