...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_list" defaultvalue="BANK Online Banking >User Group Management > User Group List"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/group.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
                ...
                <td align="center" class="listcontent1"><a onClick="postToMainFrame('/cib/group.do?ActionMethod=view',{groupId:'<set:listdata name='groupId'/>'})" href="#">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" colspan="2" class="sectionbutton"><input id="buttonOk" name="buttonOk" type="button" value="<set:label name='buttonNewGroup'/>" onClick="doSubmit()">
                <input id="ActionMethod" name="ActionMethod" type="hidden" value="addGroupLoad">				  </td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
		  </form>
