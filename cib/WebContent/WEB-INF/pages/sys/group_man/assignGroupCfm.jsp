...
{
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="assignGroupCancel";
		  ...
		  <form action="/cib/group.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                ...
                <td width="80%" class="content1"><set:label name='functionTitle_assign'/></td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="5" class="groupinput"><set:label name="Group_Assignment"/></td>
              </tr>
			  <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <input id="ActionMethod" name="ActionMethod" type="hidden" value="assignGroupConfirm">				  </td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
		  </form>
