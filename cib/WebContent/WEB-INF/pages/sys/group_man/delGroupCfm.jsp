...
{
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="delGroupCancel";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_delete" defaultvalue="BANK Online Banking >User Management > Edit User Group"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_delete" defaultvalue="EDIT USER GROUP"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/group.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                ...
                <td width="72%" class="content1"><set:label name='functionTitle_delete'/></td>
              </tr>
            </table>
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                ...
                <td>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <set:list name="item_functionList">
                        <tr>
                          <td class="content1" width="40%"><img src="/cib/images/check1.gif" border="0" align="absmiddle"> <set:listdata name='permissionResource' rb="app.cib.resource.sys.operator_approver_function"/></td>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" colspan="2" class="sectionbutton"><input id="buttonOk" name="buttonOk" type="button" value="<set:label name='buttonConfirm' defaultvalue=' Confirm '/>" onClick="doSubmit('confirm')">
				<input id="buttonCancel" name="buttonCancel" type="button" value="<set:label name='buttonCancel' defaultvalue='Cancel'/>" onClick="doCancel()">
                  <input id="ActionMethod" name="ActionMethod" type="hidden" value="delGroupConfirm">
				  <input id="groupId" name="groupId" type="hidden" value="<set:data name='groupId'/>">
				  <input id="groupName" name="groupName" type="hidden" value="<set:data name='groupName'/>">
				  <input id="roleId" name="roleId" type="hidden" value="<set:data name='roleId'/>">
				  <input id="accountList" name="accountList" type="hidden" value="<set:data name='accountList'/>">
				  <input id="functionList" name="functionList" type="hidden" value="<set:data name='functionList'/>">
				  <input id="Description" name="Description" type="hidden" value="<set:data name='Description'/>">				  </td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
		  </form>
