...
function doSubmit(arg1) {
	if (arg1 == 'return') {
		document.getElementById("ActionMethod").value = 'viewAuthPrefList';
		setFormDisabled("form1");
		document.getElementById("form1").submit();
	}
}
</script>
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/corpInfo.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.sys.auth_pref" -->
</head>
		  ...
		  <form action="/cib/corpInfo.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                ...
                <td width="72%" class="content1"><set:data name='txnType' rb="app.cib.resource.common.subtype"/></td>
              </tr>
              <tr class="greyline">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
				...
				<td class="content1" width="72%"><set:data name='ruleType' rb="app.cib.resource.sys.auth_pref"/> <set:if name="ruleType" condition="equals" value="0">&nbsp;&nbsp; - &nbsp;&nbsp;<set:data name='singleLevel'/></set:if>
				<set:if name="ruleType" condition="equals" value="1">&nbsp;&nbsp; - &nbsp;&nbsp;<set:label name="Multi_Class_Matrix" defaultvalue="Authorization Matrix(for Multi Class Authorization)"/></set:if>
				</td>
              </tr>
			  </table>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <set:list name="ruleList">
                <tr  class="<set:listclass class1='' class2='greyline'/>">
                  <td class="listcontent1"><set:listdata name='fromAmount' format='amount'/></td>
                  <td class="listcontent1"><set:listdata name='toAmount' format='amount'/></td>
                  <td class="listcontent1"><set:listdata name='levelA'/></td>
                  <td class="listcontent1"><set:listdata name='levelB'/></td>
                  <td class="listcontent1"><set:listdata name='levelC'/></td>
                  <td class="listcontent1"><set:listdata name='levelD'/></td>
                  <td class="listcontent1"><set:listdata name='levelE'/></td>
                </tr>
              </set:list>
            </table>
			  </set:if>
