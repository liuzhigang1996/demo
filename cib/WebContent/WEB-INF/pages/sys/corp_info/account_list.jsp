...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.bnk.corp_account" -->
</head>
<body class="body1" onLoad="pageLoad();">
<div name="pageheader" id="pageheader">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_view_set" defaultvalue="MDB Corporate Online Banking > Corporation Info > Account List"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_view_set" defaultvalue="ACCOUNT LIST"/><!-- InstanceEndEditable --></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td class="listheader1" align="left" colspan="2"><set:label name="type"/>&nbsp;</td>
