...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_set_currency"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_set_currency"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/setCurrency.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr>
                ...
                <td  class="content1" width="80%"><set:label name='EDIT'/></td>
              </tr>
			   <tr class="greyline">
                <td class="label1" ><set:label name="Status" defaultvalue="Status"/></td>
				<td class="label1" ><set:label name="PENDING_APPROVAL" rb="app.cib.resource.common.ack_status"/></td>
              </tr>
			  </table>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <input id="ActionMethod" name="ActionMethod" type="hidden" value="setCurrencyLoad">				  </td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
		  </form>
