...
function doSubmit(arg) {
	if (arg == 'return') {
		document.form1.ActionMethod.value = 'viewAccLimitsList';
	} 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_view_limits" defaultvalue="MDB Corporate Online Banking > Corporation Info > View Transactin Limits"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_view_limits" defaultvalue="VIEW TRANSACTION LIMITS"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/corpInfo.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                <td width="28%" class="label1"><strong><set:label name="account" defaultvalue="account"/></strong></td>
