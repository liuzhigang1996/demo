...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_resetpwd"/><!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1"/>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  ...
                  <td class="label1" ><set:label name="functionTitle_resetpwd" /></td>
                </tr>
                <tr>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="40" colspan="2" class="sectionbutton"><input id="buttonConfirm" name="buttonConfirm" type="button" value="<set:label name='buttonConfirm' defaultvalue='Confirm'/>" onClick="doSubmit();">
                    ...
                    <input id="ActionMethod" name="ActionMethod" type="hidden" value="resetPasswordConfirm">
                  </td>
                </tr>
              </table>
              <!-- InstanceEndEditable -->
