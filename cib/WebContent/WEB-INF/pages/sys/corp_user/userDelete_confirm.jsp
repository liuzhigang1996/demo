...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_delete" defaultvalue="MDB Corporate Online Banking >User Management > New User"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_delete" defaultvalue="VIEW USER INFORMATION"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/corpUser.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1"/>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  <td class="label1" width="28%"><set:label name="Operation" defaultvalue="Operation"/></td>
                  <td class="label1" width="72%"><set:label name="functionTitle_delete" defaultvalue="functionTitle_delete"/></td>
                </tr>
              </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
