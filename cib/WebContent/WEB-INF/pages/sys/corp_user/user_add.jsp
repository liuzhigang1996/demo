...
function changRoleId(obj){
	//document.getElementById("mobile_hits").innerHTML = "";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --> <set:label name="navigationTitle_add" defaultvalue="MDB Corporate Online Banking > Corp User > New User"/> <!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --> <set:label name="functionTitle_add" defaultvalue="NEW USER"/> <!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  ...
                  <set:data name='corpId'/>
                  <!-- add by lzg for GAPMC-EB-001-0040 -->
                  <input type = "hidden" name = "corpId" value ="<set:data name='corpId'/>" >
                  <!-- add by lzg end -->
                  </td>
                </tr>
                <tr class="greyline">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  ...
                  <!--<td width="72%" class="content1"><input class="bankMustInput" id="userId" name="userId" type="text" value="<set:data name='userId'/>" size="20" maxlength="12"></td>
                  --><td width="72%" class="content1"><input class="bankMustInput" id="userId" name="userId" type="text" value="<set:data name='userId'/>" size="20" maxlength="16" onkeyup="this.value=this.value.replace(/[^a-z0-9A-Z]/g,'');"></td>
                  <!-- modified by lzg end -->
                </tr>
                <tr class="greyline">
                  <td class="label1"><set:label name="Role" defaultvalue="Role"/></td>
                  <td class="content1">
				    <select class="bankMustInput" id="roleId" name="roleId" nullable="0" onChange="changRoleId(this);">
                ...
                <tr >
                  ...
                  <td class="content1"><input class="bankMustInput" id="userName" name="userName" type="text" value="<set:data name='userName'/>" size="40" maxlength="40"></td>
                </tr>
                <tr class="greyline">
                ...
                <tr  >
                  ...
                  <td class="content1" colspan="3"><input id="idIssueDate" name="idIssueDate" type="text" value="<set:data name='idIssueDate'/>" size="10" maxlength="10">
                    <img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "{scwShow(document.getElementById('idIssueDate'), this,language)};" > </td>
                </tr>
                <tr class="greyline">
                ...
                <tr class="greyline">
                  ...
                  <td class="content1">
                  <%-- COMMENT BY LINRUI 20190522
                  <span id="country_area"><input id="mobileCountryCode" name="mobileCountryCode" type="text" value="<set:data name='mobileCountryCode'/>" size="3"  maxlength="3">&nbsp;<input id="mobileAreaCode" name="mobileAreaCode" type="text" value="<set:data name='mobileAreaCode'/>" size="3"  maxlength="3">&nbsp;</span>
                  --%>
                  <input class="bankMustInput" id="mobile" name="mobile" type="text" value="<set:data name='mobile'/>" size="20"  maxlength="20">
                  <%-- COMMENT BY LINRUI 20190522
                  <span id="mobile_hits">&nbsp;&nbsp;</span>
                  --%>
                  </td>
                </tr>
                <tr>
                ...
                <tr class="greyline">
                  ...
                  <td class="content1"><input id="faxNo" name="faxNo" type="text" value="<set:data name='faxNo'/>" size="60"></td>
                </tr>
                <tr class="">
                  <td class="label1"><set:label name="Cert_Info1" defaultvalue="User Certificate "/></td>
                  <td class="content1"><textarea id="certInfo1" name="certInfo1" cols="60" rows="3"><set:data name='certInfo1'/>
</textarea></td>
                </tr>
                <tr class="greyline">
                  <td class="label1"><set:label name="Authoriztion_Level" defaultvalue="Authorization Level"/></td>
                  <td class="content1"><select class="bankMustInput" id="authLevel" name="authLevel" nullable="0">
                      ...
                      <set:rblist file="app.cib.resource.common.auth_level"> <set:rboption/> </set:rblist>
                    </select></td>
                </tr>
                <tr>
                  <td class="label1"><set:label name="User_Group" defaultvalue="User Group"/></td>
                  <td class="content1"><select id="groupId" name="groupId" nullable="0">
                ...
                <tr>
                  <td colspan="2" ><div title="User's Transaction Limits"  id="operator" >
                      <table width="100%" border="0" cellspacing="0" cellpadding="3">
                        <tr>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="40" colspan="2" class="sectionbutton"><input id="buttonOk" name="buttonOk" type="button" value="<set:label name='buttonOK' defaultvalue=' OK '/>" onClick="doSubmit();">
                    ...
                    <!--                      <input id="buttonReset" name="buttonReset" type="reset" value="<set:label name='buttonReset' defaultvalue='Reset'/>"> -->
