...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="greyline">
    ...
    <td class="content1"><set:label name='functionTitle'/></td>
  </tr>
			  <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="2" class="groupinput"><set:label name="Corp_Info" defaultvalue=""/></td>
              </tr>
              <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="greyline">
                <td colspan="7" class="label1"><set:label name="Multi_Class_Matrix" defaultvalue="Authorization Matrix(for Multi Class Authorization)"/>				</td>
              </tr>
              <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" colspan="2" class="sectionbutton"><input id="ok" name="ok" type="button" value="<set:label name='buttonOK' defaultvalue=' OK '/>" onClick="doSubmit('query')">
