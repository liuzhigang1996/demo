...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleDetail" defaultvalue="TRANSFER TO ACCOUNTS IN BANKS OVERSEAS"/><!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1" align="center"/>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr class="greyline">
                  ...
                  <td class="content1"><set:data name='fromAccount'/> </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="content1" colspan="2" ><set:data name='toCurrency' db='rcCurrencyCBS'/><set:data name='transferAmount' format="amount"/> </td>
                </tr>
                ...
                <tr class="greyline">
                  ...
                  <td class="content1"><set:data name='beneficiaryCountry' db="country"/> </td>
                </tr>
                <tr >
                  <td class="label1"><set:label name="Beneficiary_City" defaultvalue="City of Beneficiary Bank"/></td>
                  <td class="content1"><set:if name='cityFlag' condition='equals' value='N'><set:data name='beneficiaryCity' db="city"/></set:if> <set:if name='cityFlag' condition='equals' value='Y'><set:data name='beneficiaryCity' /></set:if> </td>
                </tr>
                <tr class="greyline">
                  <td class="label1"><set:label name="Beneficiary_Bank" defaultvalue="Name of Beneficiary Bank"/></td>
                  <td class="content1"><set:if name='bankFlag' condition='equals' value='N'><set:data name='beneficiaryBank1' db="overseaBank"/></set:if> <set:if name='bankFlag' condition='equals' value='Y'><set:data name='beneficiaryBank1'/></set:if> </td>
                </tr>
                <tr >
                  <td class="label1"><set:label name="Beneficiary_Bank_Address" defaultvalue="Address of Beneficiary Bank"/></td>
                  <td class="content1"><set:data name='beneficiaryBank2'/> <br>
                    <set:data name='beneficiaryBank3'/> </td>
                </tr>
                <tr class="greyline">
              ...
              <!-- add by lzg end -->
                ...
                <tr >
                  ...
                  <td class="content1"><set:data name='chareBy' rb="app.cib.resource.txn.charge_name"/> </td>
                </tr>
			 ...
			 <!-- add by lw end -->	
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td><set:assignuser selectFlag="Y" /> </td>
                </tr>
                <tr>
