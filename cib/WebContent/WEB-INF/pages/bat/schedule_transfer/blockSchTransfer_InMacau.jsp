...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleBlock" defaultvalue="TRANSFER TO ACCOUNTS IN OTHER BANKS IN MACAU"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/scheduleTransferMacau.do" method="post" name="form1" id="form1">
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr>
				...
				<td class="label1" ><set:label name="functionTitleBlock" defaultvalue="Add a schedule (Accounts in Macau)"/></td>
              </tr>
			  <tr>
