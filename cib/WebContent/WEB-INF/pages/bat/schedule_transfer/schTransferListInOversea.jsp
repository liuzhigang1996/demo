...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/scheduleTransferOversea.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.bat.schedule_transfer_list" -->
</head>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="ltab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                        <td class="tab1_c"><a onClick="postToMainFrame('/cib/scheduleTransferBANK3rd.do?ActionMethod=list',{ownerAccFlag:'N'})" href="#"><set:label name="TO_MDB_BANK_ACCOUNT" defaultvalue="To MDB Account"/></a></td>
                        <td class="rtab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                      </tr>
                  </table></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  ...
                  <td class="listheader1"><set:label name="BENEFICIARY_NAME"/></td>
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  ...
                  <td class="listcontent1"><set:listdata name="beneficiaryName1"/></td>
