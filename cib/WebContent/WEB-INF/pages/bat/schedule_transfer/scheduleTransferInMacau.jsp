              ...
              <tr>
                ...
                <td><table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td class="tab1_o">
                        <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  begin */ --><!-- <set:label name="Accounts_in_Macau" defaultvalue="Accounts in Other Banks in Macau"/> --> <set:label name="TO_LOCAL_BANK_ACCOUNT" defaultvalue="To Local Bank Account"/> <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  end */ --></td>
                ...
                <td><table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="ltab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                      <td class="tab1_c"><a onClick="toTargetFormgoToTarget('/cib/scheduleTransferOversea.do?ActionMethod=addLoad')" href="#">
                        <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  begin */ --><!-- <set:label name="Accounts_in_Overseas" defaultvalue="Accounts in Banks Overseas"/> --> <set:label name="TO_OVERSEAS_BANK_ACCOUNT" defaultvalue="To Overseas Bank Account"/> <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  end */ -->
                      </a></td>
                      <td class="rtab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                    </tr>
                </table></td>
