...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --> <set:label name="navigationTitle" defaultvalue="BANK Online Banking >Transfer > Accounts in Overseas"/> <!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/scheduleTransferOversea.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="schedule_oversea" form="form1" file="schedule_transfer_oversea" /> </td>
                </tr>
              </table>
                ...
                <tr>
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="tab1_c"><a onClick="toTargetFormgoToTarget('/cib/scheduleTransferBANK.do?ActionMethod=addLoad')" href="#"> <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  begin */ --><!-- <set:label name="Accounts_in_BANK" defaultvalue="Accounts in BANK"/> --> <set:label name="TO_MY_ACCOUNT" defaultvalue="To My Account"/> <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  end */ --></a></td>
                  ...
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="ltab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                        <td class="tab1_c"><a onClick="toTargetFormgoToTarget('/cib/scheduleTransferBANK3rd.do?ActionMethod=addLoad')" href="#"> <set:label name="TO_MDB_BANK_ACCOUNT" defaultvalue="To MDB Account"/> </a></td>
                        <td class="rtab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                      </tr>
                    </table></td>
                  ...
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="ltab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                        <td class="tab1_c"><a onClick="toTargetFormgoToTarget('/cib/scheduleTransferMacau.do?ActionMethod=addLoad')" href="#"><!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  begin */ --><!-- <set:label name="Accounts_in_Macau" defaultvalue="Accounts in Other Banks in Macau"/> --> <set:label name="TO_LOCAL_BANK_ACCOUNT" defaultvalue="To Local Bank Account"/> <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  end */ --></a></td>
                        <td class="rtab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                      </tr>
                    </table></td>
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="tab1_o"><!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  begin */ --><!-- <set:label name="Accounts_in_Overseas" defaultvalue="Accounts in Banks Overseas"/> --> <set:label name="TO_OVERSEAS_BANK_ACCOUNT" defaultvalue="To Overseas Bank Account"/> <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  end */ --></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr class="greyline" >
                  ...
                  <td class="label1"><set:label name="Monthly" defaultvalue="Monthly"/>---
                    ...
                    <set:label name="Start_of_month" defaultvalue="Start of month"/>
                    <input id="month_type" type="radio" name="month_type" value="-1" onClick="initDesignedDay();">
                    <set:label name="End_of_month" defaultvalue="End of month"/>
                    <input id="month_type" type="radio" name="month_type" value="0" onClick="initMonthType();">
                    <set:label name="Designated_Day" defaultvalue="Designated Day "/>&nbsp;
                    <input id="designed_day" name="designed_day" type="text" value="<set:data name='designed_day'/>" size="8" maxlength="8" onClick="">
                    (1-31)</td>
                </tr>
                <tr class="greyline" >
                ...
                <tr>
                  ...
                  <td class="content1" colspan="3"><input id="endDate" name="endDate" type="text" value="<set:data name='endDate'/>" size="10" maxlength="10"><img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "{scwShow(document.getElementById('endDate'), this,language)};" > </td>
                </tr>  
              </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                ...
                <tr >
                  <td width="25%" class="label1",colspan="3"><span>&nbsp;&nbsp;</span><b> <set:label name="Transfer_From" defaultvalue="Transfer From"/></b>
              ...
              <tr>
                ...
                <tr class="greyline">
                  ...
                  <td width="5%" class="content1"><div name="showFromCurrency" id="showFromCurrency"><set:data name="fromCurrency"/></div></td>
				...
				<!----------------Modified by xyf 20090721 begin----------------->
				  <tr>
                    <td class="label1" colspan="4">&nbsp;</td>
                  </tr>
				  <tr class="greyline">
                    <td class="label1"><span>&nbsp;&nbsp;</span><set:label name="Beneficiary_Address" defaultvalue="Beneficiary Address "/></td>
                    <td  class="content1"  colspan="3">
					<input id="beneficiaryName3" name="beneficiaryName3" type="text" value="<set:data name='beneficiaryName3'/>" size="45" maxlength="35"><br>
                ...
                <tr class="greyline">
                  ...
                  <td class="content1" colspan="3" ><table><tr><td><select name="beneficiaryCountry" id="beneficiaryCountry" nullable="0"  onChange="showList(this, $('beneficiaryCity'),'country');">
                      <option value="" selected><set:label name="Select_Country_Label" defaultvalue="---Select a Country ---"/></option>
                ...
                <tr >
                  ...
                  <td class="content1" colspan="3" ><table><tr><td><select name="beneficiaryCity" id="beneficiaryCity" nullable="0"  onChange="otherCityControl(this.value);">&nbsp;
                      <option value="" selected><set:label name="Select_City_Label" defaultvalue="---Select a City ---"/></option>
                ...
                <tr >
                  ...
                  <td class="content1" colspan="3" ><select name="beneficiaryBank1" id="beneficiaryBank1" nullable="0"  onChange="changeCgd(this.value);otherBankControl(this.value);">
                      <option value="0" selected><set:label name="Select_Beneficiary_Bank" defaultvalue="---Select a Beneficiary Bank---"/></option>
                    </select>
                ...
                <tr class="greyline">
                  ...
                  <td  class="content1" colspan="3"><input id="beneficiaryBank2" name="beneficiaryBank2" type="text" value="<set:data name='beneficiaryBank2'/>" size="45" maxlength="35">
                    <br>
                    <input id="beneficiaryBank3" name="beneficiaryBank3" type="text" value="<set:data name='beneficiaryBank3'/>" size="45" maxlength="35">
                    <br>
                  </td>
                </tr>
                <tr>
                  <td class="label1"><span class = "xing">*</span><set:label name="SWIFT_Address" defaultvalue="SWIFT Address"/></td>
                  <td  class="content1" colspan="3"><input name="swiftAddress" id="swiftAddress" type="text" value="<set:data name='swiftAddress'/>" size="45" maxlength="11"></td>
                </tr>
                <tr class="greyline">
                  <td  colspan="4"><div name="showBankLabel" id="showBankLabel"></div></td>
                </tr>
                <!--<tr >
                ...
                --><tr >
                  ...
                  <td  class="content1"  colspan="3"><input id="messsage" name="messsage" type="text" value="<set:data name='messsage'/>" size="45" maxlength="35">
                    <br>
                    <input id="messsage2" name="messsage2" type="text" value="<set:data name='messsage2'/>" size="45" maxlength="35">
                  </td>
                </tr>
                <tr class="greyline">
                  ...
                  <!-- modified by lzg for GAPMC-EB-001-0050 -->
                  <!--<td class="content1" colspan="3" ><set:rblist file="app.cib.resource.txn.charge_name"> <set:rbradio name="chareBy"/> </set:rblist> </td>
                -->
                 <td class="content1" colspan="3">
               ...
               <!-- add by lzg 20190602 -->
				...
				<tr>
     			...
     			<table width="100%">
     			<tr>
                  	<td class="label1" width="25%"><set:label name="Purpose" defaultvalue="Purpose"/></td>
                  	<td class="content1" colspan="3" width="75%">
