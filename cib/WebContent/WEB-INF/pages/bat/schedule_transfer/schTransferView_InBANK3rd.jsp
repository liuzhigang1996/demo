...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleDetail" defaultvalue="TRANSFER IN BANK DETAIL"/><!-- InstanceEndEditable --></td>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1" align="center"/>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr >
                  ...
                  <td class="content1" colspan="3" ><set:data name='toAccount'/> </td>
                </tr>
