...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleBlock" defaultvalue="TRANSFER IN BANK DETAIL"/><!-- InstanceEndEditable --></td>
