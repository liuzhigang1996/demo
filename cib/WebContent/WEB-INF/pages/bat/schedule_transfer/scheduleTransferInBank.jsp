		  ...
		  <form action="/cib/scheduleTransferBANK.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="schedule_bank" form="form1" file="schedule_transfer_BANK" />
                ...
                <tr>
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td class="tab1_o"><!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  begin */ --><!-- <set:label name="Accounts_in_BANK" defaultvalue="Accounts in BANK"/> --> <set:label name="TO_MY_ACCOUNT" defaultvalue="To My Account"/> <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  end */ --></td>
                    ...
                    <div name="showAmountArea" id="showAmountArea" style="display: none">
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td><div name="showAmount"  format="amount" id="showAmount" ></div>
                          </td>
                        </tr>
                      </table>
                    </div></td>
              ...
              <%--end --%>
                ...
                <!--<tr>
                  <td class="label1"></td>
                  <td width="50%" class="content1" colspan="3">
                    <input name="toAccount2" type="text" id="toAccount2" value="<set:data name='toAccount2'/>" size="20" maxlength="12" onChange="otherAcc(this.value)"></td>
                </tr>
                <tr class="greyline">
