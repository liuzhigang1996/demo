...
<set:loadrb file="app.cib.resource.bat.schedule_transfer_bank3rd">
<head>
...
//		if (form.elements[i].name == 'scheduleName') {
//			alert(form.elements[i].name + ',' + form.elements[i].value);
//			for(i=0;i<form.elements[i].length; i++) {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="990" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle" defaultvalue="MDB Corporate Online Banking > Scheduled Transfer > New Scheduled Transfer"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle" defaultvalue="NEW TRANSFER SCHEDULE - To MDB Account"/><!-- InstanceEndEditable --></td>
    ...
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
		  ...
		  <form action="/cib/scheduleTransferBANK3rd.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" --> <set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="schedule_bank" form="form1" file="schedule_transfer_BANK" />
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="ltab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                        <td class="tab1_c"><!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  begin */ --><a onClick="toTargetFormgoToTarget('/cib/scheduleTransferBANK.do?ActionMethod=addLoad')" href="#"> <set:label name="TO_MY_ACCOUNT" defaultvalue="To My Account"/> </a><!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  end */ --></td>
                  ...
                  <td><table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="ltab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                        <td class="tab1_c"><a onClick="toTargetFormgoToTarget('/cib/scheduleTransferOversea.do?ActionMethod=addLoad')" href="#"><!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  begin */ --><!-- <set:label name="Accounts_in_Overseas" defaultvalue="Accounts in Banks Overseas"/> --> <set:label name="TO_OVERSEAS_BANK_ACCOUNT" defaultvalue="To Overseas Bank Account"/> <!-- /* Modify by long_zg 2019-05-22 UAT6-246 COB：新增的第三者轉賬未完全改好  end */ --></a></td>
                        <td class="rtab1_c"><img src="/cib/images/shim.gif" width="8" height="26"></td>
                      </tr>
                    </table></td>
                </tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr class="greyline" >
                  <td class="label1"><input type="radio" name="dayType" value="4" id="dayType4" onClick="changeFrequence(this.id);" ></td>
              ...
              <tr>
               ...
               <%-- modified by lzg end --%>
                ...
                <tr class="greyline">
                  ...
                  <td class="content1" colspan="3" >
				  	<input name="toAccount" type="text" id="toAccount" value="<set:data name='toAccount'/>" size="20" maxlength="12" onblur="showToCcyList(this, $('toCurrency'),'getToCcy', this.value);">
				  </td>
                </tr>
              ...
              <tr>
                <td height="28" valign="top" class="label1"></td>
