...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/protectionChequeBatchRequest.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.srv.protection_check_request" --><!-- InstanceParam name="enctype" type="text" value="multipart/form-data" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/protectionChequeBatchRequest.do" method="post" enctype="multipart/form-data" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="protection_cheque_check" form="form1" file="batch_request" /> </td>
                </tr>
              </table>
              ...
              <tr>
                <td><table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td class="tab1_c"><a href="protectionChequeRequest.do?ActionMethod=protectionLoad"><set:label name="Cheque_single" defaultvalue="Bank Draft Request"/></a></td>
...
function popWindow(url){
		...
		popWin1.focus();
                        ...
                        <a href="#" onClick="popWindow('<set:label name='CHEQUE_PROTECTION_N' rb='app.cib.resource.common.upload_sample'/>')"><set:label name="help" rb="app.cib.resource.common.operation"/></a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr class="greyline">
