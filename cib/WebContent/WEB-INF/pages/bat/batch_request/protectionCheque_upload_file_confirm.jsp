...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/protectionChequeBatchRequest.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.srv.protection_check_request" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/protectionChequeBatchRequest.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="groupinput"><set:if name="errRecordNo" value="0" condition="notequals"> <set:label name="err_record_below" defaultvalue="err_record_below"/> </set:if> <set:if name="rightRecordNo" value="0" condition="notequals"> <set:label name="nor_record_below" defaultvalue="nor_record_below"/> </set:if> : </td>
                </tr>
              </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
				  ...
				  <td class="listcontent1"><set:listdata name="CHEQUE_STYLE" /></td>
