...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/bankBatchRequest.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.srv.bank_draft_request" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/bankBatchRequest.do" method="post" name="form1" id="form1">
			...
			<!-- add by lw end -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3" id="round">
                ...
                <tr class="">
                  ...
                  <td class="label1"><set:data name="TO_CURRENCY"/>&nbsp;<set:data name="TO_AMOUNT" format="amount"/></td>
                </tr>
                <tr class="greyline">
                ...
                <tr class="">
                  ...
                  <td width="72%" class="label1"><set:data name="TO_CURRENCY"/>&nbsp;<set:data name="totalAmount" format="amount"/></td>
                </tr>
                <tr class="greyline">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  ...
                  <td align="right" class="listcontent1"><set:listdata name="DRAFT_AMOUNT" format="amount"/></td>
                  <td class="listcontent1"><set:listdata name="BENEFICIARY_NAME" escapechar="YES"/></td>
				  <td class="listcontent1"><set:listdata name="BANK_ADDRESS_1" escapechar="YES"/></td>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="40" colspan="2" class="sectionbutton"><div align="center"> <set:if name="errFlag" condition="equals" value="N">
