...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/cashOrderBatchRequest.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.srv.cash_order_request" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/cashOrderBatchRequest.do" method="post" name="form1" id="form1">
			...
			<!-- add by lw end -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
				   ...
				   <td align="right" class="listcontent1"><set:listdata name="CASHIER_AMOUNT" format="amount"/></td>
