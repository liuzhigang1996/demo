...
function doSubmit(arg) {
	if(validate_upload_file(document.getElementById("form1"))){
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/payroll.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.bat.payroll" --><!-- InstanceParam name="enctype" type="text" value="multipart/form-data" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/payroll.do" method="post" enctype="multipart/form-data" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><set:messages width="100%" cols="1" align="center"/> <set:fieldcheck name="upload_file" form="form1" file="payroll" /> </td>
                </tr>
              </table>
...
function popWindow(url){
		...
		popWin1.focus();
                        ...
                        <a href="#" onClick="popWindow('<set:label name='PAYROLL' rb='app.cib.resource.common.upload_sample'/>')"><set:label name="help" rb="app.cib.resource.common.operation"/></a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr class="greyline">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="40" colspan="2" class="sectionbutton">
                      <input id="ok" name="ok" type="button" value="&nbsp;&nbsp;<set:label name='submit' defaultvalue=' submit '/>&nbsp;&nbsp;" onClick="doSubmit('ok')">
<!--                      <input id="reset" name="reset" type="reset" value="&nbsp;&nbsp;<set:label name='reset' defaultvalue=' reset '/>&nbsp;&nbsp;"> -->
