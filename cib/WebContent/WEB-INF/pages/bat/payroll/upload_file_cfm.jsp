...
function doSubmit(arg) {
	if (arg == 'confirm') {
		if(checkAssignedUser()){
			document.form1.ActionMethod.value = 'uploadFileCfm';
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3" id="round">
                ...
                <tr class="">
                  ...
                  <td width="72%" class="content1"><set:data name="currency"/>&nbsp;<set:data name="totalAmount" format="amount"/></td>
                </tr>
                <tr class="greyline">
			  ...
			  <set:if name="errFlag" condition="equals" value="Y">
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="groupinput"><set:label name="err_record_below" defaultvalue="err_record_below"/> :</td>
                </tr>
              </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <set:list name="errList" showPageRows="10" showNoRecord="YES">
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  <td class="listcontent1"><set:listdata name="LINE_NO" /></td>
                  <td class="listcontent1"><set:listdata name="REFERENCE_NO"/></td>
                  <td class="listcontent1"><set:listdata name="TO_ACCOUNT" /></td>
                  <td align="center" class="listcontent1">                    <set:data name="currency" />                  </td>
                  <td align="right" class="listcontent1">                    <set:listdata name="CREDIT_AMOUNT" format="amount"/>                  </td>
                ...
                <tr>
                  ...
                  <td class="listcontent1"><strong>
                    <div align="center"><set:label name="total_amt"/></div>
                    </strong></td>
                  <td class="listcontent1"><strong>
                    <div align="center"><set:data name="errTotalAmt" format="amount"/></div>
                    </strong></td>
                  <td colspan="3" class="listcontent1">&nbsp;</td>
                </tr>
				-->
              </table>
			  </set:if>
