...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInBankMtS.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.bat.batch_transfer_bank" -->
</head>
<body class="body1" onLoad="pageLoad();">
<div name="pageheader" id="pageheader">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitleMtS" defaultvalue="BANK Online Banking >Transfer > Multi C to Single D"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitleMtS" defaultvalue="MULTI DEBIT TO SINGLE CREDIT TRANSFER"/><!-- InstanceEndEditable --></td>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/transferInBankMtS.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="greyline">
                ...
                <td  width="72%" class="content1" colspan="2" ><set:data name='TO_ACCOUNT'/>
				</td>
              </tr>
			  <tr >
			    <td class="label1"><set:label name="TO_ACCOUNT_NAME" defaultvalue="To Account Name"/></td>
               <td class="content1"><set:data name='TO_ACCOUNT_NAME'/><br><set:data name='TO_ACCOUNT_NAME2'/>
			    </td>
              </tr>
			  <tr class="greyline">
			    <td class="label1"><set:label name="Transfer_Amount" defaultvalue="Transfer Amount"/></td>
               <td class="content1"><set:data name='toCurrency' db='rcCurrencyCBS'/>&nbsp;<set:data name='toAmount' format="amount"/>
			    </td>
              </tr>
			   <tr>
                  <td class="label1"><set:label name="total_amt_file" defaultvalue="Total Amount in file"/></td>
                  <td class="content1"><set:data name="TO_CURRENCY" db="rcCurrencyCBS"/>&nbsp;<set:data name="TO_AMOUNT" format="amount"/></td>
                </tr>
                <tr class="greyline">
                ...
                <tr class="greyline">
                  ...
                  <td width="72%" class="content1"><set:data name="TO_CURRENCY" db="rcCurrencyCBS"/>&nbsp;<set:data name="totalAmount" format="amount"/></td>
                </tr>
                <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
				  ...
				  <td class="listheader1"><set:label name="REMARK" defaultvalue="REMARK"/></td>
				   <set:if name="errRecordNo" value="0" condition="notequals">
				  <td class="listheader1"><set:label name="Problem_Description" defaultvalue="Problem Description"/></td>
				   </set:if>
                </tr>
                <set:list name="recList" showPageRows="10" showNoRecord="YES">
                  <tr class="<set:listclass class1='' class2='greyline'/>">
                  <td class="listcontent1"><set:listdata name="LINE_NO" /></td>
                  <td class="listcontent1"><set:listdata name="FROM_ACCOUNT" /></td>
                  <td align="right" class="listcontent1"><set:listdata name="DEBIT_AMOUNT" format="amount"/></td>
