...
<table width="100%" border="0" cellspacing="0" cellpadding="3" id="round">
  <tr>
   ...
   <tr class="greyline">
    ...
    <tr >
               ...
               <td class="content1"><set:data name='fromCurrency' db='rcCurrencyCBS'/>&nbsp;<set:data name='newFromAmount' format="amount"/>
  ...
  <tr class="greyline">
    ...
    <td width="72%" class="content1"><set:data name="toCurrency" db="rcCurrencyCBS"/>&nbsp;<set:data name="toAmount" format="amount"/><input name="toCurrency" type="hidden" id="toCurrency" value="<set:data name='toCurrency'/>"><input name="toAmount" type="hidden" id="toAmount" value="<set:data name='toAmount'/>"></td>
  </tr>
    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
			   <tr >
                ...
                <td  class="listheader1"><set:label name="TO_ACCOUNT" defaultvalue="TO ACCOUNT"/></td>
				 <td  class="listheader1"><set:label name="TO_ACCOUNT_NAME" defaultvalue="TO ACCOUNT NAME"/></td>
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
				...
				<td class="listcontent1"><set:listdata name="toAccountName"/><br><set:listdata name="toAccountName2"/></td>
