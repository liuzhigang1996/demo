...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
			   ...
			   <td class="listheader1"><set:label name="line_in_file" defaultvalue="line_in_file"/></td>
                <td class="listheader1"><set:label name="TO_ACCOUNT" defaultvalue="ACCOUNT NUMBER"/></td>
				<td align="right" class="listheader1"><set:label name="TRANSFER_AMOUNT" defaultvalue="AMOUNT"/></td>
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
			   <td class="listcontent1"><set:listdata name="lineNo" /></td>
				...
				<td class="listcontent1"><set:listdata name="beneficiaryCountry" escapechar="YES"/></td>
				<td class="listcontent1"><set:listdata name="beneficiaryBank" format="amount"/></td>  
