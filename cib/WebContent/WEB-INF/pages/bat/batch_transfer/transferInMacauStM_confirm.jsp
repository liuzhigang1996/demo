...
function doCancel(){
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="uploadFileCancel";
	document.getElementById("form1").submit();
}
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInMacauStM.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.bat.batch_transfer_macau" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/transferInMacauStM.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr>
			   ...
			   <tr class="greyline">
                  <td class="label1"><set:label name="total_amt_file" defaultvalue="Total Amount in file"/></td>
                  <td class="content1"><set:data name="TO_CURRENCY"/>&nbsp;<set:data name="TO_AMOUNT" format="amount"/></td>
                </tr>
                <tr class="">
                ...
                <tr class="greyline">
                  <td class="label1"><set:label name="no_of_record_file" defaultvalue=" Number of Record in file"/></td>
                ...
                <tr class="">
                  <td class="label1"><set:label name="right_record_no" defaultvalue="Right Record Number"/></td>
                  <td class="content1"><set:data name="rightRecordNo" /></td>
                </tr>
                <tr class="greyline">
                  <td class="label1"><set:label name="err_record_no" defaultvalue=" Error Record Number"/></td>
			 ...
			 <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  <td class="listheader1" align="left"><set:label name="line_in_file" defaultvalue="line_in_file"/></td>
                  <td class="listheader1" align="left"><set:label name="TO_ACCOUNT" defaultvalue="TO ACCOUNT"/></td>
				  ...
				  <td class="listheader1" align="left"><set:label name="Bank_Name" defaultvalue="Bank Name"/></td>
				  <td class="listheader1" align="left"><set:label name="Charge_Account" defaultvalue="Charge Account"/></td>
				   <set:if name="errRecordNo" value="0" condition="notequals">
				  <td class="listheader1" align="left"><set:label name="Problem_Description" defaultvalue="Problem Description"/></td>
				   </set:if>
                </tr>
                <set:list name="recList" showPageRows="10" showNoRecord="YES">
                <tr class="<set:listclass class1='' class2='greyline'/>">
                   <td class="listcontent1" align="left"><set:listdata name="LINE_NO" /></td>
                  <td class="listcontent1" align="left"><set:listdata name="TO_ACCOUNT" /></td>
                  <td align="right" class="listcontent1"><set:listdata name="TRANSFER_AMOUNT" format="amount"/></td>
                  <td class="listcontent1" align="left"><set:listdata name="BENEFICIARY_NAME" escapechar="YES"/><br><set:listdata name="BENEFICIARY_NAME2" escapechar="YES"/></td>
				  <td class="listcontent1" align="left"><set:listdata name="BENEFICIARY_BANK" escapechar="YES"/></td>
				  <td class="listcontent1" align="left"><set:listdata name="CHARGE_ACCOUNT" /></td>
				  <set:if name="errRecordNo" value="0" condition="notequals">
				  <td class="listcontent1" align="left"><set:listdata name="PROBLEM_TYPE" rbs="app.cib.resource.bat.file_err_type"/></td>
				   </set:if>
                </tr>
                </set:list>
              </table>
