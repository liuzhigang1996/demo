            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			 ...
			 <table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  ...
                  <td class="listheader1" align="left"><set:label name="FROM_ACCOUNT" defaultvalue="FROM ACCOUNT"/></td>
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
                  ...
                  <td class="listcontent1" align="left"><set:listdata name="FROM_ACCOUNT" /></td>
