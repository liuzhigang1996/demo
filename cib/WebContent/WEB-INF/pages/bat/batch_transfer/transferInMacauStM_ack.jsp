		  ...
		  <form action="/cib/transferInMacauStM.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
				  ...
				  <td class="listheader1"><set:label name="Bank_Name" defaultvalue="Bank Name"/></td>
				  <td class="listheader1"><set:label name="Charge_Account" defaultvalue="Charge Account"/></td>
				</tr>
