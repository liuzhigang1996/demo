...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInOverseaStM.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.bat.batch_transfer_oversea" --><!-- InstanceParam name="enctype" type="text" value="multipart/form-data" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/transferInOverseaStM.do" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
function popWindow(url){
		...
		popWin1.focus();
                        ...
                        <a href="#" onClick="popWindow('<set:label name='TRANSFER_OVERSEAS_N' rb='app.cib.resource.common.upload_sample'/>')"><set:label name="help" rb="app.cib.resource.common.operation"/></a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr class="greyline">
