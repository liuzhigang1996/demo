...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInBankStM.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.bat.batch_transfer_bank" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/transferInBankStM.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
				  ...
				  <td class="listheader1" align="left"><set:label name="TO_ACCOUNT_NAME" defaultvalue="TO ACCOUNT NAME"/></td>
                  <td align="right" class="listheader1"><set:label name="TRANSFER_AMOUNT" defaultvalue="TRANSFER AMOUNT"/></td>
				  <td class="listheader1" align="left"><set:label name="REMARK" defaultvalue="REMARK"/></td>
				  <set:if name="errRecordNo" value="0" condition="notequals">
                ...
                <tr class="<set:listclass class1='' class2='greyline'/>">
				  ...
				  <td class="listcontent1" align="left"><set:listdata name="TO_ACCOUNT_NAME" /><br><set:listdata name="TO_ACCOUNT_NAME2" /></td>
