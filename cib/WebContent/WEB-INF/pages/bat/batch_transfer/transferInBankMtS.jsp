...
function doSubmit()
{
	if(validate_transferInBankStM(document.getElementById("form1"))){
...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/transferInBankMtS.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.bat.batch_transfer_bank" --><!-- InstanceParam name="enctype" type="text" value="multipart/form-data" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/transferInBankMtS.do" method="post" enctype="multipart/form-data" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
            <set:messages width="100%" cols="1" align="center"/>
            <set:fieldcheck name="transferInBankMtS" form="form1" file="batch_transfer" />
...
function popWindow(url){
		...
		popWin1.focus();
					  ...
					  <a href="#" onClick="popWindow('<set:label name='TRANSFER_BANK_NTO1' rb='app.cib.resource.common.upload_sample'/>')"><set:label name="help" rb="app.cib.resource.common.operation"/></a></td>
                    </tr>
                  </table></td>
                </tr>
                <%--<tr class="greyline">
            ...
            <tr class="greyline">
                  <td width="28%" class="label1"><set:label name="choose_file" defaultvalue="choose_file"/></td>
                  <td width="72%" colspan="2" class="content1">
                  	<table>
                  		<td id="wcc">
                  		<input name="uploadFile" type="file" id="uploadFile" value="<set:data name='uploadFile'/>" onKeyDown="this.blur();" onChange="changeFileName(this.value)" onpaste="return false;"size="70">
                  		<set:label name="choose_file" defaultvalue="choose_file" /></td>
                  		<td><input type="text" name="fileName" id="fileName" disabled="disabled" value="<set:data name='uploadFile'/>" /></td>
                  	</table>
                  </td>
                </tr>
...
<!--                <input id="bottonReset" name="bottonReset" type="reset" value="<set:label name='buttonReset' defaultvalue='Reset'/>"> -->
				<input id="ActionMethod" name="ActionMethod" type="hidden" value="uploadFileLoad">
				<set:singlesubmit/>				  </td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
