...
function doSubmit(arg) {
	if (arg == 'apply') {
		document.form1.ActionMethod.value = 'setAccountLimitsCfm';
	} else if (arg == 'return') {
...
function doCancel(){
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="setAccountLimitsCancel";
	document.getElementById("form1").submit();
}
</script>
    ...
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
		  ...
		  <form action="/cib/corpAccountLimits.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="40" colspan="2" class="sectionbutton"><input id="apply_change" name="apply_change" type="button" value="&nbsp;&nbsp;<set:label name='buttonConfirm'/>&nbsp;&nbsp;" onClick="doSubmit('apply')">
                  <input name="return" id="return" type="button" value="<set:label name='buttonReturn' />" onClick="doCancel()">
                  	<input id="ActionMethod" name="ActionMethod" type="hidden" value="return">			    </td>
			  </tr>
            </table>
<!-- InstanceEndEditable -->
		  </form>
