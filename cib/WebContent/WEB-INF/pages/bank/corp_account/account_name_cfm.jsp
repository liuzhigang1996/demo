...
function doSubmit(arg) {
	if (arg == 'confirm') {
		document.form1.ActionMethod.value = 'nameAccountCfm';
	}
...
function doCancel(){
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="nameAccountCancel";
		  ...
		  <form action="/cib/corpAccount.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<input id="confirm" name="confirm" type="button" value="<set:label name='buttonConfirm'/>" onClick="doSubmit('confirm')">
