		  ...
		  <form action="/cib/corpAccount.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  <td class="listheader1" align="left"><set:label name="account_no"/>&nbsp;</td>
                  <td class="listheader1" colspan="2" align="left"><set:label name="type"/>&nbsp;</td>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="40" colspan="2" class="sectionbutton"><input name="return" id="return" type="button" value="&nbsp;<set:label name='buttonReturn'/>&nbsp;" onClick="doSubmit('return')">
