...
function doCancel() {
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="updateSubsidiaryReturn";
	document.getElementById("form1").submit();
}
</script>
        ...
        <tr>
		  ...
		  <form action="/cib/corpSubsidiary.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    <td colspan="2" class="groupconfirm"><set:label name="Corp_Info" /></td>
                  </tr>
                  <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="40" colspan="2" class="sectionbutton"><input id="buttonConfirm" name="buttonConfirm" type="button" value="<set:label name='buttonConfirm' defaultvalue='Confirm'/>" onClick="doSubmit('confirm')">
                      <input id="buttonReturn" name="buttonReturn" type="button" value="<set:label name='buttonReturn' defaultvalue='buttonReturn'/>" onClick="doCancel()">
                      <input id="ActionMethod" name="ActionMethod" type="hidden" value="updateSubsidiaryCfm"></td>
                  </tr>
                </table>
                <!-- InstanceEndEditable -->
		  </form>
