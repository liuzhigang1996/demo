...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
        <set:label name="navigationTitle" defaultvalue="MDB Corporate Online Banking > Corporation Management > Corporation List"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle" defaultvalue="Corporation List"/>
        <!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/corpSubsidiary.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
			  ...
			  <tr class="greyline">
                ...
                <td width="72%" class="content1"><set:label name="ackStatusAccepted" defaultvalue="Accepted(Pendding Approval)"/></td>
			  </tr>
                </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                  <td colspan="2" class="groupack"><set:label name="Corp_Info"/></td>
                  </tr>
                  <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    <td colspan="3" class="groupinput"><set:label name="Subsidiaries" defaultvalue="Subsidiaries"/>					</td>
                  </tr>
                  <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="40" colspan="2" class="sectionbutton"><input id="buttonOK" name="buttonOK" type="button" value="<set:label name='buttonOK' defaultvalue='OK'/>" onClick="doSubmit('listSubsidiary')">
                    <input id="ActionMethod" name="ActionMethod" type="hidden" value="listSubsidiaryLoad">
