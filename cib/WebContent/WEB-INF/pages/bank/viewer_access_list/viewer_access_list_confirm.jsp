...
function doSubmit(arg) {
		...
		document.getElementById('ActionMethod').value = 'updateAccessListCfm';
		document.getElementById("form1").submit();
}
function doReturn(){
		setFormDisabled('form1');
		document.getElementById('ActionMethod').value = 'updateAccessListReturn';
		document.getElementById("form1").submit();
}
</script>
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr class="greyline">
                    ...
                    <td width="82%" class="content1">
                      <select name="associatedList" size="15" multiple id="select" style="width:300">
                        <set:list name="newAccessList">
                  ...
                  <tr>
                    <td class="groupseperator" colspan="2">&nbsp;</td>
                  </tr>
                </table>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="40" colspan="2" class="sectionbutton"><input id="submit1" name="submit1" type="button" value="<set:label name='buttonConfirm' defaultvalue='Confirm'/>" tabindex="3"  onClick="doSubmit();">
                      <input id="submit12" name="submit12" type="button" value="<set:label name='buttonReturn'/>" tabindex="3"  onClick="doReturn();">
