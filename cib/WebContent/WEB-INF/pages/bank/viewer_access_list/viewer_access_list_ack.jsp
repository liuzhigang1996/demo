...
function doSubmit(arg) {
		...
		document.getElementById('ActionMethod').value = 'listLoad';
		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr>
                    ...
                    <td class="content1"><set:label name='functionTitle_update' defaultvalue="UPDATE VIEWER ACCESS LIST"/></td>
                  </tr>
                  <tr class="greyline">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr class="greyline">
                    ...
                    <td width="82%" class="content1"><select name="associatedList" size="15" multiple id="select" style="width:300">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="40" colspan="2" class="sectionbutton"><input id="submit1" name="submit1" type="button" value="<set:label name='buttonOK' defaultvalue='OK'/>" tabindex="3"  onClick="doSubmit();">
                      ...
                      <input name="ActionMethod" type="hidden" id="ActionMethod" value="listLoad"></td>
                  </tr>
                </table>
                <!-- InstanceEndEditable -->
		  </form>
