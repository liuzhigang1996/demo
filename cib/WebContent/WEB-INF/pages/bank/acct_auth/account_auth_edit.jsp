...
function doSubmit()
{
	if(validate_input(document.getElementById("form1"))){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_Edit" defaultvalue="MDB Corporate Online Banking > Company Preferences > Edit Account Authorization"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_Edit" defaultvalue="EDIT ACCOUNT AUTHORIZATION"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/accountAuthorization.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><set:messages width="100%" cols="1" align="center"/>
                            <set:fieldcheck name="accountAuthorization" form="form1" file="account_authorization" /></td>
                      </tr>
            </table>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
			 ...
			 <table width="100%" border="0" cellspacing="0" cellpadding="3">              
			<tr>
				<td class="content1" ><set:label name="Acct_No" defaultvalue="Account No"/></td>
				<td class="content1" ><input id="account" name="account" type="text" value="<set:data name='account'/>" size="25" maxlength="20"> </td>
			</tr>
			<tr class="greyline">
				<td class="content1" ><set:label name="Auth_User" defaultvalue="Authorization User"/></td>
				<td class="content1" ><input id="authUser" name="authUser" type="text" value="<set:data name='authUser'/>" size="50" maxlength="40"></td>
             </tr>
			<input id="selectRecordId" name="selectRecordId" type="hidden" value="<set:data name='selectRecordId'/>">
			</table>
