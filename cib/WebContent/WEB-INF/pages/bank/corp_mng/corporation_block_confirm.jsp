...
{
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="blockCancel";
	document.getElementById("form1").submit();
}
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_block" defaultvalue="MDB Corporate Online Banking > Corporation Management >Register New Corporation"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_block" defaultvalue="Register New Corporation"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/corporation.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr>
				...
				<td class="label1" ><set:label name="functionTitle_block" defaultvalue="Block Company"/></td>
              </tr>
			  <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<input id="buttonCancel" name="buttonCancel" type="button" value="<set:label name='buttonCancel' defaultvalue='Cancel'/>" onClick="doCancel()">
				  <input id="ActionMethod" name="ActionMethod" type="hidden" value="blockConfirm">
				  </td>
              </tr>
            </table>
			<!-- InstanceEndEditable -->
