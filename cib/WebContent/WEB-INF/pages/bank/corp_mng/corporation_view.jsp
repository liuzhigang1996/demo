...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
        <set:label name="navigationTitle_view" defaultvalue="MDB Corporate Online Banking > Corporation Management > Corporation Information"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle_view" defaultvalue="Corporation information"/>
        <!-- InstanceEndEditable --></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
					...
					<input id="id_edit" name="buttonEdit" type="button" value="<set:label name='buttonEdit' defaultvalue= 'Edit '/>" disabled onClick="doSubmit('edit')">
                      ...
                      <input name="buttonReturn" id="buttonReturn" type="button" value="<set:label name='buttonReturn' defaultvalue=' Return '/>" onClick="doSubmit('return')">
