...
function pageLoad(){
	var obj = document.getElementById("corpType").value;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" -->
          <set:label name="navigationTitle_add" defaultvalue="MDB Corporate Online Banking > Corporation Management >Register New Corporation"/>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" -->
        <set:label name="functionTitle_add" defaultvalue="Register New Corporation"/>
        <!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/corporation.do" method="post" name="form1" id="form1">
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr>
                    <td width="28%" class="label1"><set:label name="Cif_No" defaultvalue="CIF NO"/></td><!-- update by linrui 20180211 -->
                    <td width="72%" class="content1"><input class="bankMustInput" id="cifNo" name="cifNo" type="text" value="<set:data name='cifNo'/>" size="12" maxlength="12"></td>
                  </tr>
                  <tr class="greyline">
                  ...
                  <tr class="greyline">
                    ...
                    <td class="content1">
					  <select class="bankMustInput" id="corpType" name="corpType" nullable="0" onChange="onOptionChange(this);">
                  ...
                  <tr class="">
                    <td class="label1"><set:label name="ID_NO" defaultvalue="ID No."/>
                    </td>
                    <td class="content1"><input id="rep2IdNo" name="rep2IdNo" type="text" value="<set:data name='rep2IdNo'/>" size="20" maxlength="20"></td>
                  </tr>
                  <tr  class="greyline">
                    <td class="label1"><set:label name="ID_Issue_date" defaultvalue="ID Issue date"/></td>
                    <td class="content1" colspan="3"><input id="rep2IdIssueDate" name="rep2IdIssueDate" type="text" value="<set:data name='rep2IdIssueDate' format='date'/>" size="10" maxlength="10">
                      <img src="/cib/images/datetime.gif" width="16" height="16" align="absmiddle" style="cursor:hand" onClick= "{scwShow(document.getElementById('rep2IdIssueDate'), this,language)};" > </td>
                  </tr>
                  <tr class="">
                    <td class="label1"><set:label name="ID_Issuer" defaultvalue="ID Issuer"/></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="40" colspan="2" class="sectionbutton"><input id="submit1" name="submit1" type="button" value="<set:label name='buttonOK' defaultvalue=' OK '/>" onClick="doSubmit()">
