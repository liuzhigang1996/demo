...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_delete" defaultvalue="MDB Corporate Online Banking > Corporation Management > Edit Corporation"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="">
                ...
                <td class="content1"><set:data name="fullName" /></td>
                  ...
                  <tr class="greyline">
                    <td class="label1"><set:label name="corp_type"/></td>
                    <td class="content1"><set:data name="fullName" rb="app.cib.resource.common.corp_type"/></td>
                  </tr>
                  <tr class="">
