...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_block" defaultvalue="MDB Corporate Online Banking > Corporation Management > Edit Corporation"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_block" defaultvalue="Edit Corporation"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/corporation.do" method="post" name="form1" id="form1">
		    ...
		    <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="greyline">
                ...
                <td class="content1"><set:label name='functionTitle_block'/></td>
              </tr>
              <tr>
