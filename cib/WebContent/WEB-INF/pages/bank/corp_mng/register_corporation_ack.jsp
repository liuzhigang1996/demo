		    ...
		    <!-- InstanceBeginEditable name="sectioncontent" -->
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr class="greyline">
                    ...
                    <td class="content1"><set:label name='functionTitle_add'/></td>
                  </tr>
                  <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <!--<tr class="greyline">
                    <td class="greyline"><set:label name="Authorization_Cur" defaultvalue="Authorization Preference Currency"/></td>
