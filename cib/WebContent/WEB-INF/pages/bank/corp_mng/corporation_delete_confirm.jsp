...
{
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="deleteCancel";
	document.getElementById("form1").submit();
}
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_delete" defaultvalue="MDB Corporate Online Banking > Corporation Management > Delete Corporation"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_delete" defaultvalue="Delete Corporation"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/corporation.do" method="post" name="form1" id="form1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="2" class="groupconfirm"><set:label name="Confirmation" defaultvalue="Confirmation"/></td>
              </tr>
			   <tr>
                <td class="label1" ><set:label name="Operation" defaultvalue="Operation"/></td>
				<td class="label1" ><set:label name="functionTitle_delete" defaultvalue="Delete Company"/></td>
              </tr>
			  <tr>
                <td colspan="2" class="groupinput"><set:label name="User_Information" defaultvalue="User Information"/></td>
              </tr>
               <tr>
			  ...
			  <tr class="">
                <td class="label1"><set:label name="Title" defaultvalue="Title"/></td>
                <td class="content1"><set:data name="rep2Title"   rb="app.cib.resource.common.title"/></td>
              </tr>
			   <tr class="greyline">
                <td class="label1"><set:label name="ID_Type" defaultvalue="ID Type"/></td>
...
<!--
              <tr class="greyline">
                <td class="label1" rowspan="4"><set:label name="Authorization_Cur" defaultvalue="Authorization Preference Currency"/></td>
                <td class="content1">MOP - <set:data name="authCurMop" rb="app.cib.resource.common.yes_no" /></td>
              </tr>
              <tr class="greyline">
                <td class="content1">HKD - <set:data name="authCurHkd" rb="app.cib.resource.common.yes_no" /></td>
              </tr>
              <tr class="greyline">
                <td class="content1">USD - <set:data name="authCurUsd" rb="app.cib.resource.common.yes_no" /></td>
              </tr>
              <tr class="greyline">
                <td class="content1">EUR - <set:data name="authCurEur" rb="app.cib.resource.common.yes_no" /></td>
              </tr>
-->
            </table>
