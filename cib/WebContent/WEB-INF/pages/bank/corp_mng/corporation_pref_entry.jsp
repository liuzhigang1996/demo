...
function doSubmit(arg,corpId) {
	...
	if (arg == 'account') {
		...
		document.getElementById("form1").action = '/cib/accountAuthorization.do';
	    document.getElementById("ActionMethod").value = 'listAccountAuthorization';
	}else if (arg == 'checking') {
		document.getElementById("form1").action = '/cib/configChecking.do';
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_pref" defaultvalue="MDB Corporate Online Banking > Corporation Preferences > "/><set:data name='prefType' rb='app.cib.resource.bnk.pref_type'/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><span id="toUpper"><set:data name='prefType' rb='app.cib.resource.bnk.pref_type'/></span><!-- InstanceEndEditable --></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr class="<set:listclass class1='' class2='greyline'/>">
                ...
                <td align="center" class="listcontent1">
                  <input id="buttonGo" name="buttonGo" type="button" value="<set:data name='prefType' rb='app.cib.resource.bnk.pref_type'/>" <set:listselected key="status" equalsvalue='1' output="disabled"/> onClick="doSubmit('<set:data name='prefType'/>','<set:listdata name='corpId'/>')">
                </a></td>
              </tr>
			  </set:list>
            </table>
