...
{
	setFormDisabled("form1");
	document.getElementById("ActionMethod").value="updateCancel";
	document.getElementById("form1").submit();
}
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_edit" defaultvalue="MDB Corporate Online Banking > Corporation Management > Edit Corporation"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_edit" defaultvalue="Edit Corporation"/><!-- InstanceEndEditable --></td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
			   ...
			   <tr>
				...
				<td class="label1" ><set:label name="functionTitle_edit" defaultvalue="Edit Company"/></td>
              </tr>
			  <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<input id="buttonCancel" name="buttonCancel" type="button" value="<set:label name='buttonCancel' defaultvalue='Cancel'/>" onClick="doCancel()">
				  <input id="ActionMethod" name="ActionMethod" type="hidden" value="updateConfirm">
				  </td>
              </tr>
            </table>
			<!-- InstanceEndEditable -->
