...
function doSetLoad(varCorpId, varCcy, varTxnType){
	...
	///cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=MOP&txnType=ALL
	window.document.location.href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=" + tempId + "&currency=" + varCcy + "&txnType=" + varTxnType;
}
</script>
		  ...
		  <form action="/cib/authPrefForSupervisor.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<td class="content1">
				<set:if name='allTxnTypeStatus' condition='equals' value='0'>
				<!-- <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=MOP&txnType=ALL"> -->
				<a href="#" onClick="doSetLoad('<set:data name='corpId'/>', 'MOP', 'ALL');">
				</set:if>
				<set:data name="allTxnTypeStatus" rb="app.cib.resource.sys.pref_status" />
				<set:if name='allTxnTypeStatus' condition='equals' value='0'></a></set:if>
				</td>				
			  </tr>
			  <tr>
			  ...
			  <set:list name="List_TRANSFER_OWN_ACCOUNT">
				...
				<!-- <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=<set:listdata name='cur'/>&txnType=TRANSFER_BANK"> -->
			  ...
			  <set:list name="List_TRANSFER_MACAU">
                <td class="content1"><set:listif name='status' condition='equals' value='0'>
				<!-- <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=<set:listdata name='cur'/>&txnType=TRANSFER_MACAU"> -->
				<a href="#" onClick="doSetLoad('<set:data name='corpId'/>', '<set:listdata name='cur'/>', 'TRANSFER_MACAU');">
				</set:listif>
				<set:listdata name="status" rb="app.cib.resource.sys.pref_status" /><set:listif name='status' condition='equals' value='0'></a></set:listif></td>
			  </set:list>
              </tr>
              <tr class="greyline">
			  ...
			  <set:list name="List_TRANSFER_OVERSEAS">
                <td class="content1"><set:listif name='status' condition='equals' value='0'>
				<!-- <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=<set:listdata name='cur'/>&txnType=TRANSFER_OVERSEAS"> -->
			  ...
			  <set:list name="List_TRANSFER_CORP">
                <td class="content1"><set:listif name='status' condition='equals' value='0'>
				 <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=<set:listdata name='cur'/>&txnType=TRANSFER_CORP"> 
			  ...
			  <set:list name="List_PAY_BILLS">
                <td class="content1"><set:listif name='status' condition='equals' value='0'>
				 <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=<set:listdata name='cur'/>&txnType=PAY_BILLS"> 
			  ...
			  <set:list name="List_TIME_DEPOSIT">
                <td class="content1"><set:listif name='status' condition='equals' value='0'>
				<!-- <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=<set:listdata name='cur'/>&txnType=TIME_DEPOSIT"> -->
			  ...
			  <set:list name="List_PAYROLL">
                <td class="content1"><set:listif name='status' condition='equals' value='0'>
				 <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=<set:listdata name='cur'/>&txnType=PAYROLL"> 
			  ...
			  <set:list name="List_BANK_DRAFT">
                <td class="content1"><set:listif name='status' condition='equals' value='0'>
				 <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=<set:listdata name='cur'/>&txnType=BANK_DRAFT"> 
			  ...
			  <set:list name="List_CASHIER_ORDER">
                <td class="content1"><set:listif name='status' condition='equals' value='0'>
				 <a href="/cib/authPrefForSupervisor.do?ActionMethod=setLoadForSupervisor&corpId=<set:data name='corpId'/>&currency=<set:listdata name='cur'/>&txnType=CASHIER_ORDER"> 
