        ...
        <tr>
		  ...
		  <form action="/cib/corpAccountLimitsForSupervisor.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="2" class="groupinput"><set:label name="limit_for_account" /> </td>
              </tr>
              <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td colspan="4" class="groupinput" valign="middle" align="left">
                  <set:label name="acc_in_bank_online" defaultvalue="acc_in_bank_online"/>
                </td>
              </tr>
              <tr>
                ...
                <td width="25%" class="content1">&nbsp;</td>
              	...
              	<td width="30%" class="content1" align="right">
