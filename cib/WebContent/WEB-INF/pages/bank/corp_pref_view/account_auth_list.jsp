...
<!-- InstanceEndEditable --><!-- InstanceParam name="page_action" type="text" value="/cib/accountAuthorizationForSupervisor.do" --><!-- InstanceParam name="help_href" type="text" value="#" --><!-- InstanceParam name="resource_file" type="text" value="app.cib.resource.sys.account_authorization" -->
</head>
  ...
  <tr>
    <td align="center" bgcolor="#999999"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
          ...
          <td>
		  <form action="/cib/accountAuthorizationForSupervisor.do" method="post" name="form1" id="form1">
