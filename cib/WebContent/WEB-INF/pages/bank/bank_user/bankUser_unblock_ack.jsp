...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_unblock" defaultvalue="MDB Corporate Online Banking > Bank User Management > Unblcok Bank User"/><!-- InstanceEndEditable --></td>
