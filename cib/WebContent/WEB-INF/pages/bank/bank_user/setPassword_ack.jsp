...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_pin" defaultvalue="MDB Corporate Online Banking > Service > Change Password"/><!-- InstanceEndEditable --></td>
        ...
        <tr>
		  ...
		  <form action="/cib/bankUser.do" method="post" name="form1" id="form1">
		    ...
		    <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
                <td width="150" height="50" align="center"  class="label1"><img src="/cib/images/Ok.gif" width="33" height="33"></td>
                <td  class="label1"><set:label name="CHANGE_SUCCESS" defaultvalue="CHANGE SUCCESS"/></td>
              </tr>
            </table>
		    <!-- InstanceEndEditable -->
		  </form>
