...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><!-- InstanceBeginEditable name="section_navbar" --><set:label name="navigationTitle_edit" defaultvalue="MDB Corporate Online Banking > Bank User Management > Edit Bank User"/><!-- InstanceEndEditable --></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><!-- InstanceBeginEditable name="section_title" --><set:label name="functionTitle_edit" defaultvalue="Edit Bank User"/><!-- InstanceEndEditable --></td>
		  ...
		  <form action="/cib/bankUser.do" method="post" name="form1" id="form1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                ...
                <td width="72%" class="content1"><set:label name='functionTitle_edit'/></td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<input id="buttonCancel" name="buttonCancel" type="button" value="<set:label name='buttonCancel' defaultvalue='Cancel'/>" onClick="doCancel()">
                  <input id="ActionMethod" name="ActionMethod" type="hidden" value="updateConfirm">				  </td>
              </tr>
            </table>
<!-- InstanceEndEditable -->
		  </form>
