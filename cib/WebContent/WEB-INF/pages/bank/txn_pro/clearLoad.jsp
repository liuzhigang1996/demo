...
function pageLoad(){
		var descriptionE =  document.getElementById("descriptionE").value;
		var descriptionC =  document.getElementById("descriptionC").value;
		descriptionE = descriptionE.replace(/<br>/g,"\n"); 
		descriptionC = descriptionC.replace(/<br>/g,"\n"); 
		document.getElementById("descriptionE").value = descriptionE;
		document.getElementById("descriptionC").value = descriptionC;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><set:label name="navigationTitleClear" /></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><set:label name="functionTitleClear" /></td>
			...
			<div>
				<div >
					...
					<div>
						...
						<div class = "desciption"><textarea  autoHeight = "true"  id = "descriptionC" name = "descriptionC" class = "myTextarea" ><set:data name = 'descriptionC' /></textarea></div>
					</div>
				</div>
				<div>
					<div>
						<span class = "myTitle" style = "float: left;"><set:label name = 'descriptionE'/></span>
						<div class = "desciption"><textarea  autoHeight = "true"  id = "descriptionE" name = "descriptionE" class = "myTextarea" ><set:data name = 'descriptionE' /></textarea></div>
					</div>
				</div>
				<div style = "clear: both;"></div>
				<div style = "width: 100%;text-align: center;">
					<input class = "myButton"  type = "button" value = "<set:label name = 'clearButton2'/>"  onclick="doSubmit('clear')"/>
