		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<div>
				...
				<div style = "width: 100%;text-align: center;">
					<input class = "myButton"  type = "button" value = "<set:label name = 'confirmButton'/>"  onclick="doSubmit('clearConfirm')"/>
					<input class = "myButton"  type = "button" value = "<set:label name = 'cancelButton'/>" onclick="doSubmit('clearLoad')">
				</div>
			</div>
