...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><set:label name="navigationTitleView" /></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><set:label name="functionTitleView" /></td>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<div>
				...
				<div style = "width: 100%;text-align: center;">
					<input class = "myButton"  type = "button" value = "<set:label name = 'okButton'/>"  onclick="doSubmit('load')"/>
				</div>
			</div>
