...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" height="18" class="navigationbar"><set:label name="navigationTitleClearConfirm" /></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="40">
  <tr>
    <td class="title1" nowrap><set:label name="functionTitleClearConfirm" /></td>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<div>
				...
				<div style = "width: 100%;text-align: center;">
					<input class = "myButton"  type = "button" value = "<set:label name = 'confirmButton'/>"  onclick="doSubmit('clearLoginMessageConfirm')"/>
					<input class = "myButton"  type = "button" value = "<set:label name = 'cancelButton'/>" onclick="doSubmit('clearLoginMessageLoad')">
				</div>
			</div>
