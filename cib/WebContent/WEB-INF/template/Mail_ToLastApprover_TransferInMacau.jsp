...
<td class="STYLE2">ACCOUNTS IN OTHER BANKS IN MACAU</td>
</tr>
<tr>
...
<td class="STYLE2"><%beneficiaryBank||db@localBank%></td>
</tr>
<tr>
<td class="STYLE2">Account  Number</td>
...
<tr>
<td class="STYLE2"><strong>Deduct Charges from Account</strong></td>
<td class="STYLE2"><%chargeAccount%></td>
</tr>
<tr>
<td class="STYLE2"><strong>Charges Amount</strong></td>
<td class="STYLE2"><%chargeCurrency%>&nbsp;<%chargeAmount||format@amount%></td>
</tr>
<tr>
<td class="STYLE2"><strong>Message to be sent</strong></td>
