...
-
  <%userName%></td>
      ...
      <tr>
        <td class="STYLE2"> Requsted Date/Time:</td>
        <td class="STYLE2"><%requestTime||format@date%>
        -
          <%requestTime||format@time%></td>
      </tr>
      <tr>
        <td height="24" class="STYLE2">Transaction Type:</td>
        <td class="STYLE2">Update Schedule Transfer - Account in banks Overseas</td>
      </tr>
    </table></td>
  </tr>
</table>
