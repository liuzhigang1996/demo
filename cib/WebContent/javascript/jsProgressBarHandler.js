  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: '/cib/images/bramus/percentImage.png',			// boxImage : image around the progress bar
			barImage	: '/cib/images/bramus/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
  ...
  */
	 ...
	 */
		...
		if (autoHook == true) {
			...
			20130503 annotation by Kevin.Wen
			
			to leave init "myJsProgressBarHandler" in jsp page.
