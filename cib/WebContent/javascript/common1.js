...
function postToMainFrame( URL, params){
    var postForm = document.form1;
    //add by lzg
    if(document.form1 == "[object HTMLCollection]"){
        postForm =document.form1[0];
    }
    //add by lzg end
    postForm.action = URL;
    postForm.method = "post";
    postForm.style.display="none"
    postForm.target = "mainFrame";
