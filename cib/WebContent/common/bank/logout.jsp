...
<SCRIPT language=JavaScript src="/javascirpt/common.js"></SCRIPT>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr> 
    <td height="200" valign="top"> 
      <form name="form1" method="post" action="/cib/bankLogin.do?ActionMethod=logout&exitActionFlag=exitByCloseWindow">
