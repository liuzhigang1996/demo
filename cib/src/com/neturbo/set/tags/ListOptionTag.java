...
public class ListOptionTag extends TagSupport {
    ...
    public int doStartTag() {
        try {
            ...
            if (selectedFlag) {
                out.print("<option value='" + valueStr + "' selected>" +
                          textStr +
                          "</option>");
            } else {
                out.print("<option value='" + valueStr + "'>" + textStr +
                          "</option>");
            }

        } catch (Exception e) {
            Log.warn("Custom Tag Process error (ListOption)", e);
        }
        return (SKIP_BODY);
