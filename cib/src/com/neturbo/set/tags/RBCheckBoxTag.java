...
public class RBCheckBoxTag
    extends TagSupport {
  private String name;
  private String inrb;
  public RBCheckBoxTag() {
  }
  ...
  public int doStartTag() {
    try {
      ...
      if (selectedFlag) {
        out.print("<input type='checkbox' name='" + name + "' value='"+value+"' checked>" + text);
      }
      else {
        out.print("<input type='checkbox' name='" + name + "' value='"+value+"'>" + text);
      }
    }
    catch (Exception e) {
