package com.neturbo.base.upload;
 ...
 * {@link com.neturbo.base.upload.MultipartElement MultipartElement}
 ...
 * </pre>
 *
 * @see com.neturbo.base.upload.MultipartElement
...
public class MultipartIterator {
     ...
     * @return a {@link com.neturbo.base.upload.MultipartElement MultipartElement}
    ...
    protected String readLine() throws ServletException, UnsupportedEncodingException {
        ...
        return new String(bufferByte, 0, bytesRead, charEncoding);
    }
