 ...
 *
 * Created Thu Mar 01 14:32:03 CST 2007 by MyEclipse Hibernate Tool.
 */
...
/**
 * A class that represents a row in the CORP_USER_HIS table. 
 * You can customize the behavior of this class by editing the class, {@link CorpUserHis()}.
 * WARNING: DO NOT EDIT THIS FILE. This is a generated file that is synchronized
 * by MyEclipse Hibernate tool integration.
 */
public abstract class AbstractCorpUserHis 
...
//    <!-- modify by long_zg 2014-04-03 for CR204 Apply OTP to BOB end -->
    ...
    /**
     * Simple constructor of AbstractCorpUserHis instances.
     */
    public AbstractCorpUserHis()
    {
    }

    /**
     * Constructor of AbstractCorpUserHis instances given a simple primary key.
     * @param seqNo
     */
    public AbstractCorpUserHis(java.lang.String seqNo)
    {
        this.setSeqNo(seqNo);
    }
    ...
    public boolean equals(Object rhs)
    {
        if (rhs == null)
            return false;
        if (! (rhs instanceof CorpUserHis))
            return false;
        CorpUserHis that = (CorpUserHis) rhs;
