 ...
 *
 * Created Thu Mar 01 15:49:12 CST 2007 by MyEclipse Hibernate Tool.
 */
...
/**
 * A class that represents a row in the CORPORATION table. 
 * You can customize the behavior of this class by editing the class, {@link Corporation()}.
 * WARNING: DO NOT EDIT THIS FILE. This is a generated file that is synchronized
 * by MyEclipse Hibernate tool integration.
 */
public abstract class AbstractCorporation 
    implements Serializable
{
	...
	/**
     * Simple constructor of AbstractCorporation instances.
     */
    public AbstractCorporation()
    {
    }

    /**
     * Constructor of AbstractCorporation instances given a simple primary key.
     * @param corpId
     */
    public AbstractCorporation(java.lang.String corpId)
    {
    ...
    public boolean equals(Object rhs)
    {
        if (rhs == null)
            return false;
        if (! (rhs instanceof Corporation))
            return false;
        Corporation that = (Corporation) rhs;
        if (this.getCorpId() == null || that.getCorpId() == null)
            return false;
        return (this.getCorpId().equals(that.getCorpId()));
    }
    ...
    public int hashCode()
    {
        ...
        {
            int result = 17;
            int corpIdValue = this.getCorpId() == null ? 0 : this.getCorpId().hashCode();
            result = result * 37 + corpIdValue;
