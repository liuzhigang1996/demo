...
public class CorpRepatriateAction extends CibAction implements Approvable {
	// static String toCorporation;
	public void addLoad() throws NTBException {
		// �ÿյ� ResultData �����ʾ���
		CorpUser userObj = (CorpUser) this.getUser();
		Corporation corpObj = userObj.getCorporation();
		String toCorporation = corpObj.getCorpName();

		Map resultData = new HashMap();

		resultData.put("toCorporation", toCorporation);
	...
	public void add() throws NTBException {
		...
		// transferBank.setToCorporation(toCorporation);

		transferBank.setToCorporation(userObj.getCorpId());
...
//		transferBank.setRequestTime(new Date());
		...
		resultData.put("txnType", Constants.TXN_SUBTYPE_TRANSFER_REPETRIATE);
	...
	public void addConfirm() throws NTBException {
		...
		String processId = flowEngineService.startProcess(
				Constants.TXN_SUBTYPE_TRANSFER_REPETRIATE,
				FlowEngineService.TXN_CATEGORY_FINANCE,
				CorpRepatriateAction.class, transferBank.getFromCurrency(),
		...
		try {
			...
			transferBank.setRecordType("8");
			corpTransferService.transferRepatriate(transferBank);
			// corpTransferService.toHostInBANK(transferBank.getTransId(),user);
			Map resultData = new HashMap();
			...
			/*mailService.toApprover_Seleted(Constants.TXN_SUBTYPE_TRANSFER_REPETRIATE, userName, dataMap);*/
			mailService.toApprover_Seleted(Constants.TXN_SUBTYPE_TRANSFER_REPETRIATE, userName ,corpUser.getCorpId(), dataMap);
...
//    	resultData.put("toAccount2", toAccount2);
	...
	public String viewDetail(String txnType, String id, CibAction bean)
		...
		return "/WEB-INF/pages/txn/corp_transfer/corp_repatriate_approval_view.jsp";
	}
