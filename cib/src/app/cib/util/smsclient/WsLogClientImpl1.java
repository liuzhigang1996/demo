...
//
//
//public class WsLogClientImpl1 implements WsLogClient{
//	
...
//	private static WsLogClientImpl1 wsLogClientImpl1 = null;
//	
//	/*static {
//		
//		// ��ʼ�����ŷ���
//		if (smsWsdlUrl == null) {
//			smsWsdlUrl = BankUtil.getProperty("app.sms.websphere.url_1");	
//		}
//		
...
//	}*/
//	
//	private WsLogClientImpl1(){
//		 // ��ʼ�����ŷ���
//		if (logWsdlUrl == null) {
//			logWsdlUrl = Config.getProperty("app.sms.log.server.url_1");	
//		}
//		
...
//			} catch (Exception e) {
//				Log.info("SMSOTP server_"+logWsdlUrl+" init error: "+e.getMessage());
//				//e.printStackTrace();
//			}
//		}
...
//	}
//	
//	public static WsLogClientImpl1 getInstance(){	
//		wsLogClientImpl1 = new WsLogClientImpl1();
//		return wsLogClientImpl1;
//	}
//	
//	
...
//		} catch (Exception e) {
//			Log.info("SMSOTP server_"+smsWsdlUrl+" connect error: "+e.getMessage());
//			//e.printStackTrace();
//		}		
//		return smsResponse;
//	}*/
...
//		} catch (Exception e) {
//			Log.info("SMSOTP server_"+logWsdlUrl+" connect error: "+e.getMessage());
//			//e.printStackTrace();
//		}		
//		return logResponse;
//	}
