...
import com.esigntrust.common.KeyAndCertificate;
import com.esigntrust.common.PKIUtil;
...
public class IaikCertVerification {
    ...
    private X509Certificate getCertFromByteArray(byte[] certByteArray) throws
         ...
         */
        X509Certificate x509certificate = new X509Certificate(certByteArray);
    ...
    public String getSubjectAlteNameHexCode() throws Exception {
        return PKIUtil.getSubjectAlternativeName(UserCert);
        /*
    ...
    public static void main(String[] args) {
        IaikCertVerification testObj = new IaikCertVerification();
        try {
            testObj.UserCert = testObj.getCertFromFile(
                    "D:/Sample Certificate/test_cert/personal.cer");
